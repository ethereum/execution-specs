...
def notify_new_payload(
    ...
    [`Block`]: ref:ethereum.forks.osaka.blocks.Block
    [`state_transition`]: ref:ethereum.forks.osaka.fork.state_transition
    """
...
def verify_and_notify_new_payload(
    ...
    [`notify_new_payload`]:
        ref:ethereum.forks.osaka.execution_engine.new_payload.notify_new_payload
    """  # noqa: E501
