"""
The [Engine API] under the Osaka fork.
...
superseded by Osaka answer with an unsupported-fork error, so this
module is the complete engine surface a Osaka client presents.
