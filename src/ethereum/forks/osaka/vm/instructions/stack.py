...
from ..gas import G_POP, G_PUSH0, G_DUPx, G_PUSHx, G_SWAPx, charge_gas
...
def push_n(evm: Evm, num_bytes: int) -> None:
    ...
    # GAS
    if num_bytes == 0:
        charge_gas(evm, G_PUSH0)
    else:
        charge_gas(evm, G_PUSHx)
