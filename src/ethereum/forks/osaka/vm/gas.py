...
GAS_BASE = GAS_BASE
GAS_VERY_LOW = GAS_VERY_LOW
GAS_LOW = GAS_LOW
GAS_MID = GAS_MID
GAS_HIGH = GAS_HIGH
GAS_EXPONENTIATION = GAS_EXPONENTIATION
GAS_KECCAK256 = GAS_KECCAK256
GAS_COLD_ACCOUNT_ACCESS = GAS_COLD_ACCOUNT_ACCESS
GAS_BLOCK_HASH = GAS_BLOCK_HASH
GAS_STORAGE_SET = GAS_STORAGE_SET
GAS_WARM_ACCESS = GAS_WARM_ACCESS
GAS_COLD_SLOAD = GAS_COLD_SLOAD
GAS_LOG = GAS_LOG
GAS_CREATE = GAS_CREATE
GAS_SELF_DESTRUCT = GAS_SELF_DESTRUCT
