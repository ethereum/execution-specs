...
class GasMeter:
    ...
    [`Evm`]: ref:ethereum.forks.binary_tree.vm.Evm
    """
    ...
    [commit]: ref:ethereum.forks.binary_tree.vm.gas.commit_state_gas
    """
    ...
    [Spill]: ref:ethereum.forks.binary_tree.vm.gas.GasMeter.state_gas_spilled
    [commit]: ref:ethereum.forks.binary_tree.vm.gas.commit_state_gas
    [restore]: ref:ethereum.forks.binary_tree.vm.gas.restore_state_gas
    [entry]: ref:ethereum.forks.binary_tree.vm.gas.restore_state_gas_to_entry
    """
...
def commit_state_gas(gas_meter: GasMeter) -> None:
    ...
    [sd]: ref:ethereum.forks.binary_tree.vm.eoa_delegation.set_delegation
    [restore]: ref:ethereum.forks.binary_tree.vm.gas.restore_state_gas
    [entry]: ref:ethereum.forks.binary_tree.vm.gas.restore_state_gas_to_entry
...
def restore_state_gas(gas_meter: GasMeter) -> None:
    ...
    [baseline]: ref:ethereum.forks.binary_tree.vm.gas.GasMeter.state_gas_baseline
    [spill]: ref:ethereum.forks.binary_tree.vm.gas.GasMeter.state_gas_spilled
...
def restore_state_gas_to_entry(
    ...
    [commit]: ref:ethereum.forks.binary_tree.vm.gas.commit_state_gas
    [grant]: ref:ethereum.forks.binary_tree.vm.TransactionEnvironment.state_gas_reservoir
...
def check_block_gas_capacity(
    ...
    [`TX_MAX_GAS_LIMIT`]: ref:ethereum.forks.binary_tree.transactions.TX_MAX_GAS_LIMIT
