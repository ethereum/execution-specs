...
[bal]: ref:ethereum.forks.binary_tree.block_access_lists.BlockAccessList
"""
...
class StorageChange:
    ...
    [s]: ref:ethereum.forks.binary_tree.block_access_lists.SlotChanges
    ...
    [`Block`]: ref:ethereum.forks.binary_tree.blocks.Block
    """
...
[`Block`]: ref:ethereum.forks.binary_tree.blocks.Block
[`Header`]: ref:ethereum.forks.binary_tree.blocks.Header
[`BALANCE`]: ref:ethereum.forks.binary_tree.vm.instructions.environment.balance
[ecs]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodesize
[ecc]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodecopy
[ech]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodehash
[call]: ref:ethereum.forks.binary_tree.vm.instructions.system.call
[create]: ref:ethereum.forks.binary_tree.vm.instructions.system.create
"""
...
class BlockAccessListBuilder:
    ...
    [`BlockAccessList`]: ref:ethereum.forks.binary_tree.block_access_lists.BlockAccessList
    """  # noqa: E501
    ...
    [`incorporate_tx_into_block`]: ref:ethereum.forks.binary_tree.state_tracker.incorporate_tx_into_block
    """  # noqa: E501
...
def ensure_account(builder: BlockAccessListBuilder, address: Address) -> None:
    ...
    [ad]: ref:ethereum.forks.binary_tree.block_access_lists.AccountData
    """
...
def add_nonce_change(
    ...
    [`CREATE`]: ref:ethereum.forks.binary_tree.vm.instructions.system.create
    [`CREATE2`]: ref:ethereum.forks.binary_tree.vm.instructions.system.create2
    """
    ensure_account(builder, address)
...
def add_code_change(
    ...
    [`CREATE`]: ref:ethereum.forks.binary_tree.vm.instructions.system.create
    [`CREATE2`]: ref:ethereum.forks.binary_tree.vm.instructions.system.create2
    [sct]: ref:ethereum.forks.binary_tree.transactions.SetCodeTransaction
    """
    ensure_account(builder, address)
...
def add_touched_account(
    ...
    [`EXTCODEHASH`]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodehash
    [`BALANCE`]: ref:ethereum.forks.binary_tree.vm.instructions.environment.balance
    [`EXTCODESIZE`]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodesize
    [`EXTCODECOPY`]: ref:ethereum.forks.binary_tree.vm.instructions.environment.extcodecopy
    """  # noqa: E501
    ensure_account(builder, address)
