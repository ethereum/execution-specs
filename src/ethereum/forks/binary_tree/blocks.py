...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.binary_tree.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.binary_tree.fork.EMPTY_OMMER_HASH
    """
    ...
    [logs bloom]: ref:ethereum.forks.binary_tree.bloom.logs_bloom
    """
    ...
    [cbalh]: ref:ethereum.forks.binary_tree.block_access_lists.hash_block_access_list
    """  # noqa: E501
...
class Block:
    ...
    [withdrawals]: ref:ethereum.forks.binary_tree.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.binary_tree.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.binary_tree.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.binary_tree.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.binary_tree.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.binary_tree.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.binary_tree.vm.instructions.log.log4
    """
