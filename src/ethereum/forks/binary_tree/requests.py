...
[rh]: ref:ethereum.forks.binary_tree.blocks.Header.requests_hash
[dt]: ref:ethereum.forks.binary_tree.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:ethereum.forks.binary_tree.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:ethereum.forks.binary_tree.requests.CONSOLIDATION_REQUEST_TYPE
[bd]: ref:ethereum.forks.binary_tree.requests.BUILDER_DEPOSIT_REQUEST_TYPE
[be]: ref:ethereum.forks.binary_tree.requests.BUILDER_EXIT_REQUEST_TYPE
[pd]: ref:ethereum.forks.binary_tree.requests.parse_deposit_requests
[crh]: ref:ethereum.forks.binary_tree.requests.compute_requests_hash
[pgpr]: ref:ethereum.forks.binary_tree.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:ethereum.forks.binary_tree.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:ethereum.forks.binary_tree.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:ethereum.forks.binary_tree.requests.DEPOSIT_REQUEST_TYPE
    """
