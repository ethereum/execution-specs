"""
The [Engine API] under the BPO2 fork.
...
superseded by BPO2 answer with an unsupported-fork error, so this
module is the complete engine surface a BPO2 client presents.
