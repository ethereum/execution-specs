...
def new_payload_v1(
    ...
    """
    `engine_newPayloadV1` serves forks before BPO2; once BPO2 is
...
def new_payload_v2(
    ...
    """
    `engine_newPayloadV2` serves forks before BPO2; once BPO2 is
    active it must not be used.
    """
    raise UnsupportedForkError(
...
def new_payload_v3(
    ...
    """
    `engine_newPayloadV3` serves forks before BPO2; once BPO2 is
    active it must not be used.
    """
    raise UnsupportedForkError(
...
def new_payload_v4(
    ...
    """
    `engine_newPayloadV4`: validate and execute a BPO2 payload.
    """
