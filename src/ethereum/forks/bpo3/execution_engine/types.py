"""
Structures of the [Engine API], as of the BPO3 fork.

Each structure version is additive over its predecessor, mirroring the
execution-apis documents: a client serving BPO3 understands every
...
class ExecutionEngine:
    ...
    [`BlockChain`]: ref:ethereum.forks.bpo3.fork.BlockChain
    """
...
def create_execution_engine(chain: BlockChain) -> ExecutionEngine:
    ...
    [`ExecutionEngine`]:
        ref:ethereum.forks.bpo3.execution_engine.types.ExecutionEngine
    """
...
class ExecutionPayloadV2:
    ...
    [`ExecutionPayloadV1`]:
        ref:ethereum.forks.bpo3.execution_engine.types.ExecutionPayloadV1
    """
...
class ExecutionPayloadV3:
    ...
    [`ExecutionPayloadV2`]:
        ref:ethereum.forks.bpo3.execution_engine.types.ExecutionPayloadV2
    """
