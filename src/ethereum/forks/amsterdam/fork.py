...
def apply_body(
    ...
    set_block_access_index(block_env.state, Uint(0))
    ...
    set_block_access_index(block_env.state, post_execution_index)
...
def process_transaction(
    ...
    set_block_access_index(block_env.state, index + Uint(1))
    ...
    for address in tx_output.accounts_to_delete:
        ...
        handle_in_transaction_selfdestruct(block_env.state, address)
    ...
    normalize_balance_changes(block_env.state)
...
def process_withdrawals(
    ...
    for i, wd in enumerate(withdrawals):
        ...
        prepare_balance_tracking(block_env.state, wd.address)
        ...
        track_balance_change(block_env.state, wd.address, U256(new_balance))
