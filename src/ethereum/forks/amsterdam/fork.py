...
def deploy_deterministic_factory(block_env: vm.BlockEnvironment) -> None:
    """
    Install the [EIP-7997] deterministic deployment factory if its
    canonical runtime code is not already present, recording the changes
    in the block access list at the pre-execution index.
