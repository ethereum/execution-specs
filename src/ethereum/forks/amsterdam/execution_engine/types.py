"""
Structures of the [Engine API], as of the Amsterdam fork.

Each structure version is additive over its predecessor, mirroring the
execution-apis documents: a client serving Amsterdam understands every
...
class ExecutionPayloadV2:
    ...
    [`ExecutionPayloadV1`]:
        ref:ethereum.forks.amsterdam.execution_engine.types.ExecutionPayloadV1
    """
...
class ExecutionPayloadV3:
    ...
    [`ExecutionPayloadV2`]:
        ref:ethereum.forks.amsterdam.execution_engine.types.ExecutionPayloadV2
    """
...
@slotted_freezable
@dataclass
class PayloadAttributesV4:
    """
    Build parameters carried by `engine_forkchoiceUpdatedV4`
    when the consensus layer requests a new block.
    """
