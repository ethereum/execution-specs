...
from ..index_tables import IndexEntry, IndexTable
...
class BlockOutput:
    ...
    index_entries :
        Index entries generated by the transactions of the block.
    """
    ...
    index_entries: Tuple[IndexEntry, ...] = field(default_factory=tuple)
