"""
The [Engine API] under the BPO4 fork.
...
superseded by BPO4 answer with an unsupported-fork error, so this
module is the complete engine surface a BPO4 client presents.
