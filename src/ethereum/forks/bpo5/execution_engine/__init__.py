"""
The [Engine API] under the BPO5 fork.
...
superseded by BPO5 answer with an unsupported-fork error, so this
module is the complete engine surface a BPO5 client presents.
