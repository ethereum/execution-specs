...
[`verify_and_notify_new_payload`]:
    ref:ethereum.forks.bpo5.execution_engine.new_payload.verify_and_notify_new_payload
"""  # noqa: E501
...
def verify_and_notify_new_payload(
    ...
    [`notify_forkchoice_updated`]:
        ref:ethereum.forks.bpo5.execution_engine.forkchoice_update.notify_forkchoice_updated
    """  # noqa: E501
...
def new_payload_v1(
    ...
    """
    `engine_newPayloadV1` serves forks before BPO5; once BPO5 is
...
def new_payload_v2(
    ...
    """
    `engine_newPayloadV2` serves forks before BPO5; once BPO5 is
    active it must not be used.
    """
    raise UnsupportedForkError(
...
def new_payload_v3(
    ...
    """
    `engine_newPayloadV3` serves forks before BPO5; once BPO5 is
    active it must not be used.
    """
    raise UnsupportedForkError(
...
def new_payload_v4(
    ...
    """
    `engine_newPayloadV4`: validate and execute a BPO5 payload.
    """
