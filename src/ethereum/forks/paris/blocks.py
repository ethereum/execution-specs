...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.paris.state.state_root
    [Trie]: ref:ethereum.forks.paris.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.paris.trie.root
    [Trie]: ref:ethereum.forks.paris.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.paris.bloom.logs_bloom
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.paris.blocks.Header
    """
    ...
    [headers]: ref:ethereum.forks.paris.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.paris.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.paris.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.paris.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.paris.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.paris.vm.instructions.log.log4
    """
