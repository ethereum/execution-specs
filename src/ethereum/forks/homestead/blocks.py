...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.homestead.state.state_root
    [Trie]: ref:ethereum.forks.homestead.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.homestead.trie.root
    [Trie]: ref:ethereum.forks.homestead.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.homestead.bloom.logs_bloom
    """
    ...
    ref:ethereum.forks.homestead.fork.calculate_block_difficulty
    """
    ...
    [u]: ref:ethereum.forks.homestead.fork.validate_proof_of_work
    """
    ...
    [v]: ref:ethereum.forks.homestead.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.homestead.blocks.Header
    """
    ...
    [headers]: ref:ethereum.forks.homestead.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.homestead.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.homestead.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.homestead.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.homestead.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.homestead.vm.instructions.log.log4
    """
