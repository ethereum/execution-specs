...
def calldatacopy(evm: Evm) -> None:
    ...
    copy_gas_cost = G.COPY_PER_WORD_COST * words
    extend_memory = calculate_gas_extend_memory(
        evm.memory, [(memory_start_index, size)]
    )
    charge_gas(evm, G.CALLDATACOPY + copy_gas_cost + extend_memory.cost)
...
def codecopy(evm: Evm) -> None:
    ...
    charge_gas(evm, G.CODECOPY + copy_gas_cost + extend_memory.cost)
...
def returndatasize(evm: Evm) -> None:
    ...
    # GAS
    charge_gas(evm, G.RETURNDATASIZE)
...
def returndatacopy(evm: Evm) -> None:
    ...
    charge_gas(evm, G.RETURNDATACOPY + copy_gas_cost + extend_memory.cost)
