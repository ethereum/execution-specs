...
def mstore(evm: Evm) -> None:
    ...
    charge_gas(evm, G.MSTORE + extend_memory.cost)
...
def mstore8(evm: Evm) -> None:
    ...
    charge_gas(evm, G.MSTORE8 + extend_memory.cost)
...
def mload(evm: Evm) -> None:
    ...
    charge_gas(evm, G.MLOAD + extend_memory.cost)
...
def mcopy(evm: Evm) -> None:
    ...
    charge_gas(evm, G.MCOPY + copy_gas_cost + extend_memory.cost)
