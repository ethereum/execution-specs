...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.gas_repricing.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]:
      ref:ethereum.forks.gas_repricing.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.gas_repricing.state.state_root
    [Trie]: ref:ethereum.forks.gas_repricing.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.gas_repricing.trie.root
    [Trie]: ref:ethereum.forks.gas_repricing.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.gas_repricing.bloom.logs_bloom
    """
    ...
    [crh]: ref:ethereum.forks.gas_repricing.requests.compute_requests_hash
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.gas_repricing.blocks.Header
    [withdrawals]: ref:ethereum.forks.gas_repricing.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.gas_repricing.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.gas_repricing.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.gas_repricing.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.gas_repricing.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.gas_repricing.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.gas_repricing.vm.instructions.log.log4
    """
