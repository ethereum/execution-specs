...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.constantinople.state.state_root
    [Trie]: ref:ethereum.forks.constantinople.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.constantinople.trie.root
    [Trie]: ref:ethereum.forks.constantinople.trie.Trie
    """
