"""
Structures of the [Engine API], as of the BPO1 fork.

Each structure version is additive over its predecessor, mirroring the
execution-apis documents: a client serving BPO1 understands every
...
class ExecutionPayloadV2:
    ...
    [`ExecutionPayloadV1`]:
        ref:ethereum.forks.bpo1.execution_engine.types.ExecutionPayloadV1
    """
...
class ExecutionPayloadV3:
    ...
    [`ExecutionPayloadV2`]:
        ref:ethereum.forks.bpo1.execution_engine.types.ExecutionPayloadV2
    """
