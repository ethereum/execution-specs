...
class ExecutionEngine:
    ...
    [`BlockChain`]: ref:ethereum.forks.bpo1.fork.BlockChain
    [`verify_and_notify_new_payload`]:
        ref:ethereum.forks.bpo1.execution_engine.new_payload.verify_and_notify_new_payload
    [`notify_forkchoice_updated`]:
        ref:ethereum.forks.bpo1.execution_engine.forkchoice_update.notify_forkchoice_updated
    """  # noqa: E501
...
def create_execution_engine(chain: BlockChain) -> ExecutionEngine:
    ...
    [`ExecutionEngine`]:
        ref:ethereum.forks.bpo1.execution_engine.types.ExecutionEngine
    """
...
[`notify_forkchoice_updated`]:
    ref:ethereum.forks.bpo1.execution_engine.forkchoice_update.notify_forkchoice_updated
[`get_payload`]:
    ref:ethereum.forks.bpo1.execution_engine.get_payload.get_payload
"""  # noqa: E501
