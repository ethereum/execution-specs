...
def notify_new_payload(
    ...
    [`Block`]: ref:ethereum.forks.bpo1.blocks.Block
    [`state_transition`]: ref:ethereum.forks.bpo1.fork.state_transition
    """
...
def verify_and_notify_new_payload(
    ...
    [`notify_new_payload`]:
        ref:ethereum.forks.bpo1.execution_engine.new_payload.notify_new_payload
    """  # noqa: E501
