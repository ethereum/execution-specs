"""
The [Engine API] under the BPO1 fork.
...
superseded by BPO1 answer with an unsupported-fork error, so this
module is the complete engine surface a BPO1 client presents.
