...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.dao_fork.state.state_root
    [Trie]: ref:ethereum.forks.dao_fork.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.dao_fork.trie.root
    [Trie]: ref:ethereum.forks.dao_fork.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.dao_fork.bloom.logs_bloom
    """
    ...
    ref:ethereum.forks.dao_fork.fork.calculate_block_difficulty
    """
    ...
    [u]: ref:ethereum.forks.dao_fork.fork.validate_proof_of_work
    """
    ...
    [v]: ref:ethereum.forks.dao_fork.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.dao_fork.blocks.Header
    """
    ...
    [headers]: ref:ethereum.forks.dao_fork.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.dao_fork.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.dao_fork.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.dao_fork.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.dao_fork.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.dao_fork.vm.instructions.log.log4
    """
