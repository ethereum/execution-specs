...
class ExecutionEngine:
    ...
    [`verify_and_notify_new_payload`]:
        ref:ethereum.forks.prague.execution_engine.new_payload.verify_and_notify_new_payload
    [`notify_forkchoice_updated`]:
        ref:ethereum.forks.prague.execution_engine.forkchoice_update.notify_forkchoice_updated
    """  # noqa: E501
...
[`notify_forkchoice_updated`]:
    ref:ethereum.forks.prague.execution_engine.forkchoice_update.notify_forkchoice_updated
[`get_payload`]:
    ref:ethereum.forks.prague.execution_engine.get_payload.get_payload
"""  # noqa: E501
...
class ExecutionPayload:
    ...
    [`ExecutionPayloadV4`]: https://github.com/ethereum/execution-apis/blob/main/src/engine/prague.md
    """  # noqa: E501
