...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.prague.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.prague.fork.EMPTY_OMMER_HASH
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`state_root()`]: ref:ethereum.forks.prague.state.state_root
    [Trie]: ref:ethereum.forks.prague.trie.Trie
    """
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [`root()`]: ref:ethereum.forks.prague.trie.root
    [Trie]: ref:ethereum.forks.prague.trie.Trie
    """
    ...
    [logs bloom]: ref:ethereum.forks.prague.bloom.logs_bloom
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.prague.blocks.Header
    [withdrawals]: ref:ethereum.forks.prague.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.prague.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.prague.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.prague.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.prague.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.prague.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.prague.vm.instructions.log.log4
    """
