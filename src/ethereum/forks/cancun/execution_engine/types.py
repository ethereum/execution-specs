...
[`notify_forkchoice_updated`]:
    ref:ethereum.forks.cancun.execution_engine.forkchoice_update.notify_forkchoice_updated
[`get_payload`]:
    ref:ethereum.forks.cancun.execution_engine.get_payload.get_payload
"""  # noqa: E501
...
class ExecutionPayload:
    ...
    [`ExecutionPayloadV3`]: https://github.com/ethereum/execution-apis/blob/main/src/engine/cancun.md
    """  # noqa: E501
...
class NewPayloadRequest:
    """
    Contain the parameters of the Engine API `engine_newPayloadV3`
