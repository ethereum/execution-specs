"""
Structures of the [Engine API], as of the Cancun fork.

Each structure version is additive over its predecessor, mirroring the
execution-apis documents: a client serving Cancun understands every
structure listed here.

[Engine API]: https://github.com/ethereum/execution-apis/blob/main/src/engine/cancun.md
"""  # noqa: E501
...
class ExecutionEngine:
    ...
    [`BlockChain`]: ref:ethereum.forks.cancun.fork.BlockChain
    """
...
def create_execution_engine(chain: BlockChain) -> ExecutionEngine:
    ...
    [`ExecutionEngine`]:
        ref:ethereum.forks.cancun.execution_engine.types.ExecutionEngine
    """
...
class ExecutionPayloadV2:
    ...
    [`ExecutionPayloadV1`]:
        ref:ethereum.forks.cancun.execution_engine.types.ExecutionPayloadV1
    """
...
class ExecutionPayloadV3:
    ...
    [`ExecutionPayloadV2`]:
        ref:ethereum.forks.cancun.execution_engine.types.ExecutionPayloadV2
    """
