...
from ethereum.spurious_dragon.vm.error import StackUnderflowError
...
def pop(evm: Evm) -> None:
    ...
    Raises
    ------
    ethereum.spurious_dragon.vm.error.StackUnderflowError
        If `len(stack)` is less than `1`.
    ethereum.spurious_dragon.vm.error.OutOfGasError
...
def push_n(evm: Evm, num_bytes: int) -> None:
    ...
    Raises
    ------
    ethereum.spurious_dragon.vm.error.StackOverflowError
