...
class Header:
    ...
    """
    Root hash of the transactions trie, which contains all transactions in this
    block.
    """

    receipt_root: Root
    """
    Root hash of the receipts trie, which contains all receipts for
    ...
    timestamp: U256
    """
    Timestamp of when the block was mined, in seconds.
    """
    ...
    nonce: Bytes8
    """
    Nonce used in the mining process, which is a 64-bit value that miners
    increment to find a valid block hash.
    """
