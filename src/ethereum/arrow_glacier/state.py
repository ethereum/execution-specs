...
def account_has_code_or_nonce(state: State, address: Address) -> bool:
    ...
    True if the account has non zero nonce or non empty code, False otherwise.
    """
...
def is_account_empty(state: State, address: Address) -> bool:
    ...
    #### Returns
    - is_empty: `bool`
    True if an account has zero nonce, empty code and zero balance, False
    otherwise.
    """
    account = get_account(state, address)
    return (
...
def account_exists_and_is_empty(state: State, address: Address) -> bool:
    ...
    True if an account exists and has zero nonce, empty code and zero balance,
    False otherwise.
    """
    account = get_account_optional(state, address)
    return (
