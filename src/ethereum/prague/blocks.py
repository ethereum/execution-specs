...
class Header:
    ...
    chain block.
    - `requests_hash`: Hash of all the collected requests from smart contracts
    in this block [`(EIP-7685)`].
...
class Block:
    ...
    fee market transactions, blob transactions or set code transactions.
