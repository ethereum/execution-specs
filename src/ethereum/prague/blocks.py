...
class Header:
    ...
    """
    Hash of all the collected requests from smart contracts in this block [(EIP-7685)].
...
class Block:
    ...
    """
    A tuple of transactions included in this block, which can be either legacy transactions, access list transactions, fee market transactions, blob transactions or set code transactions.
    """
