...
from ethereum.constantinople.trie import (
    BranchNode,
    ExtensionNode,
    InternalNode,
    LeafNode,
...
def compact_to_nibble_list(bytes: Bytes) -> Tuple[Bytes, bool]:
    ...
    `ethereum.constantinople.trie.nibble_list_to_compact`.
    """
...
def encode_internal_node_nohash(node: InternalNode) -> Bytes:
    """
    Perform an `ethereum.constantinople.trie.encode_internal_node`, but skip
    the hashing step.
    """
