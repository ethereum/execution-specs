...
from ethereum.dao_fork.trie import (
    BranchNode,
    ExtensionNode,
    InternalNode,
    LeafNode,
...
def compact_to_nibble_list(bytes: Bytes) -> Tuple[Bytes, bool]:
    """
    Performs the reverse of `ethereum.dao_fork.trie.nibble_list_to_compact`.
    """
...
def encode_internal_node_nohash(node: InternalNode) -> Bytes:
    """
    Perform an `ethereum.dao_fork.trie.encode_internal_node`, but skip the
    hashing step.
    """
