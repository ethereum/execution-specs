...
`ethereum.berlin.fork` to use alternate optimized implementations.
"""
from ethereum.base_types import U256_CEIL_VALUE
from ethereum.berlin.fork import generate_header_hash_for_pow
...
def validate_proof_of_work(header: Header) -> None:
    """
    See `ethereum.berlin.fork.validate_proof_of_work`.
    """
