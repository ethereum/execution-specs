...
from ethereum.muir_glacier.trie import (
    BranchNode,
    ExtensionNode,
    InternalNode,
    LeafNode,
...
def compact_to_nibble_list(bytes: Bytes) -> Tuple[Bytes, bool]:
    ...
    `ethereum.muir_glacier.trie.nibble_list_to_compact`.
    """
...
def encode_internal_node_nohash(node: InternalNode) -> Bytes:
    """
    Perform an `ethereum.muir_glacier.trie.encode_internal_node`, but skip
    the hashing step.
    """
