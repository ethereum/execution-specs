...
`ethereum.london.fork` to use alternate optimized implementations.
"""
from ethereum.base_types import U256_CEIL_VALUE
from ethereum.ethash import epoch
from ethereum.exceptions import InvalidBlock
from ethereum.london.fork import generate_header_hash_for_pow
from ethereum.london.fork_types import Header
...
def validate_proof_of_work(header: Header) -> None:
    """
    See `ethereum.london.fork.validate_proof_of_work`.
    """
