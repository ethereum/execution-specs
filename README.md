...
|-----------------------|-----------|----------|-----------|-------|-------|
| Arrow Glacier (Planned) | 13773000 | TBD | [EIP-4345](https://eips.ethereum.org/EIPS/eip-4345) | [Specification](./network-upgrades/mainnet-upgrades/arrow-glacier.md) | [Blog](https://blog.ethereum.org/2021/11/10/arrow-glacier-announcement/) |
