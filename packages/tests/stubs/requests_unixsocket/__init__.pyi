...
class Session(requests.Session):
    def __init__(self, url_scheme: str = ..., *args: Incomplete, **kwargs: Incomplete) -> None: ...
...
def request(method: str | bytes, url: str | bytes, **kwargs: Incomplete) -> Response: ...
def get(url: str | bytes, **kwargs: Incomplete) -> Response: ...
def head(url: str | bytes, **kwargs: Incomplete) -> Response: ...
def post(
    url: str | bytes, data: _Data | None = None, json: _JSON | None = None, **kwargs: Incomplete
) -> Response: ...
def patch(url: str | bytes, data: _Data | None = None, **kwargs: Incomplete) -> Response: ...
def put(url: str | bytes, data: _Data | None = None, **kwargs: Incomplete) -> Response: ...
