...
import eest.ethereum_test_cli.pytest_commands.plugins.filler.filler
...
class TestFillPytester:
    ...
    def default_html_report_file_path(self) -> str:
        ...
        return eest.ethereum_test_cli.pytest_commands.plugins.filler.filler.default_html_report_file_path()
