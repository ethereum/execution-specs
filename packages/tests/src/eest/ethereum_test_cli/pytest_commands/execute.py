...
eth_config = _create_execute_subcommand(
    ...
    command_logic_test_paths=[
        Path(
            "eest/ethereum_test_cli/pytest_commands/plugins/execute/eth_config/execute_eth_config.py"
        )
    ],
)
...
recover = _create_execute_subcommand(
    ...
    command_logic_test_paths=[
        Path(
            "eest/ethereum_test_cli/pytest_commands/plugins/execute/execute_recover.py"
        )
    ],
)
