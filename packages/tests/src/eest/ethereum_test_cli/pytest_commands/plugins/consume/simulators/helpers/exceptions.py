...
from eest.client_clis.clis.besu import BesuExceptionMapper
from eest.client_clis.clis.erigon import (
    ErigonExceptionMapper,
)
from eest.client_clis.clis.ethereumjs import (
    EthereumJSExceptionMapper,
)
from eest.client_clis.clis.ethrex import (
    EthrexExceptionMapper,
)
from eest.client_clis.clis.geth import GethExceptionMapper
from eest.client_clis.clis.nethermind import (
    NethermindExceptionMapper,
)
from eest.client_clis.clis.nimbus import (
    NimbusExceptionMapper,
)
from eest.client_clis.clis.reth import RethExceptionMapper
