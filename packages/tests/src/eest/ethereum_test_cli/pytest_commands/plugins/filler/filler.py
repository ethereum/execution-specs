...
from eest.ethereum_test_cli.gen_index import (
    generate_fixtures_index,
)
from eest.client_clis import TransitionTool
from eest.client_clis.clis.geth import FixtureConsumerTool
...
def fixture_collector(
    ...
    if request.config.getoption("fill_static_tests_enabled"):
        request.config.pluginmanager.import_plugin(
            "eest.ethereum_test_cli.pytest_commands.plugins.filler.static_filler"
        )
        request.config.pluginmanager.import_plugin(
            "eest.ethereum_test_cli.pytest_commands.plugins.solc.solc"
        )
