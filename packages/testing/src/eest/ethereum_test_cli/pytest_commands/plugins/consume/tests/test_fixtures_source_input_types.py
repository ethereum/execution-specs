...
class TestSimplifiedConsumeBehavior:
    ...
    def test_fixtures_source_from_release_url_no_api_calls(self) -> None:
        ...
        with patch(
            "eest.ethereum_test_cli.pytest_commands.plugins.consume.consume.FixtureDownloader"
        ) as mock_downloader:
    ...
    def test_fixtures_source_from_release_spec_makes_api_calls(self) -> None:
        ...
        with patch(
            "eest.ethereum_test_cli.pytest_commands.plugins.consume.consume.get_release_url"
        ) as mock_get_url:
            mock_get_url.return_value = "https://github.com/ethereum/execution-spec-tests/releases/download/v3.0.0/fixtures_stable.tar.gz"
            with patch(
                "eest.ethereum_test_cli.pytest_commands.plugins.consume.consume.get_release_page_url"
            ) as mock_get_page:
