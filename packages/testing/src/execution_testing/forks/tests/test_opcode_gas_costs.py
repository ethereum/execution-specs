...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            + Osaka.gas_costs().GAS_LOG_DATA * 32
            + Osaka.memory_expansion_gas_calculator()(new_bytes=32),
            id="log0",
        ),
        # LOG1 tests
        pytest.param(
            ...
            Osaka.gas_costs().GAS_LOG
            + Osaka.gas_costs().GAS_LOG_DATA * 64
        ...
        pytest.param(
            ...
            Osaka.gas_costs().GAS_LOG
            + Osaka.gas_costs().GAS_LOG_DATA * 128
        ...
        pytest.param(
            ...
            Osaka.gas_costs().GAS_LOG
            + Osaka.gas_costs().GAS_LOG_DATA * 256
        ...
        pytest.param(
            ...
            Osaka.gas_costs().GAS_LOG
            + Osaka.gas_costs().GAS_LOG_DATA * 512
