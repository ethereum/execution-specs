    ...
    def base_test_parametrizer_func(
        ...
        class BaseTestWrapper(cls):  # type: ignore
            ...
            def __init__(self, *args: Any, **kwargs: Any) -> None:
                ...
                # The appended sync block: on unless the option or an
                # ineligibility marker withholds it. Only fixture
                ...
                kwargs["sync_block"] = request.config.getoption(
                    ...
                    for marker in (
                        "no_sync_block_state_context",
                        "no_sync_block_timestamp_headroom",
                    )
                )
