...
from execution_testing.ethereum_test_cli.gen_index import (
...
def fixture_collector(
    ...
    if request.config.getoption("fill_static_tests_enabled"):
        request.config.pluginmanager.import_plugin(
            "execution_testing.ethereum_test_cli.pytest_commands.plugins.filler.static_filler"
        )
        request.config.pluginmanager.import_plugin(
            "execution_testing.ethereum_test_cli.pytest_commands.plugins.solc.solc"
        )
