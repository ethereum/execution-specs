...
pytest_plugins = (
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.pytest_hive.pytest_hive",
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.consume.simulators.base",
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.consume.simulators.single_test_client",
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.consume.simulators.test_case_description",
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.consume.simulators.timing_data",
    "execution_testing.ethereum_test_cli.pytest_commands.plugins.consume.simulators.exceptions",
)
