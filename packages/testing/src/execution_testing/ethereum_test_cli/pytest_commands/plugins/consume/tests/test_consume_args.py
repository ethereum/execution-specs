...
def consume_test_case_ids() -> list[str]:
    ...
    return [
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Cancun-blockchain_test_from_state_test]]",
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Paris-blockchain_test_from_state_test]]",
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Shanghai-blockchain_test_from_state_test]]",
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Cancun-state_test]]",
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Paris-state_test]]",
        f"src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py::test_fixture[CollectOnlyFixtureConsumer-tests/{MINIMAL_TEST_FILE_NAME}::test_function[fork_Shanghai-state_test]]",
    ]
    ...
    with FileLock(fixtures_dir.with_suffix(".lock")):
        ...
        if not meta_folder.exists():
            pytester.copy_example(
                name="src/execution_testing/ethereum_test_cli/pytest_commands/pytest_ini_files/pytest-fill.ini"
            )
            args = [
                "-c",
                "pytest-fill.ini",
...
def copy_consume_test_paths(pytester: Pytester) -> None:
    ...
    local_test_paths = [
        Path(
            "src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py"
        )
    ]
...
single_test_id = (
    "src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/"
...
def test_consume_simlimit_collectonly(
    ...
    pytester.copy_example(
        name="src/execution_testing/ethereum_test_cli/pytest_commands/pytest_ini_files/pytest-consume.ini"
    )
    consume_test_path = "src/execution_testing/ethereum_test_cli/pytest_commands/plugins/consume/direct/test_via_direct.py"
    args = [
        "-c",
        "pytest-consume.ini",
        "--input",
