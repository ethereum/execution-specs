...
#### - `executionWitnessMutated`: [`Optional`](./common_types.md#optional)`[bool]`

Optional fixture metadata. When `true`, the payload's `executionWitness` was
deliberately modified by the filler for stateless validation negative testing
and is not expected to be generated by execution clients.
