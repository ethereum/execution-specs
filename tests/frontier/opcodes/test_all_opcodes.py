...
def constant_gas_opcodes(fork: Fork) -> Generator[ParameterSet, None, None]:
    ...
    opcode_floor_gas = {
        ...
        Op.LOG0: gas_costs.GAS_LOG + (0 * gas_costs.GAS_LOG_TOPIC),
        Op.LOG1: gas_costs.GAS_LOG + (1 * gas_costs.GAS_LOG_TOPIC),
