...
def test_log0_fail_required_gas_overflows(test_file: str) -> None:
...
def test_log1_fail_required_gas_overflows(test_file: str) -> None:
    with pytest.raises(ValueError):
        run_logging_ops_vm_test(test_file)
...
def test_log2_fail_required_gas_overflows(test_file: str) -> None:
    with pytest.raises(ValueError):
        run_logging_ops_vm_test(test_file)
...
def test_log3_fail_required_gas_overflows(test_file: str) -> None:
    with pytest.raises(ValueError):
        run_logging_ops_vm_test(test_file)
...
def test_log4_fail_required_gas_overflows(test_file: str) -> None:
    with pytest.raises(ValueError):
        run_logging_ops_vm_test(test_file)
