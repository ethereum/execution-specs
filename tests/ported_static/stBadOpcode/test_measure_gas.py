...
def test_measure_gas(
    ...
    contract_1 = pre.deploy_contract(
        code=Op.CREATE2(value=Op.DUP1, offset=0x0, size=0x200, salt=Op.ADD(0x5a17, Op.GAS))
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=1,
    ...
    contract_12 = pre.deploy_contract(
        code=Op.PUSH2[0xea60] + Op.ADD(Op.CALLDATALOAD(offset=0x4), 0xc0de00)
        ...
        + Op.PUSH1[0x1] + Op.JUMPI(pc=0x3d, condition=Op.EQ) + Op.JUMPDEST
        + Op.POP + Op.JUMP(pc=0xd) + Op.JUMPDEST + Op.SWAP3 + Op.POP
        + Op.CODESIZE + Op.JUMP(pc=0x38) + Op.JUMPDEST + Op.SWAP1 + Op.SWAP2
        + Op.POP + Op.DUP2 + Op.SWAP1 + Op.JUMP(pc=0x31),
        balance=0xba1a9ce0ba1a9ce,
        nonce=1,
