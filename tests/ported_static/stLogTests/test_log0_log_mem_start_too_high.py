...
def test_log0_log_mem_start_too_high(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x3e8, address=0x4e46dd6ccd823bbe05d8ceaf0ca778101f8d8e6b, value=0x17, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.STOP,
