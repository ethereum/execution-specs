...
def test_return_test(
    ...
    # Source: lll
    # {(CALL 2000 0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b 0 30 1 31 1) [[0]](MLOAD 0) (RETURN 30 2)}
    contract_0 = pre.deploy_contract(
        code=Op.POP(Op.CALL(gas=0x7d0, address=0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b, value=0x0, args_offset=0x1e, args_size=0x1, ret_offset=0x1f, ret_size=0x1))
