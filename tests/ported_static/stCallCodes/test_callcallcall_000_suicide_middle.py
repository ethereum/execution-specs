...
def test_callcallcall_000_suicide_middle(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x186a0, address=0xba5a575c914981fb64bfb082dc59434c66eb2714, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000001: Account(storage={1: 1}, balance=0x2540be400),
    }
