...
def test_callcodecallcall_100_oogm_after(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc3500, address=0xb5d1a486869d27225126c47727513f57d329a01a, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
