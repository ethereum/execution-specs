...
def test_callcodecallcodecall_110_oogm_after(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x927c0, address=0x83b7d129b58ab5315b795f9a8d34294ec60c9d63, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
