...
def test_call_oog_additional_gas_costs2(
    ...
    # Source: lll
    # { [[0]] (CALL 6000 <contract:0x1000000000000000000000000000000000000001> 1 0 64 0 64 ) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x1770, address=0x89cd1cb7ad11c6949bec0c8c7533dc073960c54f, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        storage={0: 2},
