...
def test_callcodecallcodecallcode_111_suicide_end(
    ...
    post = {
        addr_0x1000000000000000000000000000000000000001: Account(balance=0xde0b6b5fb6fe400),
        addr_0x1000000000000000000000000000000000000002: Account(storage={0: 0, 1: 0, 2: 0}, balance=0x2540be400),
    }
