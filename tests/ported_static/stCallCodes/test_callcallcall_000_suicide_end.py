...
def test_callcallcall_000_suicide_end(
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.SSTORE(key=0x2, value=Op.CALL(gas=0xc350, address=0xcb6497f0337b6cd0f7239a8819295ec7d1dafd34, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
