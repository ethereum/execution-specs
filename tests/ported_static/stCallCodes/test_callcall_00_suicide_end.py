...
def test_callcall_00_suicide_end(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x249f0, address=0xf741cfee7b7fb1025dccef3db5a3cbc8ffb776f8, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
