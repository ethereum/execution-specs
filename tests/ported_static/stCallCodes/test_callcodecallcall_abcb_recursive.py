...
def test_callcodecallcall_abcb_recursive(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0x17d7840, address=0x66c0d9f841a86866465e6385c3827be02b580020, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
