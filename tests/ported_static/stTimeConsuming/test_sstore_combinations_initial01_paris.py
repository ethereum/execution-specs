...
def test_sstore_combinations_initial01_paris(
    ...
    #   dim1: middle action 1 (12) — {CALL,CALLCODE,DELEGATECALL,STATICCALL} × {c3,c4,c5}  # noqa: E501
    #   dim2: 2nd change call type (4) — STATICCALL, CALL, CALLCODE, DELEGATECALL  # noqa: E501
    #   dim3: middle action 2 (12) — {CALL,CALLCODE,DELEGATECALL,STATICCALL} × {c3,c4,c5}  # noqa: E501
    gas = 0x493E0
