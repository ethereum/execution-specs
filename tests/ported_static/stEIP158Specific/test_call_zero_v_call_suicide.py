...
def test_call_zero_v_call_suicide(
    ...
    # Source: lll
    # { [0](GAS) (CALL 60000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[100]] (SUB @0 (GAS)) }
    ...
    addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SELFDESTRUCT(address=0x61385ed1c4e08aa26be16da3851df1cc90ed2777)
        + Op.STOP,
        nonce=0,
    ...
    post = {
        addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(balance=0),
