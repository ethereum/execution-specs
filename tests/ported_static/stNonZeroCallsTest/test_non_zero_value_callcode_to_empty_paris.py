...
def test_non_zero_value_callcode_to_empty_paris(
    ...
    addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b = Address("0x85b89db0e2aef2a23f50801209a3de4c65c58d9d")  # noqa: E501
    sender = EOA(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0xea60, address=0x85b89db0e2aef2a23f50801209a3de4c65c58d9d, value=0x1, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
