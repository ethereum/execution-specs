...
def test_non_zero_value_transaction_cal_lwith_data_to_one_storage_key_paris(
    ...
    """test_non_zero_value_transaction_cal_lwith_data_to_one_storage_key_p..."""
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    addr_0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b = Address("0x4757608f18b70777ae788dd4056eeed52f7aa68f")  # noqa: E501
    sender = EOA(
    ...
    pre[addr_0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b] = Account(balance=10, storage={0: 1})
    ...
    post = {
        addr_0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 1}, balance=11),
    }
