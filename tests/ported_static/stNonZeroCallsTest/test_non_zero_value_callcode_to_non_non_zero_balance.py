...
def test_non_zero_value_callcode_to_non_non_zero_balance(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0xea60, address=0x9089da66e8bbc08846842a301905501bc8525dc4, value=0x1, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
