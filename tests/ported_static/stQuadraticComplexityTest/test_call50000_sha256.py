...
def test_call50000_sha256(
    ...
    # Source: lll
    # { (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) [[ 0 ]] (CALL 78200 2 1 0 50000 0 0) ) [[ 1 ]] @i}
    contract_0 = pre.deploy_contract(
        code=Op.JUMPDEST
        + Op.JUMPI(pc=0x2d, condition=Op.ISZERO(Op.LT(Op.MLOAD(offset=0x80), 0xc350)))
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0x13178, address=0x2, value=0x1, args_offset=0x0, args_size=0xc350, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    expect_entries_: list[dict] = [
        ...
        contract_0: Account(
                storage={0: 0, 1: 0},
                code=bytes.fromhex("5b61c3506080511015602d576000600061c35060006001600262013178f16000556001608051016080526000565b60805160015500"),  # noqa: E501
                nonce=0,
            ),
    },
        },
