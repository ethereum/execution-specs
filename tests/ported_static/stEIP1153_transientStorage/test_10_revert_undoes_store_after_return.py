...
def test_10_revert_undoes_store_after_return(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.CALL(gas=Op.GAS, address=Op.ADDRESS, value=Op.DUP1, args_offset=Op.DUP2, args_size=Op.DUP2, ret_offset=Op.PUSH0, ret_size=0x20))  # noqa: E501
        + Op.SSTORE(key=0x2, value=Op.MLOAD(offset=Op.PUSH0))
        + Op.SSTORE(key=0x3, value=Op.TLOAD(key=Op.PUSH0)) + Op.JUMP
        + Op.JUMPDEST
