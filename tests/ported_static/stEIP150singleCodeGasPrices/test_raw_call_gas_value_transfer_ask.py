...
def test_raw_call_gas_value_transfer_ask(
    ...
    # Source: lll
    # { [0] (GAS) (CALL 3000000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 10 0 0 0 0) [[1]] (SUB @0 (GAS)) }
    ...
    post = {
        addr_0x094f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={2: 0x70e1c}),
