...
def test_eip2929(
    ...
    EXPECT_ENTRIES: list[dict] = [
        ...
        },
        {
            ...
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2090, 1: 90, 2: 90})},
        },
        {
            "indexes": {"data": [2], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 4991, 1: 91, 2: 91})},
        },
        {
            "indexes": {"data": [14], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2090, 1: 2891, 2: 90})},
        },
        {
            "indexes": {
            ...
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2590, 1: 90, 2: 90})},
        },
        {
            "indexes": {"data": [5], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2597, 1: 97, 2: 97})},
        },
        {
            "indexes": {"data": [8, 25, 26, 7], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2608, 1: 108, 2: 108})},
        },
        {
            "indexes": {"data": [9, 10, 27, 28], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2605, 1: 105, 2: 105})},
        },
        {
            "indexes": {
            ...
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2590, 1: 108, 2: 108})},
        },
        {
            "indexes": {"data": [11], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2711, 1: 211, 2: 211})},
        },
        {
            "indexes": {"data": [35], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2590, 1: 90, 2: 211})},
        },
        {
            "indexes": {"data": [36], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2590, 1: 211, 2: 90})},
        },
        {
            "indexes": {"data": [37], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2711, 1: 90, 2: 90})},
        },
        {
            "indexes": {"data": [12], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2211, 1: 211, 2: 211})},
        },
        {
            "indexes": {"data": [13], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2208, 1: 208, 2: 208})},
        },
        {
            "indexes": {"data": [15], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2090, 1: 211, 2: 208})},
        },
        {
            "indexes": {"data": [16], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2090, 1: 2891, 2: 208})},
        },
        {
            "indexes": {"data": [17], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2211, 1: 90, 2: 208})},
        },
        {
            "indexes": {"data": [18], "gas": -1, "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 2208, 1: 90, 2: 2891})},
        },
    ]
