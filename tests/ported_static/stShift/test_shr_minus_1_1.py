...
def test_shr_minus_1_1(
    ...
    # Source: raw
    # 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60011c600055
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SHR(0x1, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)),  # noqa: E501
        storage={0: 3},
