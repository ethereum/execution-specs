...
def test_sar_2_255_minus_1_248(
    ...
    # Source: raw
    # 0x7f7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60f81d600055
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SAR(0xf8, 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)),  # noqa: E501
        storage={0: 3},
