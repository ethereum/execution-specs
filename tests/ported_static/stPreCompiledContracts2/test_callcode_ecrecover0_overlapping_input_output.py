...
def test_callcode_ecrecover0_overlapping_input_output(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x493e0, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x40, ret_size=0x20))  # noqa: E501
        + Op.SSTORE(key=0x0, value=Op.MOD(Op.MLOAD(offset=0x40), Op.EXP(0x2, 0xa0)))  # noqa: E501
