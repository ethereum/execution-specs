...
def test_callcode_ripemd160_5(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) [[ 2 ]] (CALLCODE 6000 3 0 0 1000000 0 32) [[ 0 ]] (MLOAD 0)}
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x1770, address=0x3, value=0x0, args_offset=0x0, args_size=0xf4240, ret_offset=0x0, ret_size=0x20))  # noqa: E501
