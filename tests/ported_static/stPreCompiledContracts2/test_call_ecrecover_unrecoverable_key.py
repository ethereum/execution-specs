...
def test_call_ecrecover_unrecoverable_key(
    ...
    """CALL to ECREC precompile with input that has a valid signature stru..."""
    ...
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0xa8b53bdf3306a35a7103ab5504a0c9b492295564b6202b1942a84ef300107281)
