...
def test_callcode_ecrecover2(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x186a0, address=0x1, value=0x0, args_offset=0x0, args_size=0x61, ret_offset=0x61, ret_size=0x20))  # noqa: E501
        + Op.SSTORE(key=0x0, value=Op.MOD(Op.MLOAD(offset=0x61), Op.EXP(0x2, 0xa0)))  # noqa: E501
