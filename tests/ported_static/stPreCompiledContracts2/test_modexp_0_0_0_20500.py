...
def test_modexp_0_0_0_20500(
    ...
    expect_entries_: list[dict] = [
        ...
        contract_0: Account(
                storage={},
                code=bytes.fromhex(""),  # noqa: E501
                balance=0,
                nonce=1,
            ),
