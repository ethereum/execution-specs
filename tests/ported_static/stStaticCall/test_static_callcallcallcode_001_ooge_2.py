    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    storage={0: 1},
                    code=bytes.fromhex(
                        "604060006040600073bda9155e6214fe759004e6fcbe736289ef8005286207a120fa60005500"  # noqa: E501
                    ),
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "604060006040600073a7c64824c59e4295a3868a2b275ad46b38f7846d620493e0fa00"  # noqa: E501
                    )
                ),
                callee_2: Account(
                    code=bytes.fromhex(
                ...
                callee_4: Account(
                    code=bytes.fromhex(
                        "6040600060406000600073609e4dfe6190235b9a0362084c741d9ec330fb1e6201d4d4f200"  # noqa: E501
                    )
                ),
                callee_5: Account(
                    code=bytes.fromhex(
                        "604060006040600073fee7d85f02f84ce8917fa8300fea57ff41ad47d7620493e0fa00"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
                ...
                callee_6: Account(
                    code=bytes.fromhex(
                        "6040600060406000732db6829f13013d6280c5be4f6a5e87de274a3c476207a120fa60005500"  # noqa: E501
                    )
                ),
                callee_7: Account(
                    code=bytes.fromhex(
                        "60406000604060006000739d41ca9233d19d3202befcef33f16af7201f0eaa6201d4d4f200"  # noqa: E501
                    )
                ),
            },
        },
