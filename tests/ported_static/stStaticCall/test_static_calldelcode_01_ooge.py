...
def test_static_calldelcode_01_ooge(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x249f0, address=0x77612608c7a22f8929f6f1c9462a9954621aeefd, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
