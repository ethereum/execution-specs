    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    code=bytes.fromhex(
                        "6001600152604060006040600073a340f8b0f598f6d5ad2856ffe45aadd934f37cf163017d7840fa50600160035200"  # noqa: E501
                    )
                ),
                callee: Account(
                    code=bytes.fromhex(
                        "60016001526040600060406000600073a340f8b0f598f6d5ad2856ffe45aadd934f37cf16207a120f250600160025200"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "6001600152604060006040600073812297c04813fea96b943b246d9d17ea17545526620f4240fa50600160025200"  # noqa: E501
                    )
                ),
            },
        },
