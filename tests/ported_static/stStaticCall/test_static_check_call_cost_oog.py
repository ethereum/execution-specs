...
def test_static_check_call_cost_oog(
    ...
    # Source: lll
    # { (STATICCALL 100 <contract:0x2000000000000000000000000000000000000000> 0 0 0 0) }
    target = pre.deploy_contract(
        code=Op.STATICCALL(gas=0x64, address=0xebe7ed7a6e995c9843a6df04e332981ebb2772e0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        nonce=0,
    ...
    addr_0x2000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x1, value=0x1) + Op.SHA3(offset=0x0, size=0x2fffff)
        + Op.STOP,
        nonce=0,
