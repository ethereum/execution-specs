...
def test_static_call_with_high_value_and_oo_gat_tx_level(
    ...
    # Source: lll
    # {  [[ 0 ]] (STATICCALL 3000001 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 0 0 0 ) [[ 1 ]] (MLOAD 0) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x2dc6c1, address=0xd5d9e9e0158920b17b6df82fac474b3e2691ee99, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
