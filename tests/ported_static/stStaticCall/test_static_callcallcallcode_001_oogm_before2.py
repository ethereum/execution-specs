...
def test_static_callcallcallcode_001_oogm_before2(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x927c0, address=0x7beca6585c70e19a4a6b3b0452a8c8867fec95e8, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 0 (CALLDATALOAD 0)) (STATICCALL 400080 (CALLDATALOAD 0) 0 64 0 64 ) (MSTORE 32 1) }
    ...
    # Source: lll
    # { (SSTORE 1 1) (CALLCODE 120020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x1)
        + Op.CALLCODE(gas=0x1d4d4, address=0x335c5531b84765a7626e6e76688f18b81be5259c, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        nonce=0,
        address=Address("0xea6e38ec4f121597eea4bab20e02865062d20101"),  # noqa: E501
    )
    # Source: lll
    # { (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) (EXTCODESIZE 1))  (CALLCODE 120020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) }
