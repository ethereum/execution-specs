...
def test_static_loop_calls_depth_then_revert2(
    ...
    # Source: raw
    # 0x6103ff60003514603d57600160003501600052600060006020600073a0000000000000000000000000000000000000005afa5061041a600051106051575b66600060006002f0600052600760196003f0505b
    contract_0 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x3d, condition=Op.EQ(Op.CALLDATALOAD(offset=0x0), 0x3ff))
