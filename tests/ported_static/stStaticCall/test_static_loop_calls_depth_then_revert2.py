    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    code=bytes.fromhex(
                        "6103ff60003514603d57600160003501600052600060006020600073a0000000000000000000000000000000000000005afa5061041a600051106051575b66600060006002f0600052600760196003f0505b"  # noqa: E501
                    )
                )
            },
        },
