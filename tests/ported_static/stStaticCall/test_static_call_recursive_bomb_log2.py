    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    storage={1: 1},
                    code=bytes.fromhex(
                        "600060006000600073b6d3ede67fdcdd6c67468b0ee88bd06fa680f8b3620186a05a03fa600055600160015500"  # noqa: E501
                    ),
                ),
                callee: Account(
                    code=bytes.fromhex(
                        "5a60005260206000a06000600060006000306161a85a03fa00"
                    )
                ),
            },
        },
