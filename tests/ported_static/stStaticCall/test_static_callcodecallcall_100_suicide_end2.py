...
def test_static_callcodecallcall_100_suicide_end2(
    ...
    # Source: lll
    # {  [[ 0 ]] (CALLCODE 150000 <contract:0x1000000000000000000000000000000000000001> 0 0 64 0 64 ) [[ 1 ]] 1 }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0x249f0, address=0x620b381d01cbd812ffb798ab35a1a316bde90ce6, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        ...
        + Op.POP(Op.STATICCALL(gas=0x186a0, address=0x8c800abf2a49ca6ffac93555af4b5c7f9a3a8186, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    # Source: lll
    # {  (MSTORE 3 1) (STATICCALL 50000 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (SELFDESTRUCT <contract:0x1000000000000000000000000000000000000001>) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.STATICCALL(gas=0xc350, address=0x48e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd3, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
