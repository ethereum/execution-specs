...
def test_static_callcallcodecallcode_011_oogm_after2(
    ...
    # Source: lll
    # {  (CALLCODE 40080 <contract:0x1000000000000000000000000000000000000002> 0 0 64 0 64 ) (SSTORE 3 1) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x9c90, address=0x25d69e6a677bd6d872f436bad807c3244a268673, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.SSTORE(key=0x3, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0x0973e7675ca57f8e6deb10cc07de5d8b53956212"),  # noqa: E501
    )
    # Source: lll
    # {  (CALLCODE 40080 <contract:0x1000000000000000000000000000000000000002> 0 0 64 0 64 ) (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) (EXTCODESIZE 1)) }
    addr_0x2000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x9c90, address=0x25d69e6a677bd6d872f436bad807c3244a268673, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.JUMPDEST
        + Op.JUMPI(pc=0x40, condition=Op.ISZERO(Op.LT(Op.MLOAD(offset=0x80), 0xc350)))
        + Op.POP(Op.EXTCODESIZE(address=0x1))
        + Op.MSTORE(offset=0x80, value=Op.ADD(Op.MLOAD(offset=0x80), 0x1))
        + Op.JUMP(pc=0x24) + Op.JUMPDEST + Op.STOP,
        nonce=0,
        address=Address("0x13a5eb6fc2cf111fba5de5c336a9510e8229a44c"),  # noqa: E501
    )
    # Source: lll
    # {  (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.CALLCODE(gas=0x4e34, address=0x335c5531b84765a7626e6e76688f18b81be5259c, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        nonce=0,
