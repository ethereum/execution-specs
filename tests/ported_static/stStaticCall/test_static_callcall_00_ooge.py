    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "6001600252604060006040600073ce21f15217a7b94db9c505a66c9549e803bf141c6201d4d4fa50600160205200"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    storage={0: 1},
                    code=bytes.fromhex(
                        "6040600060406000732814f1be80fce656766c827bc6e55bfb7a3bc4b962055730fa60005500"  # noqa: E501
                    ),
                ),
                callee_2: Account(
                    code=bytes.fromhex(
                        "604060006040600073a18394a87a4c414718bbbee0f695d74cd7a4f9de620249f0fa60005500"  # noqa: E501
                    )
                ),
                callee_3: Account(
                    code=bytes.fromhex(
                        "6001600252604060006040600073e574f7ec5305be91332b5b8b12deb8966e05f42d614e34fa50600160205200"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
                ...
                callee_4: Account(
                    code=bytes.fromhex("6001600255600160025200")
                ),
                callee_5: Account(
                    code=bytes.fromhex(
