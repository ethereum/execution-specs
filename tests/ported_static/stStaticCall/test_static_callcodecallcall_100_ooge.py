...
def test_static_callcodecallcall_100_ooge(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x249f0, address=0xc4961fc5bdc17da68e909d07947a5e030952891e, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 32 (CALLDATALOAD 0)) (STATICCALL 100000 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x20, value=Op.CALLDATALOAD(offset=0x0))
        + Op.POP(Op.STATICCALL(gas=0x186a0, address=0x5ac4ee179abd5ea5f60962e651ded51161a55b6e, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.POP(Op.STATICCALL(gas=0x4e34, address=Op.CALLDATALOAD(offset=0x20), args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        nonce=0,
