...
def test_static_callcodecallcall_abcb_recursive2(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0x17d7840, address=0x2733821fa13c4ead1c9631c76820333f42059b7c, value=Op.CALLVALUE, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
