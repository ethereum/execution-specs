...
def test_static_ab_acalls0(
    ...
    # Source: lll
    # {  [[ (PC) ]] (STATICCALL 100000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 0 0 0) }
    addr_0x095e7baea6a6c7c4c2dfeb977efac326af552d87 = pre.deploy_contract(
        code=Op.SSTORE(key=Op.PC, value=Op.STATICCALL(gas=0x186a0, address=0x9a95017e0dbf52bb87ddfda883b69d6188d574ca, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    addr_0x945304eb96065b2a98b57a48a06ae28d285a71b5 = pre.deploy_contract(
        code=Op.SSTORE(key=Op.PC, value=Op.ADD(0x1, Op.STATICCALL(gas=0xc350, address=0xc54c4be163add3cc0efe5268a599a308dab12c74, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)))  # noqa: E501
        + Op.STOP,
        balance=23,
        nonce=0,
    ...
    # Source: lll
    # {  (MSTORE 1 (PC)) (STATICCALL 100000 <contract:0x245304eb96065b2a98b57a48a06ae28d285a71b5> 0 0 0 0) }
    addr_0x195e7baea6a6c7c4c2dfeb977efac326af552d87 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x1, value=Op.PC)
        + Op.STATICCALL(gas=0x186a0, address=0x718a83e869d6f4dea50a650b9825cbfe683bdf16, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # { (MSTORE 1 (PC)) (STATICCALL 50000 <contract:0x195e7baea6a6c7c4c2dfeb977efac326af552d87> 0 0 0 0) }
    addr_0x245304eb96065b2a98b57a48a06ae28d285a71b5 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x1, value=Op.PC)
        + Op.STATICCALL(gas=0xc350, address=0x7a365d98665a08e6ed6c1638c8ea6775fa649048, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=23,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0x095e7baea6a6c7c4c2dfeb977efac326af552d87: Account(storage={36: 0}, balance=0xde0b6b3a76586a0),
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0x195e7baea6a6c7c4c2dfeb977efac326af552d87: Account(storage={36: 0}, balance=0xde0b6b3a76586a0),
        addr_0x245304eb96065b2a98b57a48a06ae28d285a71b5: Account(storage={38: 0}),
        target: Account(storage={0: 1, 1: 1}),
    },
        },
    ]
