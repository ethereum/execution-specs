...
def test_static_callcallcodecallcode_011_ooge_2(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x249f0, address=0x11a4a9dad43e6ed44e108eaf7fb160f9835068f4, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 3 1) (CALLCODE 100000 (CALLDATALOAD 0) 0 0 64 0 64 ) (MSTORE 3 1)}
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.CALLCODE(gas=0x186a0, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0x11a4a9dad43e6ed44e108eaf7fb160f9835068f4"),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 11) (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) (MSTORE 13 1)}
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        ...
        + Op.MSTORE(offset=0xd, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0xbb2e6e56806816e94a356b0f0c8e53f98e44d6ad"),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 11) (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 1 0 64 0 64 ) (MSTORE 13 1)}
    addr_0x2000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0xb)
        + Op.POP(Op.CALLCODE(gas=0x4e34, address=0x335c5531b84765a7626e6e76688f18b81be5259c, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0xd, value=0x1) + Op.STOP,
        nonce=0,
