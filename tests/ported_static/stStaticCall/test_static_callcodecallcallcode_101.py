...
def test_static_callcodecallcallcode_101(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x55730, address=0xf553d6b8627c39028bd1e05a4f55e2a4b3042a1d, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 1 1) (STATICCALL 300000 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 31 1) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x1, value=0x1)
        + Op.POP(Op.STATICCALL(gas=0x493e0, address=0x999e3c988e5fdf24adf774e3502f0095e6530b72, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    # Source: lll
    # {  (MSTORE 1 1) (DELEGATECALL 250000 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 31 1) }
