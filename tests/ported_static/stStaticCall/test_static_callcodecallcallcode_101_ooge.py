    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    storage={0: 1, 1: 1},
                    code=bytes.fromhex(
                        "604060006040600073af91df7b32c8778f1428f893f7356f90cfc2cbb762055730f4600055600160015500"  # noqa: E501
                    ),
                ),
                callee: Account(
                    code=bytes.fromhex(
                        "604060006040600073fbef21c5a6c2adcf3d769f085e0cc9fe9a8df9546201d4d4f400"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "6040600060406000739126e4f25cc411a2d9d393afedb321eef8a5ac9462030d40fa00"  # noqa: E501
                    )
                ),
                callee_2: Account(
                    code=bytes.fromhex(
