    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "73569cdc3b32cc3f9747bbde39fd70fead591d2f0dff60406000604060007348e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd361c350fa00"  # noqa: E501
                    )
                ),
                ...
                callee_2: Account(
                    code=bytes.fromhex(
                        "6040600060406000600073408f1aceffec7bdaa35d77006cdcaead563bb694620186a0f200"  # noqa: E501
                    )
                ),
            },
        },
