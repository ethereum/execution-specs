...
def test_static_callcallcodecallcode_011_oogm_before2(
    ...
    # Source: lll
    # {  (MSTORE 0 (CALLDATALOAD 0)) [[ 0 ]] (STATICCALL 150000 <contract:0x1000000000000000000000000000000000000001> 0 64 0 64 ) [[ 1 ]] 1 }
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=Op.CALLDATALOAD(offset=0x0))
        + Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x249f0, address=0x8bde6a10a1792232fd09b528800d9ac2a6835424, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 32 1) (CALLCODE 40080 (CALLDATALOAD 0) 0 0 64 0 64 ) (MSTORE 32 1) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x20, value=0x1)
        + Op.POP(Op.CALLCODE(gas=0x9c90, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x20, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0x8bde6a10a1792232fd09b528800d9ac2a6835424"),  # noqa: E501
    )
    # Source: lll
    # {  (SSTORE 3 1) (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) (MSTORE 32 1) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.SSTORE(key=0x3, value=0x1)
        + Op.POP(Op.CALLCODE(gas=0x4e34, address=0xd4286ac3fcac436406bc95f5b0176ad49aed7f7c, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x20, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0x87f0bb05316a8d8146646a151a64f38ae9d25176"),  # noqa: E501
    )
    # Source: lll
    # {  (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) (EXTCODESIZE 1)) (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) (MSTORE 32 1) }
    ...
    # Source: lll
    # {  (CALLCODE 20020 <contract:0x1000000000000000000000000000000000000003> 1 0 64 0 64 ) (MSTORE 32 1) }
    addr_0x3000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x4e34, address=0xd4286ac3fcac436406bc95f5b0176ad49aed7f7c, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x20, value=0x1) + Op.STOP,
        balance=10,
        nonce=0,
