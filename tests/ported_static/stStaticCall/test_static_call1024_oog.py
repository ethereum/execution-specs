...
def test_static_call1024_oog(
    ...
    # Source: lll
    # { [[ 0 ]] (ADD @@0 1) [[ 1 ]] (STATICCALL (MUL (SUB (GAS) 10000) (SUB 1 (DIV @@0 1025))) <contract:0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0) [[ 2 ]] (ADD 1(MUL @@0 1000)) }
    addr_0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(Op.SLOAD(key=0x0), 0x1))
        + Op.SSTORE(key=0x1, value=Op.STATICCALL(gas=Op.MUL(Op.SUB(Op.GAS, 0x2710), Op.SUB(0x1, Op.DIV(Op.SLOAD(key=0x0), 0x401))), address=0x5eb006f1716196a0d072b390030a665386c48b9b, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    # Source: lll
    # { (MSTORE 0 (ADD (MLOAD 0) 1))  (STATICCALL (MUL (SUB (GAS) 10000) (SUB 1 (DIV (MLOAD 0) 1025))) <contract:0xcbbf5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0) (MSTORE 32 (ADD 1(MUL (MLOAD 0) 1000))) }
    addr_0xcbbf5374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        ...
        + Op.POP(Op.STATICCALL(gas=Op.MUL(Op.SUB(Op.GAS, 0x2710), Op.SUB(0x1, Op.DIV(Op.MLOAD(offset=0x0), 0x401))), address=0x42223ec7d9570a769becbe4beed7d885e01e6e37, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
        + Op.MSTORE(offset=0x20, value=Op.ADD(0x1, Op.MUL(Op.MLOAD(offset=0x0), 0x3e8)))
        + Op.STOP,
        balance=1024,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 1, 1: 0, 2: 1001}),
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 0, 1: 0, 2: 0}),
        target: Account(storage={0: 1, 1: 1}),
    },
        },
    ]
