    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "60016000510160005260006000600060007342223ec7d9570a769becbe4beed7d885e01e6e37610401600051046001036127105a0302fa506103e86000510260010160205200"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    storage={0: 1, 2: 1001},
                    code=bytes.fromhex(
                        "6001600054016000556000600060006000735eb006f1716196a0d072b390030a665386c48b9b610401600054046001036127105a0302fa6001556103e86000540260010160025500"  # noqa: E501
                    ),
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
