    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                ...
                contract: Account(
                    code=bytes.fromhex(
                        "600060006000600073a1202b00f0cb8acdd112e4fc87899f33572541c6620927c0fa6009555a600a5500"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "5a60085260006000600060007344969261d9660fcc1a2e03db83ba372ebf5f652d620927c0fa60095200"  # noqa: E501
                    )
                ),
            },
        },
