...
def test_static_call_to_del_call_op_code_check(
    ...
    # Source: lll
    # {  (MSTORE 0 (DELEGATECALL 100000 <contract:0x1000000000000000000000000000000000000002> 0 0 0 0)) (if (= 1 (MLOAD 0)) (MSTORE 1 1) (SSTORE 1 1) ) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=Op.DELEGATECALL(gas=0x186a0, address=0x114ca039127835ca3472ef43e00d15e2d8623286, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        ...
        + Op.JUMPI(pc=0x4b, condition=Op.EQ(0x7ef8271e6cdb0a23220b73bf3e9697e173f9d015, Op.CALLER))
        + Op.SSTORE(key=0x1, value=0x2) + Op.JUMP(pc=0x51) + Op.JUMPDEST
        + Op.MSTORE(offset=0x1, value=0x1) + Op.JUMPDEST
        + Op.JUMPI(pc=0x74, condition=Op.EQ(0x692bdb71bf492107772d8fb07345faa13b37937b, Op.ADDRESS))
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex("000000000000000000000000692bdb71bf492107772d8fb07345faa13b37937b"),  # noqa: E501
        gas_limit=1000000,
        value=0x186a0,
        nonce=0,
        gas_price=10,
