    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                ...
                contract: Account(
                    ...
                    code=bytes.fromhex(
                        "600035600052604060006040600073dc07fff80d888eba04eab962d37897f6c923462b620249f0f46000555a60015500"  # noqa: E501
                    ),
                ),
                callee_1: Account(code=bytes.fromhex("600160025200")),
                callee_2: Account(
                    code=bytes.fromhex(
                        "604060006040600060003561c350fa507399b0d2d9eea3205f4de64fdc26910432824ab1a7ff00"  # noqa: E501
                    )
                ),
            },
        },
