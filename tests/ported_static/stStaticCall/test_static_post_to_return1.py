...
def test_static_post_to_return1(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[1]](STATICCALL 30000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 64 0 0 ) [[2]] (MLOAD 0) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.STATICCALL(gas=0x7530, address=0xd5d9e9e0158920b17b6df82fac474b3e2691ee99, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x0))  # noqa: E501
