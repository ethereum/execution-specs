...
def test_static_call_ripemd160_3_postfixed0(
    ...
    # Source: lll
    # { (MSTORE 0 0xf34578907f00) [[ 2 ]] (STATICCALL 6000 3 0 37 0 32) [[ 0 ]] (MLOAD 0)}
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0xf34578907f00)
        + Op.SSTORE(key=0x2, value=Op.STATICCALL(gas=0x1770, address=0x3, args_offset=0x0, args_size=0x25, ret_offset=0x0, ret_size=0x20))  # noqa: E501
