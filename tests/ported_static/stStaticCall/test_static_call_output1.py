...
def test_static_call_output1(
    ...
    # Source: lll
    # { (MSTORE 0 0x5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6) (STATICCALL 50000 <contract:0xaaae7baea6a6c7c4c2dfeb977efac326af552d87> 0 0 0 0) [[ 0 ]] (MLOAD 0) }
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0x5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6)
        + Op.POP(Op.STATICCALL(gas=0xc350, address=0xbcc1197ccd23a97607f2f96d031f3432e0d16a02, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
