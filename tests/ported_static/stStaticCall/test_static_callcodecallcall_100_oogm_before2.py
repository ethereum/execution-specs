    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                ...
                callee_3: Account(
                    code=bytes.fromhex(
                        "60016003526040600060406000600035619c90fa00"
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
                    code=bytes.fromhex(
                        "6000356000526040600060406000347399fe987d98b818ed5af6ae7b1a91a3be35956195620249f0f2600055600160015500"  # noqa: E501
                    ),
                ),
            },
        },
