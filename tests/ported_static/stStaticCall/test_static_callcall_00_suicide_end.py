    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "6001602052604060006040600073cfb5784a5e49924becc2d5c5d2ee0a9b141e621661c350fa5073a2ca69f1cf9ffa7a761899e8dd2f941d40326fd6ff00"  # noqa: E501
                    )
                ),
                contract: Account(
                    code=bytes.fromhex(
                        "604060006040600073662727c5fec3e62db4f386d95388caedd4067bb8620249f0fa60005500"  # noqa: E501
                    )
                ),
