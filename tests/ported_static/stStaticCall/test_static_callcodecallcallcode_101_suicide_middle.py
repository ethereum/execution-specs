...
def test_static_callcodecallcallcode_101_suicide_middle(
    ...
    # Source: lll
    # {  [[ 0 ]] (DELEGATECALL 150000 0x1000000000000000000000000000000000000001 0 64 0 64 ) [[ 1 ]] 1 }
    ...
    # Source: lll
    # {  (MSTORE 3 1) (STATICCALL 100000 0x1000000000000000000000000000000000000002 0 64 0 64 ) (MSTORE 32 1) }
    contract_1 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.STATICCALL(gas=0x186a0, address=0x1000000000000000000000000000000000000002, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    # Source: lll
    # { (SELFDESTRUCT 0x1000000000000000000000000000000000000000) (DELEGATECALL 50000 0x1000000000000000000000000000000000000003 0 64 0 64 ) }
    contract_2 = pre.deploy_contract(
        code=Op.SELFDESTRUCT(address=0x1000000000000000000000000000000000000000)
        + Op.DELEGATECALL(gas=0xc350, address=0x1000000000000000000000000000000000000003, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
