    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "73cc7b2c7c17e1dd7940b1aa2f4b3e55d7bd662608ff604060006040600060007348e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd361c350f200"  # noqa: E501
                    )
                ),
                callee_1: Account(code=bytes.fromhex("600160035200")),
                callee_2: Account(
                    code=bytes.fromhex(
                        "60016003526040600060406000733a5852e2f86bae6627a307298c4bf906ada12419620186a0fa50600160205200"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
