...
def test_static_call_recursive_bomb2(
    ...
    # Source: lll
    # {  [[ 0 ]] (CALLCODE (GAS) <contract:0x095e7baea6a6c7c4c2dfeb977efac326af552d87> 0 0 0 0 0) [[ 1 ]] 1}
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=Op.GAS, address=0xcf55ff2b7d15859f0cea76885b2d9e850d7dcacd, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 0 (+ (MLOAD 0) 1))  (STATICCALL (- (GAS) 15000) (ADDRESS) 0 0 0 0)  }
    addr_0x095e7baea6a6c7c4c2dfeb977efac326af552d87 = pre.deploy_contract(
        ...
        + Op.STATICCALL(gas=Op.SUB(Op.GAS, 0x3a98), address=Op.ADDRESS, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0x1312d00,
        nonce=0,
