...
def test_static_callcallcallcode_001_suicide_end(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.STATICCALL(gas=0x186a0, address=0x4a31dd3a8c3c9a793ac0b3c234a4dbac2f201404, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000001: Account(storage={1: 0, 3: 0}, balance=0x2540be400),
