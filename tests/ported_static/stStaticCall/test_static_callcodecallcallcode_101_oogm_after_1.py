...
def test_static_callcodecallcallcode_101_oogm_after_1(
    ...
    # Source: lll
    # {  (CALLCODE 700150 <contract:0x1000000000000000000000000000000000000001> 0 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x1000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0xaaef6, address=0xf4645c150a8060778ad94dffe302081fc222dedb, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    # Source: lll
    # {  (STATICCALL 400080 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) (EXTCODESIZE 1)) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.POP(Op.STATICCALL(gas=0x61ad0, address=0x858db7418c9e1c32811e5bc39366bdf6e2ed2492, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.JUMPDEST
    ...
    # Source: lll
    # {  (CALLCODE 120020 <contract:0x1000000000000000000000000000000000000003> 0 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x1d4d4, address=0x335c5531b84765a7626e6e76688f18b81be5259c, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        nonce=0,
    ...
    # Source: lll
    # {  (CALLCODE 700150 <contract:0x2000000000000000000000000000000000000001> 0 0 64 0 64 ) (MSTORE 3 1)}
    addr_0x2000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0xaaef6, address=0x18dc408f6983f318529a93583ee12f590c537820, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # {  (STATICCALL 400080 <contract:0x2000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x2000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.POP(Op.STATICCALL(gas=0x61ad0, address=0x677db155fab75972f19732afb328a0ea6472a6ab, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        nonce=0,
        address=Address("0x18dc408f6983f318529a93583ee12f590c537820"),  # noqa: E501
    )
    # Source: lll
    # {  (CALLCODE 120020 <contract:0x2000000000000000000000000000000000000003> 0 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x2000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x1d4d4, address=0xb126c622075b1189fb6c45e851641cfaddf65b36, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        nonce=0,
