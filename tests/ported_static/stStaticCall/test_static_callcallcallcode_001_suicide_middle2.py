    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "738d1428c10723924a74ab6096c463edaab4cea5fbff604060006040600060007348e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd361c350f200"  # noqa: E501
                    )
                ),
                callee_1: Account(code=bytes.fromhex("600160035200")),
                callee_2: Account(
                    code=bytes.fromhex(
                        "60016003526040600060406000732dfe35a60d7de3d8eeb1d7a015541c76b0e00e9f620186a0fa50600160205200"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
