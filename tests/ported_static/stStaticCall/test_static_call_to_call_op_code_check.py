...
def test_static_call_to_call_op_code_check(
    ...
    # Source: lll
    # {  (MSTORE 0 (CALL 100000 <contract:0x1000000000000000000000000000000000000002> 0 0 0 0 0)) (if (= 1 (MLOAD 0)) (MSTORE 1 1) (SSTORE 1 1) ) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=Op.CALL(gas=0x186a0, address=0xd366057a988cb6562f7fa2a601f06a503d30a90, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        ...
        + Op.JUMPI(pc=0x4b, condition=Op.EQ(0x51a6b9d90fa023dbfe63296b65876f9caf3ff3fd, Op.CALLER))
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex("00000000000000000000000051a6b9d90fa023dbfe63296b65876f9caf3ff3fd"),  # noqa: E501
        gas_limit=1000000,
        value=0x186a0,
        nonce=0,
        gas_price=10,
