    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "604060006040600073c26255d9fcf9d7d38d2734cd4e980b8c00eceef662061ad0fa50600160035500"  # noqa: E501
                    )
                ),
                callee_1: Account(code=bytes.fromhex("600160035200")),
                callee_2: Account(
                    code=bytes.fromhex(
                        "604060006040600073c26255d9fcf9d7d38d2734cd4e980b8c00eceef662061ad0fa505b61c3506080511015603f5760013b506001608051016080526023565b00"  # noqa: E501
                    )
                ),
                callee_3: Account(
                    code=bytes.fromhex(
                        "6040600060406000600073335c5531b84765a7626e6e76688f18b81be5259c6201d4d4f200"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={1: 1},
