...
def test_static_callcodecallcodecallcode_111_suicide_end(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x249f0, address=0x20052c9e11ec43b94405d98f61e2b5e8bb722ed1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
