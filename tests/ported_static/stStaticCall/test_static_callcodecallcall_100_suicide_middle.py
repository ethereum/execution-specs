...
def test_static_callcodecallcall_100_suicide_middle(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x249f0, address=0xcbfd6696cbc67e0593fd4ae8a6646c6ac25ecfb8, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        ...
        + Op.POP(Op.STATICCALL(gas=0x186a0, address=0x408f1aceffec7bdaa35d77006cdcaead563bb694, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.SELFDESTRUCT(address=0x31d06fad70e2a598413824a9bc68d80a5d2b194e)
