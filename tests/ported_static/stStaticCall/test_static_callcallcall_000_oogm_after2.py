    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "6001600352604060006040600073a34eee061f267a63c872265bed51c483f777a7b06206ddd0fa505b61c350608051101560445760013b506001608051016080526028565b00"  # noqa: E501
                    )
                ),
                ...
                contract: Account(
                    storage={111: 1},
                    code=bytes.fromhex(
                        "60406000604060007310345562e309b2045c737ffdd46e941710495fc4620aae60fa6000556001606f5500"  # noqa: E501
                    ),
                ),
                callee_2: Account(
                    code=bytes.fromhex(
                        "6001600352604060006040600073335c5531b84765a7626e6e76688f18b81be5259c6201d4d4fa50600160205200"  # noqa: E501
                    )
                ),
            },
        },
