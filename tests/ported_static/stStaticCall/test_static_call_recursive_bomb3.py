...
def test_static_call_recursive_bomb3(
    ...
    # Source: lll
    # {  [[ 0 ]] (CALLCODE ( - (GAS) 100000) <contract:0x095e7baea6a6c7c4c2dfeb977efac326af552d87> 0 0 0 0 0) [[ 1 ]] 1 }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=Op.SUB(Op.GAS, 0x186a0), address=0xda47db5b3761aed22b9f70aedaa7d54c5e340cc5, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    # Source: lll
    # {  (MSTORE 0 (+ (SLOAD 0) 1)) (STATICCALL (- (GAS) 224) (ADDRESS) 0 0 0 0)  }
    addr_0x095e7baea6a6c7c4c2dfeb977efac326af552d87 = pre.deploy_contract(
        ...
        + Op.STATICCALL(gas=Op.SUB(Op.GAS, 0xe0), address=Op.ADDRESS, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0x1312d00,
        nonce=0,
