...
def test_static_callcallcallcode_001(
    ...
    # Source: lll
    # {  [[ 0 ]] (STATICCALL 350000 <contract:0x1000000000000000000000000000000000000001> 0 64 0 64 ) (MSTORE 3 1)  }
    addr_0x1000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x55730, address=0x5ccb387ab81f41f0b490664795e7004d5d14bf91, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        ...
        + Op.POP(Op.STATICCALL(gas=0x493e0, address=0x82d1fd8c6ed53a58bd8b065074a6b572a7ca89fa, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # { (MSTORE 3 1)  (DELEGATECALL 250000 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.DELEGATECALL(gas=0x3d090, address=0x7e63847aad8ca50fb7c04777dce6871a6bf8de0c, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    addr_0x2000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x55730, address=0x69ce59f2414271f3e079542ef3893a021d7d68ea, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # { (MSTORE 3 1)  (STATICCALL 300000 <contract:0x2000000000000000000000000000000000000002> 0 64 0 64 )(MSTORE 3 1)  }
    addr_0x2000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.STATICCALL(gas=0x493e0, address=0xf18dde9381a558c4be0b84b0f3a17e22b3f9ffce, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # { (MSTORE 3 1)  (DELEGATECALL 250000 <contract:0x2000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 3 1) }
    addr_0x2000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(Op.DELEGATECALL(gas=0x3d090, address=0x335c5531b84765a7626e6e76688f18b81be5259c, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.MSTORE(offset=0x3, value=0x1) + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0x1000000000000000000000000000000000000000: Account(storage={0: 1, 1: 0, 3: 0, 4: 0}),
        addr_0x1000000000000000000000000000000000000001: Account(storage={1: 0, 3: 0, 4: 0}),
