    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    ...
                    code=bytes.fromhex(
                        "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff6000527faaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa602052600260006040600073d5d9e9e0158920b17b6df82fac474b3e2691ee99611388fa60005560005160015500"  # noqa: E501
                    ),
                ),
                callee: Account(code=bytes.fromhex("603760005360026000f3")),
            },
        },
    ]
