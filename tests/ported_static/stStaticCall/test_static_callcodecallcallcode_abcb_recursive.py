...
def test_static_callcodecallcallcode_abcb_recursive(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.STATICCALL(gas=0xf4240, address=0xab5c6018cf3368381e283c1de7f906c456188bc3, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.DELEGATECALL(gas=0x7a120, address=0x2733821fa13c4ead1c9631c76820333f42059b7c, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
