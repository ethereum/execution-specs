    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                ...
                contract: Account(
                    code=bytes.fromhex(
                        "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff6000527faaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa60205260006040604060007315eb18969e0925c8e4a76fd7cbce36a2b056b27e620186a0fa60005500"  # noqa: E501
                    )
                ),
            },
        },
