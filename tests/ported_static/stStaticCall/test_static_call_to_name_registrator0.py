...
def test_static_call_to_name_registrator0(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (STATICCALL 100000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 64 64 0) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x186a0, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, args_offset=0x0, args_size=0x40, ret_offset=0x40, ret_size=0x0))  # noqa: E501
        + Op.STOP,
