...
def test_static_call_create3(
    ...
    # Source: lll
    # {  (MSTORE 0 0x6d600060006000600030620186a0fa600052600e6012f3) [[ 0 ]] (CREATE 1 9 23)  [[ 1 ]] (STATICCALL 30000 (SLOAD 0) 0 0 0 0) [[ 2 ]] 1 }
    contract_1 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0x6d600060006000600030620186a0fa600052600e6012f3)
        + Op.SSTORE(key=0x0, value=Op.CREATE(value=0x1, offset=0x9, size=0x17))
        + Op.SSTORE(key=0x1, value=Op.STATICCALL(gas=0x7530, address=Op.SLOAD(key=0x0), args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex("0000000000000000000000001000000000000000000000000000000000000000"),  # noqa: E501
        gas_limit=1000000,
        value=0x186a0,
        nonce=0,
        gas_price=10,
