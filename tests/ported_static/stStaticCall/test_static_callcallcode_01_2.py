...
def test_static_callcallcode_01_2(
    ...
    # Source: lll
    # {  (STATICCALL 350000 <contract:0x1000000000000000000000000000000000000001> 0 32 0 64 ) }
    addr_0x1000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.STATICCALL(gas=0x55730, address=0xc42c1601b039f8bb80a155b5b6afb4cffeb430a, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # {  (CALLCODE 250000 <contract:0x1000000000000000000000000000000000000002> 2 0 32 0 64 ) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.CALLCODE(gas=0x3d090, address=0x8ad8d964b0888c5016605939dd13e1bdcf679f05, value=0x2, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # {  (STATICCALL 350000 <contract:0x2000000000000000000000000000000000000001> 0 32 0 64 ) }
    addr_0x2000000000000000000000000000000000000000 = pre.deploy_contract(
        code=Op.STATICCALL(gas=0x55730, address=0xf686a2e0e79c5fbb3407d5e53f3ab6b0ab21a51a, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
    ...
    # Source: lll
    # {  (MSTORE 0 (CALLDATALOAD 0)) (CALLCODE 250000 <contract:0x2000000000000000000000000000000000000002> 0 0 32 0 64 ) }
    addr_0x2000000000000000000000000000000000000001 = pre.deploy_contract(
        ...
        + Op.CALLCODE(gas=0x3d090, address=0x2fcc143c5267b6c6ce4e1abd936e84eedffd6a4e, value=0x0, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0xde0b6b3a7640000,
        nonce=0,
