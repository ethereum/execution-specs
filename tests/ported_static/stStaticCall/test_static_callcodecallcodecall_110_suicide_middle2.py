...
def test_static_callcodecallcodecall_110_suicide_middle2(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.CALLCODE(gas=0x186a0, address=0x408f1aceffec7bdaa35d77006cdcaead563bb694, value=Op.CALLVALUE, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    addr_0x1000000000000000000000000000000000000002 = pre.deploy_contract(
        code=Op.SELFDESTRUCT(address=0x44d09ddf088dd88c0e91fa7ef74973ff94ad7414)
