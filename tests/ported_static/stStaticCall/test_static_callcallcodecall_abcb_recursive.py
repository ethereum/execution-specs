    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                ...
                callee: Account(
                    code=bytes.fromhex(
                        "604060006040600073e07076b3a07ff8e567e4f8451dac25bacefb88b2620f4240f400"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "6040600060406000732c81f66472668c71014ce3a9537b033db57af77b6207a120fa00"  # noqa: E501
                    )
                ),
            },
        },
