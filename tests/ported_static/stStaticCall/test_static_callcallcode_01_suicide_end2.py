...
def test_static_callcallcode_01_suicide_end2(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0x249f0, address=0x5de1c119e1fc3598726f4d9411debd7ed1402187, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    # Source: lll
    # {  (CALLCODE 50000 <contract:0x1000000000000000000000000000000000000002> 0 0 64 0 64 ) (SELFDESTRUCT <contract:target:0x1000000000000000000000000000000000000000>) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0xc350, address=0xcfb5784a5e49924becc2d5c5d2ee0a9b141e6216, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
