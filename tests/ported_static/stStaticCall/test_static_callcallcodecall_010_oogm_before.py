    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                contract: Account(
                    storage={0: 1, 1: 1},
                    code=bytes.fromhex(
                        "600035600052604060006040600073e7b982648e452964fb0ac2b867efa7c7b5b93d916207a120fa600055600160015500"  # noqa: E501
                    ),
                ),
                callee: Account(code=bytes.fromhex("600160035200")),
                callee_1: Account(
                    code=bytes.fromhex(
                        "6001600355604060006040600073335c5531b84765a7626e6e76688f18b81be5259c6201d4d4fa00"  # noqa: E501
                    )
                ),
                callee_2: Account(
                    code=bytes.fromhex("604060006040600060003562061ad0f400")
                ),
                callee_3: Account(
                    code=bytes.fromhex(
