...
def test_static_internal_call_hitting_gas_limit(
    ...
    # Source: lll
    # { (STATICCALL 5000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0) }
    target = pre.deploy_contract(
        code=Op.STATICCALL(gas=0x1388, address=0x285bb5c8a71646ab9a5796d4a718cc4826af8d06, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0xf4240,
        nonce=0,
