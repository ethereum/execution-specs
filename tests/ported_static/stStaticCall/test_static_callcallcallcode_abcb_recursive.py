    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "6001600152604060006040600073458e20b622ec33a82f2a43a90edc52a429639916620f4240fa506001601f5200"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex(
                        "600160015260406000604060007334baf5e282fcbde0d147efd6f95e606cc8c274856207a120f450600160155200"  # noqa: E501
                    )
                ),
                contract: Account(
                    code=bytes.fromhex(
                        "600160015260406000604060007334baf5e282fcbde0d147efd6f95e606cc8c2748563017d7840fa506001601f5200"  # noqa: E501
                    )
                ),
            },
        },
