...
def test_static_call_recursive_bomb1(
    ...
    target = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=Op.GAS, address=0xcf55ff2b7d15859f0cea76885b2d9e850d7dcacd, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
