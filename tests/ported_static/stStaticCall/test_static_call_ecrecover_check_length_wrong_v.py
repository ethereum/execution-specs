...
def test_static_call_ecrecover_check_length_wrong_v(
    ...
    target = pre.deploy_contract(
        code=Op.MSTORE(offset=0x80, value=0x1122334455667788990011223344556677889900112233445566778899001122)
        ...
        + Op.SSTORE(key=0x2, value=Op.STATICCALL(gas=0x493e0, address=0x1, args_offset=0x0, args_size=0x80, ret_offset=0x80, ret_size=0x20))  # noqa: E501
    ...
    post = {
        target: Account(
                storage={
            0: 0x1122334455667788990011223344556677889900112233445566778899001122,
            1: 160,
            2: 1,
        },
            ),
