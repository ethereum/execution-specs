    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex("6040600060406000600035620493e0fa00")
                ),
                ...
                contract: Account(
                    storage={0: 1, 1: 1},
                    code=bytes.fromhex(
                        "600035600052604060006040600034731b78afbe56d4678cfa8dc79df079bad5585b8d3a62055730f2600055600160015500"  # noqa: E501
                    ),
                ),
                callee_3: Account(
                    code=bytes.fromhex(
