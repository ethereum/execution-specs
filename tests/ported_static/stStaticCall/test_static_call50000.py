    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    storage={1: 50000},
                    code=bytes.fromhex(
                        "5b61c3506080511015603e576000600061c3506000737efd7e4e34d1783f5d86b7862a37b3bbbd13deb8620186a0fa6000556001608051016080526000565b60805160015500"  # noqa: E501
                    ),
                ),
                callee_1: Account(
                    storage={0: 1}, code=bytes.fromhex("60005460005200")
                ),
                callee_2: Account(
                    storage={0: 1}, code=bytes.fromhex("60005460005500")
                ),
                callee_3: Account(
                    code=bytes.fromhex(
                        "5b61c3506080511015603e576000600061c3506000736d440cd3e818056e21914c856e3712f4186b06c8620186a0fa6000556001608051016080526000565b60805160205500"  # noqa: E501
                    )
                ),
                contract: Account(
                    storage={0: 1, 1: 1},
