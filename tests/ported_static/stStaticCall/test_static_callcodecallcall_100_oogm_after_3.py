...
def test_static_callcodecallcall_100_oogm_after_3(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xeaf6, address=0x2865fd3572b0b77173e5ed91e968acad55701151, value=Op.CALLVALUE, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        ...
        + Op.POP(Op.STATICCALL(gas=0x9c90, address=0x694b007c276285e1a2424a78288abf42fdda6e71, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.JUMPDEST
    ...
    # Source: lll
    # {  (MSTORE 3 1) (STATICCALL 20020 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 32 1) }
