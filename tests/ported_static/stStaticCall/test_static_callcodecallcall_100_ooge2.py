    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "result": {
                callee: Account(
                    code=bytes.fromhex(
                        "60003560005260406000604060007333e1ad2a3ae944798e9ed4689b85d9136b59ebd2620186a0fa00"  # noqa: E501
                    )
                ),
                callee_1: Account(
                    code=bytes.fromhex("6040600060406000600035614e34fa00")
                ),
                callee_2: Account(code=bytes.fromhex("600160035500")),
                contract: Account(
                    storage={0: 1, 1: 1},
                    code=bytes.fromhex(
                        "6000356000526040600060406000347303c7aef27501fce796222312bcd7a4546dd60637620249f0f2600055600160015500"  # noqa: E501
                    ),
                ),
                callee_3: Account(
                    code=bytes.fromhex(
