...
def test_static_call_contract_to_create_contract_oog(
    ...
    # Source: lll
    # {(MSTORE 0 0x600c60005566602060406000f060205260076039f3) [[0]](CREATE 1 11 21) (STATICCALL 0 (SLOAD 0) 0 0 0 0)}
    contract_0 = pre.deploy_contract(
        ...
        + Op.STATICCALL(gas=0x0, address=Op.SLOAD(key=0x0), args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)  # noqa: E501
        + Op.STOP,
        nonce=0,
