...
def test_test_contract_suicide(
    ...
    target = pre.deploy_contract(
        ...
        + Op.JUMP(pc=0x15a) + Op.JUMPDEST + Op.MSTORE(offset=0x0, value=Op.DUP1)
        + Op.RETURN(offset=0x0, size=0x20) + Op.JUMPDEST + Op.PUSH1[0x0] * 2
        ...
        + Op.JUMPI(pc=0x137, condition=Op.CALL) + Op.STOP + Op.JUMPDEST
        + Op.POP * 2
        ...
        + Op.PUSH2[0x164] + Op.JUMP(pc=Op.PUSH2[0x5d]) + Op.JUMPDEST
