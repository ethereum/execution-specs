...
def test_test_keywords(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SWAP1 + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP2
        + Op.JUMPI(pc=0xcd, condition=Op.ISZERO(0x1)) + Op.JUMPDEST
        + Op.JUMPI(pc=0xa1, condition=Op.ISZERO(Op.SLT(Op.DUP3, 0xa)))
        + Op.PUSH1[0x1] + Op.SWAP1 + Op.SWAP2 + Op.ADD + Op.SWAP1
        + Op.JUMP(pc=0x8f) + Op.JUMPDEST
        ...
        + Op.PUSH1[0x1] + Op.SWAP2 + Op.DUP3 + Op.SWAP1 + Op.SUB + Op.SWAP2
        + Op.SWAP1 + Op.SUB + Op.JUMP(pc=0xb0) + Op.JUMPDEST * 2
        + Op.JUMP(pc=0xd5) + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SWAP3 + Op.POP
        + Op.JUMP(pc=0xed) + Op.JUMPDEST
        + Op.JUMPI(pc=0xe0, condition=Op.EQ(0x0, Op.DUP2)) + Op.JUMP(pc=0xe8)
        + Op.JUMPDEST + Op.PUSH1[0x1] + Op.SWAP3 + Op.POP + Op.JUMP(pc=0xed)
        + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SWAP3 + Op.POP + Op.JUMPDEST
        + Op.POP * 2 + Op.SWAP1 + Op.JUMP,
        balance=0x186a0,
        nonce=0,
