...
def test_test_cryptographic_functions(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.JUMP(pc=0x108) + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SWAP1 + Op.POP
        + Op.JUMP(pc=0x2ec) + Op.JUMPDEST
        + Op.MUL(0x1, 0x3c8727e019a42b444667a587b6001251becadabbb36bfed8087a92c18882d111)
        + Op.PUSH1[0x2] + Op.PUSH1[0x20] + Op.PUSH1[0x0] * 2
        + Op.MSTORE(offset=Op.DUP2, value=0x74657374737472696e6700000000000000000000000000000000000000000000)
        + Op.PUSH1[0xa] + Op.ADD + Op.PUSH1[0x0] * 2 + Op.DUP6
        + Op.SUB(Op.GAS, 0x61da) + Op.JUMPI(pc=0x16b, condition=Op.CALL)
        + Op.STOP + Op.JUMPDEST + Op.POP + Op.MLOAD(offset=0x0)
        ...
        + Op.PUSH1[0x3] + Op.PUSH1[0x20] + Op.PUSH1[0x0] * 2
        + Op.MSTORE(offset=Op.DUP2, value=0x74657374737472696e6700000000000000000000000000000000000000000000)
        + Op.PUSH1[0xa] + Op.ADD + Op.PUSH1[0x0] * 2 + Op.DUP6
        + Op.SUB(Op.GAS, 0x61da) + Op.JUMPI(pc=0x1e6, condition=Op.CALL)
        ...
        + Op.PUSH1[0x1] + Op.PUSH1[0x20] + Op.PUSH1[0x0] * 2
        ...
        + Op.SUB(Op.GAS, 0x61da) + Op.JUMPI(pc=0x2bd, condition=Op.CALL)
        + Op.STOP + Op.JUMPDEST + Op.POP
        ...
        + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SWAP1 + Op.POP + Op.JUMP(pc=0x2ec)
        + Op.JUMPDEST * 2 + Op.SWAP1 + Op.JUMP,
        balance=0x186a0,
        nonce=0,
