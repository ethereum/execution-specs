...
def test_create_and_gas_inside_create(
    ...
    # Source: lll
    # { [100] (GAS) (MSTORE 0 0x5a60fd55) (SSTORE 11 (CREATE 0 28 4)) (SSTORE 9 (SUB @100 (GAS))) }
    ...
    post = {
        ...
        Address("0xf1ecf98489fa9ed60a664fc4998db699cfa39d40"): Account(storage={253: 0x83729}),  # noqa: E501
    }
