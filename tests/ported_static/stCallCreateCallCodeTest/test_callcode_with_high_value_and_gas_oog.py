...
def test_callcode_with_high_value_and_gas_oog(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (CALLCODE 0xffffffffffffffffffffffff <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 100000000000000000000 0 64 0 2 ) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xffffffffffffffffffffffff, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0x56bc75e2d63100000, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))  # noqa: E501
        + Op.STOP,
