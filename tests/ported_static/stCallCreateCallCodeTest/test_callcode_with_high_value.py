...
def test_callcode_with_high_value(
    ...
    # Source: lll
    # {  [[ 0 ]] (CALLCODE 50000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 1000000000000000001 0 64 0 2 ) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc350, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0xde0b6b3a7640001, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))  # noqa: E501
        + Op.STOP,
