...
def test_call_with_high_value_oo_gin_call(
    ...
    # Source: lll
    # {  [[ 0 ]] (ADD (CALL 10000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 1000000000000000000 0 0 0 0 ) 1) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(Op.CALL(gas=0x2710, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0xde0b6b3a7640000, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0), 0x1))  # noqa: E501
        + Op.STOP,
    ...
    post = {
        ...
        addr_0x945304eb96065b2a98b57a48a06ae28d285a71b5: Account(balance=23),
    }
