...
def test_callcode_lose_gas_oog(
    ...
    # Source: lll
    # { [[ 0 ]] (ADD @@0 1) [[ 1 ]] (CALLCODE (ADD 1(MUL @@0 100000)) <contract:target:0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[ 2 ]] (ADD 1(MUL @@0 1000)) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(Op.SLOAD(key=0x0), 0x1))
        + Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=Op.ADD(0x1, Op.MUL(Op.SLOAD(key=0x0), 0x186a0)), address=0xb0fafbe5aa1d6f184eb4bcb79b292e4d3238f4ca, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
