...
def test_delegatecall_in_initcode_to_existing_contract(
    ...
    # Source: lll
    # { (MSTORE 0 0x604060006040600073945304eb96065b2a98b57a48a06ae28d285a71b5620186) (MSTORE 32 0xa0f4600055336001550000000000000000000000000000000000000000000000) (CREATE 1 0 64) }
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x2, value=0x1) + Op.SSTORE(key=0xb, value=Op.CALLER)  # noqa: E501
        + Op.STOP,
        nonce=0,
