...
def test_delegatecall_in_initcode_to_empty_contract(
    ...
    # Source: lll
    # { (MSTORE 0 0x604060006040600073945304eb96065b2a98b57a48a06ae28d285a71b5620186) (MSTORE 32 0xa0f4600055000000000000000000000000000000000000000000000000000000) (CREATE 1 0 64) }
    ...
    post = {
        Address("0x13136008b64ff592819b2fa6d43f2835c452020e"): Account(storage={0: 1}, balance=1),  # noqa: E501
    }
