...
def test_call_with_high_value_and_gas_oog(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (DELEGATECALL 0xffffffffffffffffffffffff <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 64 0 2 ) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0xffffffffffffffffffffffff, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))  # noqa: E501
        + Op.STOP,
