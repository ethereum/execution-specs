...
def test_underflow_test(
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.SIGNEXTEND(0x80, 0x80) + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.LOG0 + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.BYTE + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.DUP1 + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.BALANCE(address=0x80) + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.SWAP1 + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.SMOD + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.SDIV + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.DUP2 + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(key=0x1, value=0x1) + Op.PUSH1[0x80] + Op.SHA3 + Op.STOP
        ),
        storage={0x1: 0x60A7},
        nonce=0,
    ...
    post = {
        Address("0x0000000000000000000000000000000000000101"): Account(
            storage={1: 24743},
        ),
