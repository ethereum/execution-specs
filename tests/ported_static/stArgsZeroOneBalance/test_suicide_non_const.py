...
def test_suicide_non_const(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SELFDESTRUCT(address=Op.BALANCE(address=0x95e7baea6a6c7c4c2dfeb977efac326af552d87))
        + Op.STOP,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        contract_0: Account(
                storage={},
                code=bytes.fromhex("73095e7baea6a6c7c4c2dfeb977efac326af552d8731ff00"),  # noqa: E501
                balance=0,
                nonce=0,
            ),
    },
