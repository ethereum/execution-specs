...
def test_delegatecall_non_const(
    ...
    # Source: lll
    # { [[ 0 ]] (DELEGATECALL (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>) (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>) (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>) (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>) (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>) (BALANCE <contract:target:0x095e7baea6a6c7c4c2dfeb977efac326af552d87>)) }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4), address=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4), args_offset=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4), args_size=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4), ret_offset=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4), ret_size=Op.BALANCE(address=0x365aae42316e918da716d904fe31eea4134112c4)))  # noqa: E501
        + Op.STOP,
        nonce=0,
