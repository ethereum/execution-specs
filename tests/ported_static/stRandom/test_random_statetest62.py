...
def test_random_statetest62(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7268713013964a96ac57580433250155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x493fbf98,
        nonce=0,
        gas_price=10,
