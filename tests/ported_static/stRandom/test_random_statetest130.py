...
def test_random_statetest130(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x368a668b76306d181a39361198831755),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x720306c0,
        nonce=0,
        gas_price=10,
