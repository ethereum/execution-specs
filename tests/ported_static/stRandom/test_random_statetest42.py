...
def test_random_statetest42(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.BYTE(0x36f0f11901, Op.CALLDATALOAD(offset=Op.PUSH32[0xc350])), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=221233021,
        value=0x61b9caa3,
        nonce=0,
        gas_price=10,
