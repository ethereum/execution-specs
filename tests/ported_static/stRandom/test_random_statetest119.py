...
def test_random_statetest119(
    ...
    target = pre.deploy_contract(
        code=Op.GASLIMIT + Op.MSIZE + Op.NUMBER + Op.PUSH32[0x1]
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x52503b127c115a9673a4313790956655),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x189731ca,
        nonce=0,
        gas_price=10,
