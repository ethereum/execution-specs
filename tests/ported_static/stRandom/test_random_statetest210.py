...
def test_random_statetest210(
    ...
    target = pre.deploy_contract(
        code=Op.GASLIMIT + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.TIMESTAMP
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0x10000000000000000000000000000000000000000], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x6a1b0d6a,
        nonce=0,
        gas_price=10,
