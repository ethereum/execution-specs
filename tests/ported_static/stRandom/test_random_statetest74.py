...
def test_random_statetest74(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x141097788a7b5a72139c07076f184255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x48e72790,
        nonce=0,
        gas_price=10,
