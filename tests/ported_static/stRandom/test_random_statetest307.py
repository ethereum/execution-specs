...
def test_random_statetest307(
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4aca7f0d,
        nonce=0,
        gas_price=10,
    ...
    post = {
        ...
        Address("0x91ed00a0a906270d466af043c4e111dadca970a3"): Account.NONEXISTENT,  # noqa: E501
