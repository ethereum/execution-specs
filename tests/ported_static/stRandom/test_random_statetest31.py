...
def test_random_statetest31(
    ...
    target = pre.deploy_contract(
        code=Op.CODESIZE + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xc350] * 2
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xc350] + Op.PUSH32[0x0] * 2 + Op.SWAP1 + Op.CALLDATACOPY
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x50282fa0,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
            ...
            0x387f000000000000000000000001000000000000000000000000000000000000: 50000,
        },
                nonce=0,
            ),
