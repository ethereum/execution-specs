...
def test_random_statetest279(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4e91b038,
        nonce=0,
        gas_price=10,
