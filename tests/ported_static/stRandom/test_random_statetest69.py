...
def test_random_statetest69(
    ...
    target = pre.deploy_contract(
        ...
        + Op.NUMBER + Op.MSIZE
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x15a0770a7676611a6595057b768b6455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x2f6c315b,
        nonce=0,
        gas_price=10,
