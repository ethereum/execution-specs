...
def test_random_statetest100(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.PREVRANDAO, value=Op.CALLCODE(gas=Op.DUP4, address=Op.TIMESTAMP, value=Op.PREVRANDAO, args_offset=Op.TIMESTAMP, args_size=Op.NUMBER, ret_offset=Op.PREVRANDAO, ret_size=Op.NUMBER)),  # noqa: E501
