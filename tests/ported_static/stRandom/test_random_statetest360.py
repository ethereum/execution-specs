...
def test_random_statetest360(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x441548af30803135562840563829c55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x3b167c0b,
        nonce=0,
        gas_price=10,
