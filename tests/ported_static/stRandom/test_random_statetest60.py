...
def test_random_statetest60(
    ...
    target = pre.deploy_contract(
        code=Op.TIMESTAMP + Op.PUSH32[0x0] + Op.TIMESTAMP
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x969001091aa15b8b9b75459d015a0455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x54de1eaf,
        nonce=0,
        gas_price=10,
