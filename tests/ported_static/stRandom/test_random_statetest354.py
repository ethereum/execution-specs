...
def test_random_statetest354(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xc350] + Op.CALLDATALOAD(offset=0x3b)
        + Op.PUSH5[0x1a8e739f86] + Op.SWAP9 + Op.EXP + Op.NUMBER
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x24aaaaf6,
        nonce=0,
        gas_price=10,
