...
def test_random_statetest339(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0x1] + Op.PUSH32[0x0]
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0]
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x89029e850708a293905668f1a367a255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x3f78c8aa,
        nonce=0,
        gas_price=10,
