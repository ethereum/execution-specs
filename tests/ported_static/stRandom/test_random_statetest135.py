...
def test_random_statetest135(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.DIV(Op.DUP8, Op.AND(0x3192186630, Op.SIGNEXTEND(Op.GAS, Op.SMOD(Op.CREATE(value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], size=Op.PUSH32[0x0]), Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])))), value=Op.PUSH32[0x0]),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x625b8cef,
        nonce=0,
        gas_price=10,
