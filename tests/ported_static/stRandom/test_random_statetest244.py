...
def test_random_statetest244(
    ...
    target = pre.deploy_contract(
        code=Op.SMOD(Op.TIMESTAMP, Op.GASLIMIT) + Op.NUMBER * 2 + Op.TIMESTAMP
        + Op.SSTORE(key=Op.MLOAD(offset=Op.BALANCE(address=Op.COINBASE)), value=Op.COINBASE),  # noqa: E501
