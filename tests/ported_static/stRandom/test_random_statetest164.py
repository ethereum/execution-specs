...
def test_random_statetest164(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x6d7148ee,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
            ...
            0x4f3f701464972e74606d6ea82d4d3080599a0e79: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe,
        },
                nonce=0,
            ),
