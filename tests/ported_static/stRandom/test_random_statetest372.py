...
def test_random_statetest372(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.ADDMOD(Op.XOR(Op.PUSH32[0x1], Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]), Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5], Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5])),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x6d4bea09,
        nonce=0,
        gas_price=10,
