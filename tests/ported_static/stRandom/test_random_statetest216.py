...
def test_random_statetest216(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x0] + Op.PUSH32[0xc350] * 2 + Op.PREVRANDAO
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x766d67fe07853208991306449455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x288181dd,
        nonce=0,
        gas_price=10,
