...
def test_random_statetest292(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x1] + Op.ADDRESS + Op.PUSH4[0xa09c825a] + Op.CALLER
        + Op.DUP15,
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x315d53c8,
        nonce=0,
        gas_price=10,
