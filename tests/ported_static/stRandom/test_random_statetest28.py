...
def test_random_statetest28(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x51af41e7,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
                storage={
            0xdf2d980d762338e0da723885b33558d435309a78: 0x38129d68939a19a2697172926f6a6736,
        },
                nonce=0,
            ),
