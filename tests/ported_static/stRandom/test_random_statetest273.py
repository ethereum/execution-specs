...
def test_random_statetest273(
    ...
    target = pre.deploy_contract(
        code=Op.NUMBER + Op.TIMESTAMP * 2 + Op.NUMBER * 2 + Op.TIMESTAMP
        + Op.JUMPDEST + Op.PREVRANDAO + Op.SWAP6 + Op.SELFDESTRUCT + Op.CREATE
        + Op.TIMESTAMP + Op.SSTORE(key=0x99, value=Op.DUP6),
