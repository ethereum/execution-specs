...
def test_random_statetest64(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.TIMESTAMP + Op.PUSH32[0x1]
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x34179199,
        nonce=0,
        gas_price=10,
