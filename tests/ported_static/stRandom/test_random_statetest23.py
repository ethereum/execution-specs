...
def test_random_statetest23(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x1] + Op.TIMESTAMP
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] * 2
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x89418c1076f1544315601489386c9155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x27cd2e4b,
        nonce=0,
        gas_price=10,
