...
def test_random_statetest63(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x0]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] * 2
        + Op.PUSH32[0xc350] + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x977f157e088003767a86928e82529655),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x31b19d43,
        nonce=0,
        gas_price=10,
