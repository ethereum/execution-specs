...
def test_random_statetest115(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x15448e363302150a6f56518aa0053155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=3202574,
        value=0x74270083,
        nonce=0,
        gas_price=10,
