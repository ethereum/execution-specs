...
def test_random_statetest29(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.ADDMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0x0], Op.PUSH32[0x10000000000000000000000000000000000000000])), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x214ab1f3,
        nonce=0,
        gas_price=10,
