...
def test_random_statetest155(
    ...
    target = pre.deploy_contract(
        code=Op.GASLIMIT + Op.PUSH32[0x0]
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x3494f39b6ca29473a199580308910155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x228b052c,
        nonce=0,
        gas_price=10,
