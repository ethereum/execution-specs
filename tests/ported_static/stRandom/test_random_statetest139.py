...
def test_random_statetest139(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x409ceff3,
        nonce=0,
        gas_price=10,
