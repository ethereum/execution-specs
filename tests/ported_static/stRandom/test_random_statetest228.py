...
def test_random_statetest228(
    ...
    target = pre.deploy_contract(
        code=Op.COINBASE + Op.NUMBER + Op.GASLIMIT + Op.NUMBER + Op.GASLIMIT * 2
        + Op.SSTORE(key=Op.SLOAD(key=Op.EXTCODESIZE(address=Op.PREVRANDAO)), value=Op.COINBASE),  # noqa: E501
