...
def test_random_statetest254(
    ...
    target = pre.deploy_contract(
        ...
        + Op.COINBASE * 2 + Op.PUSH32[0x1] + Op.PREVRANDAO
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x59b6b83f294740688598c52195a9255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x5c13c2ff,
        nonce=0,
        gas_price=10,
