...
def test_random_statetest281(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] * 2 + Op.GASLIMIT
        + Op.PUSH32[0xc350] + Op.COINBASE + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x649a7a3457645670a27fa170639718a2),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x662e647c,
        nonce=0,
        gas_price=10,
