...
def test_random_statetest179(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x515480126a50a173506e066762129255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x5e6cf4ec,
        nonce=0,
        gas_price=10,
