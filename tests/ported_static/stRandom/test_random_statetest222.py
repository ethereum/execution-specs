...
def test_random_statetest222(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.DUP2),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x66f96b9f,
        nonce=0,
        gas_price=10,
