...
def test_random_statetest39(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x1040dc3b,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
            ...
            0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff715de955: 0x14f8b588e368f08461f9f01b866e43aa79bbadc0980b242070b8cfbfc6540,
        },
                nonce=0,
            ),
