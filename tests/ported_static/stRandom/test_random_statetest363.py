...
def test_random_statetest363(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7b20937d953695f369719f9a44790555),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4c18b65e,
        nonce=0,
        gas_price=10,
