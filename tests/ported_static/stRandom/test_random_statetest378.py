...
def test_random_statetest378(
    ...
    target = pre.deploy_contract(
        code=Op.SLOAD(key=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])  # noqa: E501
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1]
        + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.GAS + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x855b445834721a5706f2891711f00255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
