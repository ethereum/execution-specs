...
def test_random_statetest301(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] * 2
        + Op.PUSH32[0xc350]
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x1340f9ce,
        nonce=0,
        gas_price=10,
