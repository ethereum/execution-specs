...
def test_random_statetest102(
    ...
    target = pre.deploy_contract(
        code=Op.GASLIMIT + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PREVRANDAO * 2 + Op.PUSH32[0x0] * 2 + Op.PUSH32[0x1]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x157094ffff1a04893a9cf3858b857655),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x25d01ae2,
        nonce=0,
        gas_price=10,
