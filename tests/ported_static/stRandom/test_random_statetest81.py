...
def test_random_statetest81(
    ...
    target = pre.deploy_contract(
        ...
        + Op.NUMBER
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x616c327e0435743c515b078453a03c55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x358ab2e1,
        nonce=0,
        gas_price=10,
