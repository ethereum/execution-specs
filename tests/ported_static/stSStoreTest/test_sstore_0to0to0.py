...
TX_DATA = [
    ...
    "6000601080603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe60006000556000600055600160015500",
...
def test_sstore_0to0to0(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x0bdfb5bb25de41df5ef3e68904843c7a7b92d35f"): Account(storage={1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
