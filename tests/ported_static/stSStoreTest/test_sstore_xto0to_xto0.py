...
def test_sstore_xto0to_xto0(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=0x0) + Op.STOP,
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        contract_2: Account(storage={1: 1}),
        Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={1: 0}, nonce=1),  # noqa: E501
    },
        },
        {
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0xa26b643c4ba8272d24f60806a37b20f255620586"): Account(storage={0: 0, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
