...
TX_DATA = [
    ...
    "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600160005560026000556003600055600160015500",
    ...
    "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560026000556003600055600160015500",
]
...
def test_sstore_xto_yto_z(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x2) + Op.SSTORE(key=0x1, value=0x3) + Op.STOP,  # noqa: E501
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        contract_2: Account(storage={1: 1}),
        Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={1: 3}, nonce=1),  # noqa: E501
    },
        },
        {
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0xde59ca290fa8b9e3db697325d153c540ac08321d"): Account(storage={0: 3, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
