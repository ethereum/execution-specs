...
def test_sstore_change_from_external_call_in_init_code(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x0) + Op.SSTORE(key=0x1, value=0x1)
        + Op.SSTORE(key=0x0, value=0x1) + Op.STOP,
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        {
            "indexes": {'data': [2, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16], 'gas': 0, 'value': -1},
            "network": ['>=Cancun'],
            "result": {
        contract_0: Account(storage={0: 0, 1: 1}, nonce=0),
        Address("0x6602cfc925be62bf18470598a98f72812a1ebef2"): Account.NONEXISTENT,  # noqa: E501
    },
        },
        {
            ...
            "result": {
        contract_0: Account(storage={0: 0, 1: 1}, nonce=0),
        Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={0: 1, 1: 1}, nonce=1),  # noqa: E501
    },
        },
        {
            ...
            "result": {
        contract_0: Account(storage={0: 0, 1: 1}, nonce=0),
        Address("0x0f446e1bd7a5da68b5e3a305c7030e3aa8efc293"): Account(storage={0: 1, 1: 1}, nonce=1),  # noqa: E501
    },
        },
    ]
