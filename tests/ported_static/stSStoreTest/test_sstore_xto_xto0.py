...
TX_DATA = [
    ...
    "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560016000556000600055600160015500",
]
...
def test_sstore_xto_xto0(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x1) + Op.SSTORE(key=0x1, value=0x0) + Op.STOP,  # noqa: E501
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x01b59db2b74b93797420b1a86a28fe35f1e7d0dd"): Account(storage={1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
