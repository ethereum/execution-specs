...
Ported from:
state_tests/stSStoreTest/sstore_0toXtoXFiller.json
"""
...
TX_DATA = [
    ...
    "6000601080603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe60016000556001600055600160015500",
    ...
    "6000601080603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe60016000556001600055600160015500",
]
...
def test_sstore_0to_xto_x(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0xf797d87eb948007fd777404ef459196b099d3ebe"): Account(storage={0: 1, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
