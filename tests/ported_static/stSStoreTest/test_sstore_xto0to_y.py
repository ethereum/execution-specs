...
TX_DATA = [
    ...
    "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600260005560006000556001600055600160015500",
...
def test_sstore_xto0to_y(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x0) + Op.SSTORE(key=0x1, value=0x1) + Op.STOP,  # noqa: E501
        storage={1: 2},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x7123afcd1c327c946e05b4fb8aea10ad0f85cb52"): Account(storage={0: 1, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
