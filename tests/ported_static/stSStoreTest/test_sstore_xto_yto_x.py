...
TX_DATA = [
    ...
    "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600160005560026000556001600055600160015500",
    ...
    "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560026000556001600055600160015500",
]
...
def test_sstore_xto_yto_x(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x2) + Op.SSTORE(key=0x1, value=0x1) + Op.STOP,  # noqa: E501
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        contract_0: Account(storage={1: 1}),
        contract_2: Account(storage={1: 1}),
        Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={1: 1}, nonce=1),  # noqa: E501
    },
        },
        {
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x90b7d8d4bc39664e30be0c2380e2b04aa15c6518"): Account(storage={0: 1, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
