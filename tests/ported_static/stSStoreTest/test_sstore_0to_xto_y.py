...
Ported from:
state_tests/stSStoreTest/sstore_0toXtoYFiller.json
"""
...
TX_DATA = [
    ...
    "6000601080603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe60026000556001600055600160015500",
]
...
def test_sstore_0to_xto_y(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0xef24be216c6eaaade3b2496281d7b66fc2669f03"): Account(storage={0: 1, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
