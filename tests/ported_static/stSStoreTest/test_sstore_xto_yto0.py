...
TX_DATA = [
    ...
    "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600160005560026000556000600055600160015500",
...
def test_sstore_xto_yto0(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=0x2) + Op.SSTORE(key=0x1, value=0x0) + Op.STOP,  # noqa: E501
        storage={1: 1},
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x96606e69ee07f3ba565d1f25edea6c691a780e71"): Account(storage={1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
