...
TX_DATA = [
    ...
    "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560016000556001600055600160015500",
]
...
def test_sstore_xto_xto_x(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0xba3394a0586b8419b4cf72c7d0f7e75a55a703f8"): Account(storage={0: 1, 1: 1}),  # noqa: E501
        contract_2: Account(storage={1: 1}),
    },
        },
        {
