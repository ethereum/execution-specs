...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(47, 0, 0, id="case47"),
        pytest.param(48, 0, 0, id="case48"),
        pytest.param(49, 0, 0, id="case49"),
        pytest.param(50, 0, 0, id="case50"),
        pytest.param(77, 0, 0, id="case51"),
        pytest.param(52, 0, 0, id="case52"),
        pytest.param(53, 0, 0, id="case53"),
        pytest.param(54, 0, 0, id="case54"),
        pytest.param(55, 0, 0, id="case55"),
        pytest.param(56, 0, 0, id="case56"),
        pytest.param(57, 0, 0, id="case57"),
        pytest.param(58, 0, 0, id="case58"),
        pytest.param(59, 0, 0, id="case59"),
        pytest.param(60, 0, 0, id="case60"),
        pytest.param(61, 0, 0, id="case61"),
        pytest.param(62, 0, 0, id="case62"),
        pytest.param(63, 0, 0, id="case63"),
        pytest.param(64, 0, 0, id="case64"),
        pytest.param(65, 0, 0, id="case65"),
        pytest.param(66, 0, 0, id="case66"),
        pytest.param(67, 0, 0, id="case67"),
        pytest.param(68, 0, 0, id="case68"),
        pytest.param(69, 0, 0, id="case69"),
        pytest.param(70, 0, 0, id="case70"),
        pytest.param(71, 0, 0, id="case71"),
        pytest.param(72, 0, 0, id="case72"),
        pytest.param(73, 0, 0, id="case73"),
        pytest.param(74, 0, 0, id="case74"),
        pytest.param(75, 0, 0, id="case75"),
        pytest.param(76, 0, 0, id="case76"),
        pytest.param(25, 0, 0, id="case77"),
    ],
)
