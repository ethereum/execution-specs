    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(code=bytes.fromhex("600360020260005500")),
                callee_1: Account(
                    code=bytes.fromhex(
                ...
                callee_2: Account(code=bytes.fromhex("601760000260005500")),
                callee_3: Account(code=bytes.fromhex("600160170260005500")),
                callee_4: Account(
                    code=bytes.fromhex(
                ...
                callee_8: Account(code=bytes.fromhex("600160005560010200")),
                contract: Account(
                    code=bytes.fromhex(
