    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(code=bytes.fromhex("600160170360005500")),
                callee_1: Account(code=bytes.fromhex("600360020360005500")),
                callee_2: Account(
                    storage={
        ...
        },
        {
            ...
            "result": {
                callee: Account(code=bytes.fromhex("600160170360005500")),
                callee_1: Account(code=bytes.fromhex("600360020360005500")),
                callee_2: Account(code=bytes.fromhex("601760000360005500")),
                callee_3: Account(
                    storage={0: 1},
                    code=bytes.fromhex(
                        "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60000360005500"  # noqa: E501
