    ...
    expect_entries_: list[dict] = [
        {
            ...
            "result": {
                ...
                callee_1: Account(code=bytes.fromhex("4460005500")),
                callee_2: Account(code=bytes.fromhex("4560005500")),
                callee_3: Account(code=bytes.fromhex("4360005500")),
                callee_4: Account(code=bytes.fromhex("4260005500")),
                contract: Account(
                    code=bytes.fromhex(
        ...
        },
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(code=bytes.fromhex("4160005500")),
                callee_1: Account(
