...
def test_not(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(code=bytes.fromhex("60001960005500")),
                callee_1: Account(
                    storage={
