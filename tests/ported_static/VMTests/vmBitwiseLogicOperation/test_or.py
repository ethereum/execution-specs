    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(code=bytes.fromhex("600260021760005500")),
                callee_1: Account(
                    storage={0: 3}, code=bytes.fromhex("600160021760005500")
                ),
                callee_2: Account(code=bytes.fromhex("600160031760005500")),
                callee_3: Account(
                    code=bytes.fromhex(
        ...
        },
        {
            ...
            "result": {
                ...
                callee_1: Account(code=bytes.fromhex("600160021760005500")),
                callee_2: Account(code=bytes.fromhex("600160031760005500")),
                callee_3: Account(
                    code=bytes.fromhex(
                        "7f0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff1760005500"  # noqa: E501
