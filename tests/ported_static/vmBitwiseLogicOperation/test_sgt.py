...
def test_sgt(
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SGT(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0x0))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_3 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SGT(0x0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
