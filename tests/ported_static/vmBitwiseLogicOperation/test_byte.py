...
def test_byte(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x0), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
    ...
    contract_1 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x1), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x2), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_3 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x3), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_4 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x4), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_5 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x5), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_6 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x6), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_7 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x7), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_8 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SUB(0x1f, 0x1f), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_9 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.BYTE(Op.SDIV(0x1f, 0x20), 0x8040201008040201))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_10 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.ADD(Op.DUP1, Op.BYTE(0x1f, 0x1234523456))),  # noqa: E501
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_11 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x100, value=0x0) + Op.JUMPDEST
        + Op.JUMPI(pc=0x4a, condition=Op.ISZERO(Op.LT(Op.MLOAD(offset=0x100), 0x20)))
        + Op.SSTORE(key=Op.MLOAD(offset=0x100), value=Op.BYTE(Op.MLOAD(offset=0x100), 0x102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f))  # noqa: E501
    ...
    contract_12 = pre.deploy_contract(
        code=Op.CALL(gas=0xffffff, address=Op.CALLDATALOAD(offset=0x4), value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
