...
def test_codecopy(
    ...
    contract_3 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x100, value=Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(Op.ADD(0x1, 0x2), 0x3), 0x4), 0x5), 0x6), 0x7), 0x8), 0x9), 0xa), 0xb), 0xc), 0xd), 0xe), 0xf), 0x10))
    ...
    contract_5 = pre.deploy_contract(
        code=Op.DELEGATECALL(gas=0xffffff, address=Op.ADD(0x1000, Op.CALLDATALOAD(offset=0x4)), args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        contract_5: Account(
                storage={
            0: 0x6040600060003960005160005560205160015500000000000000000000000000,
            1: 0,
        },
            ),
    },
        ...
        contract_5: Account(
                storage={
            0: 0x6110006000600039600051600055602051600155000000000000000000000000,
            1: 0,
        },
            ),
    },
        ...
        contract_5: Account(
                storage={
            0: 0x6010600f600e600d600c600b600a600960086007600660056004600360026001,
            1: 0x101010101010101010101010101016101005260206000600039604060206020,
            2: 0x3960005160005560205160015560405160025500000000000000000000000000,
        },
            ),
    },
        },
        ...
        contract_5: Account(
                storage={
            0: 0x3860ff5560ff5460006000396160a76000556160a76001556160a76002556000,
