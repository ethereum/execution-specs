...
def test_jumpi(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.JUMPI(pc=Op.MUL(0x20, 0x10), condition=0x1) + Op.JUMPDEST + Op.STOP,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d)
        + Op.JUMPI(pc=Op.MUL(0x20, 0x10), condition=0x0) + Op.JUMPDEST + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_4 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x6, condition=0x1) + Op.STOP + Op.JUMPDEST
    ...
    contract_5 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x6, condition=0x0) + Op.STOP + Op.JUMPDEST
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_6 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d)
        + Op.JUMPI(pc=0xfffffff, condition=0xff) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_7 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d)
        + Op.JUMPI(pc=0xfffffff, condition=0x0) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_8 = pre.deploy_contract(
        code=Op.PUSH1[0x23] + Op.JUMPI(pc=0x8, condition=0x1) + Op.PUSH1[0x1]
    ...
    contract_9 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMPDEST
    ...
    contract_10 = pre.deploy_contract(
        code=Op.PUSH2[0x600d] + Op.JUMPI(pc=0xa, condition=0x1) + Op.PUSH1[0xff]
    ...
    contract_11 = pre.deploy_contract(
        code=Op.JUMP(pc=0xb) + Op.JUMPDEST + Op.SSTORE(key=0x0, value=0x600d)
        + Op.STOP + Op.JUMPDEST + Op.JUMPI(pc=0x3, condition=0x1),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_12 = pre.deploy_contract(
        code=Op.JUMPI(pc=Op.ADD(0x5, 0x4), condition=0x1) + Op.STOP + Op.JUMPDEST
    ...
    contract_13 = pre.deploy_contract(
        code=Op.JUMPI(pc=Op.ADD(0x5, 0x4), condition=0x0) + Op.STOP + Op.JUMPDEST
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_14 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x7, condition=0x1) + Op.STOP + Op.PUSH1[0x5b]
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_15 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x7, condition=0x1) + Op.STOP + Op.PUSH1[0x1]
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_16 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMPI(pc=0xd, condition=0x1)
        + Op.GAS + Op.JUMPDEST + Op.SSTORE(key=0x1, value=Op.GAS),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_17 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMPI(pc=0xb, condition=0x1)
        + Op.GAS + Op.JUMPDEST + Op.SSTORE(key=0x1, value=Op.GAS),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_18 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x1000000000000000d, condition=0x11) + Op.JUMPDEST * 2
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_19 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x1000000000000000d, condition=0x0) + Op.JUMPDEST * 2
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_20 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x100000009, condition=0x11) + Op.JUMPDEST * 2
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_21 = pre.deploy_contract(
        code=Op.JUMPI(pc=0x100000009, condition=0x0) + Op.JUMPDEST * 2
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_22 = pre.deploy_contract(
        code=Op.POP(Op.MLOAD(offset=0x0)) + Op.POP(Op.SUB(0x0, 0x1))
    ...
    contract_24 = pre.deploy_contract(
        code=Op.JUMPI(pc=0xe, condition=0x1) + Op.JUMPDEST * 16
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_25 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.MSTORE(offset=0x0, value=0x10)  # noqa: E501
        + Op.JUMPDEST + Op.SUB(Op.MLOAD(offset=0x0), 0x1)
        + Op.MSTORE(offset=0x0, value=Op.DUP1) + Op.PUSH1[0xb] + Op.JUMPI,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_26 = pre.deploy_contract(
        code=Op.DELEGATECALL(gas=0x10000, address=Op.CALLDATALOAD(offset=0x4), args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        storage={0: 2989},
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        {
            "indexes": {'data': [0, 1, 5, 6, 8, 9, 13, 14, 15, 16, 17, 18, 20, 22], 'gas': -1, 'value': -1},
            "network": ['>=Cancun'],
            "result": {contract_26: Account(storage={0: 2989})},
        },
        {
            "indexes": {'data': [2, 3, 4, 7, 10, 11, 12, 19, 21, 23, 24, 25], 'gas': -1, 'value': -1},
            "network": ['>=Cancun'],
