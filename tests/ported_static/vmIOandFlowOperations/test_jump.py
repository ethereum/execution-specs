...
def test_jump(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMP(pc=Op.MUL(0x20, 0x10))
        + Op.JUMPDEST + Op.STOP,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.JUMP(pc=0x4) + Op.STOP + Op.JUMPDEST
    ...
    contract_3 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMP(pc=0xfffffff) + Op.STOP,  # noqa: E501
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_4 = pre.deploy_contract(
        code=Op.PUSH1[0x23] + Op.JUMP(pc=0x8) + Op.PUSH1[0x1] + Op.JUMPDEST
    ...
    contract_6 = pre.deploy_contract(
        code=Op.PUSH2[0x600d] + Op.JUMP(pc=0x8) + Op.PUSH1[0xff] + Op.JUMPDEST
    ...
    contract_7 = pre.deploy_contract(
        ...
        + Op.STOP + Op.JUMPDEST + Op.JUMP(pc=0x3),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_9 = pre.deploy_contract(
        code=Op.JUMP(pc=0x5) + Op.STOP + Op.PUSH1[0x5b]
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_10 = pre.deploy_contract(
        code=Op.JUMP(pc=0x5) + Op.STOP + Op.PUSH1[0x1]
        + Op.SSTORE(key=0x0, value=0x600d),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_11 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMP(pc=0xb) + Op.GAS
        + Op.JUMPDEST + Op.SSTORE(key=0x1, value=Op.GAS),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_12 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x600d) + Op.JUMP(pc=0x9) + Op.GAS
        + Op.JUMPDEST + Op.SSTORE(key=0x1, value=Op.GAS),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_13 = pre.deploy_contract(
        code=Op.JUMP(pc=0x1000000000000000b) + Op.JUMPDEST * 2
    ...
    contract_14 = pre.deploy_contract(
        code=Op.JUMP(pc=0x100000007) + Op.JUMPDEST * 2
        + Op.SSTORE(key=0x1, value=0x1),
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_15 = pre.deploy_contract(
        ...
        + Op.JUMP(pc=Op.MLOAD(offset=0x0)) + Op.SSTORE(key=0x0, value=0x600d)
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_16 = pre.deploy_contract(
        code=Op.JUMP(pc=0xe) + Op.JUMPDEST * 16 + Op.SSTORE(key=0x0, value=0x600d),  # noqa: E501
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_17 = pre.deploy_contract(
        code=Op.DELEGATECALL(gas=0x10000, address=Op.ADD(0x1000, Op.CALLDATALOAD(offset=0x4)), args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)
        + Op.STOP,
        storage={0: 2989},
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        {
            "indexes": {'data': [0, 1, 3, 4, 5, 9, 10, 11, 12, 13, 14, 15], 'gas': -1, 'value': -1},
            "network": ['>=Cancun'],
