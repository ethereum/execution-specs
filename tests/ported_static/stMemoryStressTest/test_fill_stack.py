...
def test_fill_stack(
    ...
    expect_entries_: list[dict] = [
        ...
        target: Account(
                storage={},
                code=bytes.fromhex(""),  # noqa: E501
                balance=0,
                nonce=0,
            ),
        coinbase: Account(
