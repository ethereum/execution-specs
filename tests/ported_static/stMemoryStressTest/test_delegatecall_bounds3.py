...
def test_delegatecall_bounds3(
    ...
    target = pre.deploy_contract(
        code=Op.POP(Op.DELEGATECALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0x0, args_size=0xffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffff))
