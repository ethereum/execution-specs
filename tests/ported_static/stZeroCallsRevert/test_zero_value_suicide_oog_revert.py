...
def test_zero_value_suicide_oog_revert(
    ...
    # Source: lll
    # { (CALL 40000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[2]]12 [[3]]12 [[4]]12 [[100]](GAS) }
    target = pre.deploy_contract(
        code=Op.POP(Op.CALL(gas=0x9c40, address=0xda2eb5512889130c4af686a291b08665b889cb22, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
