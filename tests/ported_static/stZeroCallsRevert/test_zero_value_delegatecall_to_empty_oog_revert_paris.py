...
def test_zero_value_delegatecall_to_empty_oog_revert_paris(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0xea60, address=0x76fae819612a29489a1a43208613d8f8557b8898, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
