...
def test_revert_opcode_in_create_returns(
    ...
    # Source: lll
    # { (seq (CREATE 0 0 (lll (seq (mstore 0 0x112233) (revert 0 32)) 0)) (SSTORE 0 (RETURNDATASIZE)) (STOP) )}
    target = pre.deploy_contract(
        code=Op.PUSH1[0xd] + Op.CODECOPY(dest_offset=0x0, offset=0x15, size=Op.DUP1)
