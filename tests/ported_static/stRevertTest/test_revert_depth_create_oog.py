    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x3e180b1862f9d158abb5e519a6d8605540c23682"): Account(nonce=1),  # noqa: E501
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x3e180b1862f9d158abb5e519a6d8605540c23682"): Account.NONEXISTENT,  # noqa: E501
