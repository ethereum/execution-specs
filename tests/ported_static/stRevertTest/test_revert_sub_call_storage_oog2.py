...
def test_revert_sub_call_storage_oog2(
    ...
    target = pre.deploy_contract(
        code=bytes.fromhex(""),  # noqa: E501
        balance=1,
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {target: Account(storage={0: 13, 1: 14}, balance=1, nonce=0)},
        },
        {
