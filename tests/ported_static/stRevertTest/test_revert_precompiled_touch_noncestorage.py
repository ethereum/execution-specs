...
def test_revert_precompiled_touch_noncestorage(
    ...
    addr_0x0000000000000000000000000000000000000001 = Address("0xb0a7b7b80bc0f95f8890e6e2070ddc906bbfdbcd")  # noqa: E501
    addr_0x0000000000000000000000000000000000000002 = Address("0xe2041123687b446e6f4ba274bfed4ce0206d4c8e")  # noqa: E501
    addr_0x0000000000000000000000000000000000000003 = Address("0x0d6d2da01a9da2c336e2affe3e6a9d0787069b56")  # noqa: E501
    addr_0x0000000000000000000000000000000000000004 = Address("0x1e28db5341d617cce6178f0bbccb352c51c5909d")  # noqa: E501
    addr_0x0000000000000000000000000000000000000005 = Address("0xae321ab38d9488985a884ed293f2c1466d2c806b")  # noqa: E501
    addr_0x0000000000000000000000000000000000000006 = Address("0xf6165bb84beb5028557005861faa9b085c1381d9")  # noqa: E501
    addr_0x0000000000000000000000000000000000000007 = Address("0x9bce9e56a0a95f42d0b6a7b550e26604d7c5299f")  # noqa: E501
    addr_0x0000000000000000000000000000000000000008 = Address("0x0e145edea519e730a2c24124733e22e8b8de1202")  # noqa: E501
    sender = EOA(
    ...
    pre[addr_0x0000000000000000000000000000000000000001] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000002] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000003] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000004] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000005] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000006] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000007] = Account(balance=0, nonce=1, storage={0: 1})
    pre[addr_0x0000000000000000000000000000000000000008] = Account(balance=0, nonce=1, storage={0: 1})
    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        addr_0x0000000000000000000000000000000000000001: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000002: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000003: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000004: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000005: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000006: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000007: Account(storage={0: 1}, nonce=1),
        addr_0x0000000000000000000000000000000000000008: Account(storage={0: 1}, nonce=1),
    },
        },
    ]
