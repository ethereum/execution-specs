...
def test_revert_in_static_call(
    ...
    # Source: lll
    # { [[ 0 ]] (STATICCALL 50000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 0 64 0 64 )}
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.STATICCALL(gas=0xc350, address=0x33fcf0576ab8b4527c9426094e2e355a7ffc7e71, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=1000,
        nonce=0,
