...
def test_revert_depth_create_address_collision(
    ...
    # Source: lll
    # { [[0]] 1 [[1]] (CALL (CALLDATALOAD 0) <contract:0xb000000000000000000000000000000000000000> 0 0 0 0 0) [[4]] 12 }
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=0x1)
        + Op.SSTORE(key=0x1, value=Op.CALL(gas=Op.CALLDATALOAD(offset=0x0), address=0xb1b49241a4ecf7860872e686090781c906b1b437, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    expect_entries_: list[dict] = [
        ...
        target: Account(
                storage={},
                code=bytes.fromhex("60016000556000600060006000600073b1b49241a4ecf7860872e686090781c906b1b437600035f1600155600c60045500"),  # noqa: E501
                nonce=54,
            ),
