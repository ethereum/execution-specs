...
def test_revert_opcode_calls(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0xa, value=Op.CALL(gas=0x3f7a0, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.STOP,
        balance=1,
        nonce=0,
    ...
    # Source: lll
    # { [[0]] (CALLCODE 50000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[2]] 14 }
    addr_0xb1005374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc350, address=0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.SSTORE(key=0x2, value=0xe) + Op.STOP,
        balance=1,
        nonce=0,
    ...
    # Source: lll
    # { [[0]] (DELEGATECALL 50000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0) [[2]] 14 }
    addr_0xb2005374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0xc350, address=0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.SSTORE(key=0x2, value=0xe) + Op.STOP,
        balance=1,
        nonce=0,
    ...
    # Source: lll
    # { [[0]] (CALL 100000 <contract:0xb3305374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[2]] 14 }
    addr_0xb3005374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x186a0, address=0x652761b88018ea027f6f27e456fe55c2dc5d6a91, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.SSTORE(key=0x2, value=0xe) + Op.STOP,
        balance=1,
        nonce=0,
    ...
    # Source: lll
    # { [[4]] (CALL 50000 <contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0 0) [[5]] 14 }
    addr_0xb3305374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(
        code=Op.SSTORE(key=0x4, value=Op.CALL(gas=0xc350, address=0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    expect_entries_: list[dict] = [
        ...
        addr_0xb0005374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 0, 2: 14}, nonce=0),
    },
        },
        {
        ...
        addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={}),
        target: Account(storage={10: 1}),
        addr_0xb1005374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 0, 2: 14}, nonce=0),
    },
        },
        {
        ...
        addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={}),
        target: Account(storage={10: 1}),
        addr_0xb2005374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 0, 2: 14}, nonce=0),
    },
        },
        {
        ...
        addr_0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={}),
        target: Account(storage={10: 1}),
        addr_0xb3005374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 1, 2: 14}, nonce=0),
        addr_0xb3305374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={4: 0, 5: 14}, nonce=0),
    },
        },
        {
        ...
        addr_0xb3005374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={0: 0, 2: 0}, nonce=0),
        addr_0xb3305374fce5edbc8e2a8697c15331677e6ebf0b: Account(storage={4: 0, 5: 0}, nonce=0),
    },
        },
    ]
