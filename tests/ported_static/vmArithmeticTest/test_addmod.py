...
def test_addmod(
    ...
    expect_posts: list[dict] = [
        ...
        {contract_4: Account(storage={0: 1})},
        {contract_5: Account(storage={0: 5})},
        {contract_6: Account(storage={0: 0})},
        {contract_7: Account(storage={0: 0})},
        {contract_8: Account(storage={0: 1})},
        {contract_9: Account(storage={0: 2})},
        {contract_10: Account(storage={0: 4})},
        {contract_11: Account(storage={0: 1})},
        {contract_12: Account(storage={0: 0})},
        {contract_13: Account(storage={0: 0})},
        {contract_14: Account(storage={0: 0})},
        {
            contract_15: Account(
                storage={
