...
def test_mod(
    ...
    contract_1 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.MOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0x2))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.MOD(0x0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_5 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SUB(Op.MOD(0x10, 0x0), 0x1)) + Op.STOP,  # noqa: E501
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
