...
def test_add(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))  # noqa: E501
        + Op.STOP,
    ...
    contract_1 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0x4))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0x1))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_4 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.ADD(0x1, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
