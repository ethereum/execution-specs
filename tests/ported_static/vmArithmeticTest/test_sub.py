...
def test_sub(
    ...
    contract_3 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SUB(0x0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_4 = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.SUB(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0x0))  # noqa: E501
        + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
