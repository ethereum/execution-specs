...
def test_create2_oo_gafter_init_code_returndata2(
    ...
    """Call RETURNDATASIZE and RETURNDATACOPY after CREATE2 deploy a contr..."""
    ...
    # Source: lll
    # { (MSTORE 0 0x6460016001556000526005601bf3) (CREATE2 0 18 14 0) [[ 1 ]] (RETURNDATASIZE) (RETURNDATACOPY 0 0 0) [[ 2 ]] (MLOAD 0) }
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        contract_0: Account(storage={1: 0, 2: 0x6460016001556000526005601bf3}),
        Address("0x6878b140f875209c82ab4d5f083b55947299ef6b"): Account(code=bytes.fromhex("6001600155")),  # noqa: E501
    },
        },
    ]
