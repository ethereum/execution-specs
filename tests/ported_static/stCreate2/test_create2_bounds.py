...
def test_create2_bounds(
    ...
    # Source: lll
    # {  (MSTORE 0 0x6001600155601080600c6000396000f3006000355415600957005b6020356000 )  (MSTORE8 32 0x35) (MSTORE8 33 0x55) (CREATE2 1 0 0 0) (CREATE2 1 0 0xfffffff 0) }
    ...
    expect_entries_: list[dict] = [
        ...
        Address("0x7c5a2c91b22d7a9226523d4ba717db6afb741ebd"): Account.NONEXISTENT,  # noqa: E501
    },
        },
    ]
