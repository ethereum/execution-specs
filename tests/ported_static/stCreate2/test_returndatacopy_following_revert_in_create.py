...
def test_returndatacopy_following_revert_in_create(
    ...
    # Source: lll
    # { (seq (CREATE2 0 0 (lll (seq (MSTORE 0 0x0000111122223333444455556666777788889999aaaabbbbccccddddeeeeffff) (REVERT 0 32) (STOP) ) 0) 0) (RETURNDATACOPY 0 0 32) (SSTORE 0 (MLOAD 0)) (STOP) )}
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP * 2
        + Op.INVALID
        + Op.MSTORE(offset=0x0, value=0x111122223333444455556666777788889999aaaabbbbccccddddeeeeffff)
        + Op.REVERT(offset=0x0, size=0x20) + Op.STOP * 2,
        storage={0: 1},
        nonce=0,
