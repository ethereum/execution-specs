...
def test_create2_first_byte_loop(
    ...
    entry = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0x600060005360016000f300000000000000000000000000000000000000000000)
        + Op.CALLDATALOAD(offset=0x24) + Op.CALLDATALOAD(offset=0x4)
        + Op.JUMPDEST + Op.JUMPI(pc=0x38, condition=Op.LT(Op.DUP2, Op.DUP2))
        + Op.SSTORE(key=0x100, value=0x1) + Op.STOP + Op.JUMPDEST + Op.DUP1
        + Op.PUSH1[0x1] + Op.SWAP2 + Op.DUP3 + Op.MSTORE8
        + Op.JUMPI(pc=0x4f, condition=Op.ISZERO(Op.CREATE2(value=Op.DUP1, offset=Op.DUP2, size=0xa, salt=0x0)))
        + Op.JUMPDEST + Op.ADD + Op.JUMP(pc=0x2a) + Op.JUMPDEST
        + Op.SSTORE(key=Op.DUP2, value=Op.DUP2) + Op.JUMP(pc=0x4a),
        nonce=0,
    ...
    expect_entries_: list[dict] = [
        ...
        Address("0x0d03885ed4f051b06ae83d869cd60f8ebdde37d8"): Account(nonce=1),  # noqa: E501
        Address("0x94b507d001a223d7948119d899358a073fe5e331"): Account(nonce=1),  # noqa: E501
    },
        },
        {
        ...
        Address("0x896e9dc41224489ed98380921ef0aeac66115d7b"): Account(nonce=1),  # noqa: E501
        Address("0x070db4fa29b5d139bedb29347001bb9c3d75dc3a"): Account(nonce=1),  # noqa: E501
    },
        },
        {
        ...
        Address("0xa492678492a13f1031904de45f26a114234b668d"): Account.NONEXISTENT,  # noqa: E501
    },
        },
    ]
