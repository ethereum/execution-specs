...
def test_create2_high_nonce_delegatecall(
    ...
    post = {
        Address("0x000000000000000000000000<contract:entry>"): Account(
            storage={1: 0, 2: 0, 65535: 0xFFFFFFFFFFFFFFFF},
            nonce=18446744073709551615,
        ),
        Address("0x00000000000000000000<contract:max_nonce>"): Account(
            storage={65535: 0xFFFFFFFFFFFFFFFF},
            nonce=18446744073709551615,
        ),
        Address("0x000000000000<contract:max_nonce_minus_1>"): Account(
            storage={65535: 0xFFFFFFFFFFFFFFFE},
            nonce=18446744073709551614,
        ),
        Address("0x0000000000000000000000000000<eoa:sender>"): Account(
            nonce=1,
        ),
        Address(
