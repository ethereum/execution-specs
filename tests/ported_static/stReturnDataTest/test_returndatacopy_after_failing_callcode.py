...
def test_returndatacopy_after_failing_callcode(
    ...
    # Source: lll
    # {  (CALLCODE 0 <contract:0x1000000000000000000000000000000000000002> 0 0 0 0 0) (RETURNDATACOPY 0x0 0x0 32) (SSTORE 0 (MLOAD 0))}
    target = pre.deploy_contract(
        code=Op.POP(Op.CALLCODE(gas=0x0, address=0x665521fd750490fd880ee369c267fca44ed8a078, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
