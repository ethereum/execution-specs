...
def test_returndatacopy_following_failing_call(
    ...
    # Source: lll
    # { (CALL 0x0900000000 <contract:0x0aabbccdd5c57f15886f9b263e2f6d2d6c7b5ec6> 0 0 0 0 0) (RETURNDATACOPY 0 1 32) (SSTORE 0 (MLOAD 0)) }
    target = pre.deploy_contract(
        code=Op.POP(Op.CALL(gas=0x900000000, address=0x3141bb954e8294e47a14ebd08229f30e6294ba83, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
