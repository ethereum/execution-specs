...
def test_returndatasize_following_successful_create(
    ...
    # Source: lll
    # { (seq (CREATE 0 0 (lll (seq (mstore 0 0x112233) (RETURN 0 32) (STOP) ) 0)) (SSTORE 0 (RETURNDATASIZE)) (STOP) )}
    target = pre.deploy_contract(
        code=Op.PUSH1[0xe] + Op.CODECOPY(dest_offset=0x0, offset=0x15, size=Op.DUP1)
