...
def test_call_then_create_successful_then_returndatasize(
    ...
    # Source: lll
    # { (seq (CALL 0x0900000000 <contract:0x0aabbccdd5c57f15886f9b263e2f6d2d6c7b5ec6> 0 0 0 0 0) (CREATE 0 0 (lll (seq (mstore 0 0x112233) (RETURN 0 32) (STOP) ) 0)) (SSTORE 0 (RETURNDATASIZE)) (STOP) )}
    target = pre.deploy_contract(
        code=Op.POP(Op.CALL(gas=0x900000000, address=0x24b406508240d6f2783499d1fd65fedd0feeef37, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
