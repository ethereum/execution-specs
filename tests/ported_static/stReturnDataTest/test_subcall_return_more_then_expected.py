...
def test_subcall_return_more_then_expected(
    ...
    #   (RETURN 0 64)
    # }
    addr_0x194f5374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(  # noqa: F841
        code=Op.MSTORE(
            offset=0x0,
    ...
    #   (REVERT 0 64)
    # }
    addr_0x294f5374fce5edbc8e2a8697c15331677e6ebf0b = pre.deploy_contract(  # noqa: F841
        code=Op.MSTORE(
            offset=0x0,
            value=0x1122334455667788991011121314151617181920212223242526272829303132,  # noqa: E501
        )
