...
def test_returndatacopy_after_failing_staticcall(
    ...
    # Source: lll
    # { (STATICCALL 0 <contract:0x1000000000000000000000000000000000000002> 0 0 0 0) (RETURNDATACOPY 0x0 0x0 32) ( SSTORE 0 (MLOAD 0))}
    target = pre.deploy_contract(
        code=Op.POP(Op.STATICCALL(gas=0x0, address=0x52fd0cbc013ee33577eec035031dbc4489a1e0bd, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
