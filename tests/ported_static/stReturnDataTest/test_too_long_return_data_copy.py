...
@pytest.mark.parametrize(
    "d, g, v",
    [
        pytest.param(18, 0, 0, id="case0"),
        pytest.param(20, 0, 0, id="case1"),
        pytest.param(21, 0, 0, id="case2"),
        pytest.param(22, 0, 0, id="case3"),
        ...
        pytest.param(13, 0, 0, id="case11"),
        pytest.param(16, 0, 0, id="case12"),
        pytest.param(1, 0, 0, id="case13"),
        pytest.param(19, 0, 0, id="case14"),
        pytest.param(2, 0, 0, id="case15"),
        pytest.param(3, 0, 0, id="case16"),
        pytest.param(5, 0, 0, id="case17"),
        pytest.param(7, 0, 0, id="case18"),
        pytest.param(12, 0, 0, id="case19"),
        pytest.param(14, 0, 0, id="case20"),
        pytest.param(15, 0, 0, id="case21"),
        pytest.param(17, 0, 0, id="case22"),
        pytest.param(0, 0, 0, id="case23"),
    ],
)
