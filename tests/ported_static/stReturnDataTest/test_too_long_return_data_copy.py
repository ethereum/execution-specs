...
def test_too_long_return_data_copy(
    ...
    # }
    addr_0x000000000000000000000000000000000000c0de = pre.deploy_contract(  # noqa: F841
    ...
    # }
    addr_0x0000000000000000000000000000000000000bad = pre.deploy_contract(  # noqa: F841
        code=Op.CALLDATALOAD(offset=0x0)
        + Op.MSTORE(
            offset=0x0,
            value=0x1F1E1D1C1B1A191817161514131211100F0E0D0C0B0A090807060504030201FF,  # noqa: E501
