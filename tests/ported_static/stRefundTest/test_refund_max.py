...
SSTORE-clear charge. The EIP-3529 refund cap (`gas_used // 5`) binds at
...
the per-clear charge delta from the fork gas model (0 pre-EIP-8037) and
subtract `gas_price * 8 * delta * 4 // 5` from the Cancun balance; do
