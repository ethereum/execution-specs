...
def test_refund_multimple_suicide(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SWAP1 + Op.MLOAD + Op.PUSH1[0x4] + Op.ADD(Op.DUP2, Op.DUP3)
        + Op.SWAP3 + Op.PUSH1[0x0] + Op.SWAP3 + Op.SWAP2 + Op.SWAP1 + Op.DUP3
        + Op.SWAP1 + Op.SUB + Op.ADD + Op.DUP2 + Op.DUP4 + Op.DUP8
        + Op.SUB(Op.GAS, 0x61da)
        + Op.JUMPI(pc=Op.PUSH2[0x2], condition=Op.ISZERO(Op.CALL)) + Op.POP * 4
        + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x40] + Op.MLOAD(offset=Op.DUP1)
        + Op.SWAP2 + Op.MSTORE(offset=Op.DUP3, value=Op.ISZERO(Op.ISZERO))
        + Op.MLOAD + Op.SWAP1 + Op.DUP2 + Op.SWAP1 + Op.ADD(0x20, Op.SUB)
        + Op.SWAP1 + Op.RETURN + Op.JUMPDEST + Op.POP + Op.PUSH1[0x1] + Op.SWAP1
        + Op.JUMP,
