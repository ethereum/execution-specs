...
def test_delegatecall_before_transition(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x7a120, address=0xd3f6e432d6891a965fc56d39e729652a0762a, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))  # noqa: E501
        + Op.STOP,
    ...
    addr_0x945304eb96065b2a98b57a48a06ae28d285a71b5 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLVALUE) + Op.STOP,
        balance=23,
        nonce=0,
