    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x0000000000000000000000000000000000001001"): Account.NONEXISTENT,  # noqa: E501
        Address("0x0000000000000000000000000000000000001002"): Account(balance=0xf4241),  # noqa: E501
    },
        },
        {
            ...
            "network": ['>=Cancun'],
            "result": {
        Address("0x0000000000000000000000000000000000001001"): Account(balance=0xf4241, nonce=0),  # noqa: E501
        Address("0x0000000000000000000000000000000000001002"): Account.NONEXISTENT,  # noqa: E501
