...
def test_create_name_registrator_zero_mem2(
    ...
    # Source: lll
    # { (MSTORE 0 0x601080600c6000396000f3006000355415600957005b60203560003555) [[ 0 ]] (CREATE 23 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff 0) }
    contract_0 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0x601080600c6000396000f3006000355415600957005b60203560003555)
        + Op.SSTORE(key=0x0, value=Op.CREATE(value=0x17, offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, size=0x0))  # noqa: E501
        + Op.STOP,
