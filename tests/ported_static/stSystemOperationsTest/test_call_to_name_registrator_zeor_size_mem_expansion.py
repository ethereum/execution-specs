...
def test_call_to_name_registrator_zeor_size_mem_expansion(
    ...
    # Source: lll
    # { (MSTORE 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (CALL 5000 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 23 0 0 0 0) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0x1388, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, value=0x17, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
        + Op.STOP,
