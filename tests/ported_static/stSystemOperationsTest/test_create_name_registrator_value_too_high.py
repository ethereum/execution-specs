...
def test_create_name_registrator_value_too_high(
    ...
    # Source: lll
    # { (MSTORE 0 0x601080600c6000396000f3006000355415600957005b60203560003555) [[ 0 ]] (CREATE 1000000000000000001 3 29) }
    contract_0 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0x601080600c6000396000f3006000355415600957005b60203560003555)
        + Op.SSTORE(key=0x0, value=Op.CREATE(value=0xde0b6b3a7640001, offset=0x3, size=0x1d))  # noqa: E501
        + Op.STOP,
