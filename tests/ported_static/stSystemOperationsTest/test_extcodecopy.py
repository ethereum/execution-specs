...
def test_extcodecopy(
    ...
    # Source: raw
    # 0x7f15688566a82f5f946c68028bf626b349e495daa43e33529a76437ac416cd1b7d6e7dae7454bb193b1c28e64a6a935bc373cea0c5cc171fa61277e5604a3bc8aef4de3d38820658600b80797ada6e82e95f6520383f95f5c7dae56b4dc13b6f22ecabfce07c3cff51
    target = pre.deploy_contract(
        code=Op.PUSH32[0x15688566a82f5f946c68028bf626b349e495daa43e33529a76437ac416cd1b7d]
    ...
    addr_0x945304eb96065b2a98b57a48a06ae28d285a71b5 = pre.deploy_contract(
        code=Op.GAS + Op.PUSH1[0x10] + Op.PUSH1[0x17] + Op.PUSH1[0x11] * 2
        + Op.PUSH1[0x18] + Op.PUSH1[0x1c] + Op.PUSH1[0xf] + Op.PUSH1[0x1b]
        + Op.PUSH1[0x1d] + Op.PUSH0 + Op.PUSH1[0x2] + Op.PUSH1[0x13]
        + Op.PUSH1[0xf] + Op.PUSH1[0x1a] + Op.DUP14 + Op.GAS + Op.JUMPDEST
        + Op.PUSH23[0x79177b5dd41a23db52998c4dcd14e88390dcc9f3ed5783]
        + Op.PUSH1[0x16] + Op.PUSH1[0x14] + Op.PUSH0 + Op.PUSH1[0x13]
        + Op.PUSH1[0xd] + Op.PUSH1[0x1f] + Op.PUSH1[0x1] + Op.PUSH1[0x11]
        + Op.PUSH1[0xe] + Op.PUSH1[0xc] + Op.PUSH1[0xd] + Op.PUSH1[0x1f]
        + Op.PUSH1[0x13] + Op.DUP13
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x24a39757,
        nonce=0,
        gas_price=483694712,
    ...
    post = {
        Address("0x00000000002147c39fd6b5c19b7b89fc003e6b16"): Account(storage={}, nonce=0),  # noqa: E501
