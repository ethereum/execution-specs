...
def test_call_to_name_registrator_too_much_memory2(
    ...
    # Source: lll
    # { (MSTORE 0 0xeeffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff00) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (CALL 500 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 23 0 64 987654 1) }
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0x1f4, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, value=0x17, args_offset=0x0, args_size=0x40, ret_offset=0xf1206, ret_size=0x1))  # noqa: E501
        + Op.STOP,
