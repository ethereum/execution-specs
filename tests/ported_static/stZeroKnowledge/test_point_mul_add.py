...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(2, 1, 0, id="case9"),
        pytest.param(2, 2, 0, id="case10"),
        pytest.param(2, 3, 0, id="case11"),
        pytest.param(3, 0, 0, id="case12"),
        pytest.param(3, 1, 0, id="case13"),
        pytest.param(3, 2, 0, id="case14"),
        pytest.param(3, 3, 0, id="case15"),
        pytest.param(4, 0, 0, id="case16"),
        pytest.param(4, 1, 0, id="case17"),
        pytest.param(4, 2, 0, id="case18"),
        pytest.param(4, 3, 0, id="case19"),
        pytest.param(5, 0, 0, id="case20"),
        pytest.param(5, 1, 0, id="case21"),
        pytest.param(5, 2, 0, id="case22"),
        pytest.param(5, 3, 0, id="case23"),
        pytest.param(6, 0, 0, id="case24"),
        pytest.param(6, 1, 0, id="case25"),
        pytest.param(6, 2, 0, id="case26"),
        pytest.param(6, 3, 0, id="case27"),
        pytest.param(7, 0, 0, id="case28"),
        pytest.param(7, 1, 0, id="case29"),
        pytest.param(7, 2, 0, id="case30"),
        pytest.param(7, 3, 0, id="case31"),
        pytest.param(8, 0, 0, id="case32"),
        pytest.param(8, 1, 0, id="case33"),
        pytest.param(8, 2, 0, id="case34"),
        pytest.param(8, 3, 0, id="case35"),
    ],
)
...
def test_point_mul_add(
    ...
    expect_entries_: list[dict] = [
        ...
        },
        {
            ...
            "network": [">=Cancun"],
            "result": {contract: Account(storage={})},
        },
        {
        ...
        {
            "indexes": {"data": [2, 8], "gas": [3], "value": -1},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={0: 1, 1: 1, 2: 1, 3: 1})},
        },
    ]
