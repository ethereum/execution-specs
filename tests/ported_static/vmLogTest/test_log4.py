...
def test_log4(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.LOG4(offset=0x0, size=0x0, topic_1=0x0, topic_2=0x0, topic_3=0x0, topic_4=0x0)
    ...
    contract_1 = pre.deploy_contract(
        ...
        + Op.LOG4(offset=Op.SUB(0x0, 0x1), size=0x1, topic_1=0x0, topic_2=0x0, topic_3=0x0, topic_4=0x0)
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_2 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd)
        + Op.LOG4(offset=0x1, size=Op.SUB(0x0, 0x1), topic_1=0x0, topic_2=0x0, topic_3=0x0, topic_4=0x0)
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_8 = pre.deploy_contract(
        ...
        + Op.LOG4(offset=0x1f, size=0x1, topic_1=Op.SUB(0x0, 0x1), topic_2=Op.SUB(0x0, 0x1), topic_3=Op.SUB(0x0, 0x1), topic_4=Op.SUB(0x0, 0x1))
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
    ...
    contract_9 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd)
        + Op.LOG4(offset=0x1f, size=0x1, topic_1=Op.PC, topic_2=Op.PC, topic_3=Op.PC, topic_4=Op.PC)
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
        balance=0xba1a9ce0ba1a9ce,
        nonce=0,
