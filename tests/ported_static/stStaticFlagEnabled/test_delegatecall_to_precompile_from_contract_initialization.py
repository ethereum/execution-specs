...
def test_delegatecall_to_precompile_from_contract_initialization(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x1, value=Op.CREATE2(value=0x0, offset=0x0, size=Op.CALLDATASIZE, salt=0x5a175a175a17))  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=4000000,
        value=100,
        nonce=0,
        gas_price=10,
