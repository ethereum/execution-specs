...
def test_create_code_size_limit(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x0, value=Op.CREATE(value=Op.DUP1, offset=0x0, size=Op.CALLDATASIZE))  # noqa: E501
    ...
    expect_entries_: list[dict] = [
        ...
        Address("0xf1ecf98489fa9ed60a664fc4998db699cfa39d40"): Account(storage={}, balance=0, nonce=1),  # noqa: E501
    },
        },
        {
