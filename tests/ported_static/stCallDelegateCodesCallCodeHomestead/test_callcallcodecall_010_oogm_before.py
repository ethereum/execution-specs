...
def test_callcallcodecall_010_oogm_before(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0xd33ab78ac3965e7d6f9548dff5839138a9f69c5, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
