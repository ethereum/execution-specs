...
def test_callcodecallcodecall_110_oogm_after(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0xbe2d28f50cb59ffbd66d2eb6a3e8d34f3561d8b, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
