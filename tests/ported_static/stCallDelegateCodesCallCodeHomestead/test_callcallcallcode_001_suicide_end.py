...
def test_callcallcallcode_001_suicide_end(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x186a0, address=0xac521409e2fa9526bfe6b827805783d2e307c4ce, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    post = {
        target: Account(
                ...
                code=bytes.fromhex("6040600060406000600073eaf8c2ae0d01a880cea4e1aa88def5edd153d57b620249f0f260005500"),  # noqa: E501
                balance=0,
                nonce=0,
            ),
        addr_0x1000000000000000000000000000000000000001: Account(storage={1: 0, 3: 0}),
        addr_0x1000000000000000000000000000000000000002: Account(storage={0: 0, 2: 0}),
