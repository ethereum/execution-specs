...
def test_callcallcallcode_001_suicide_middle(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x186a0, address=0x124b38fa011c9d36b7fe193dc636813a2f8bdaa7, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000002: Account(storage={0: 0, 2: 0}, balance=0x2540be400),
