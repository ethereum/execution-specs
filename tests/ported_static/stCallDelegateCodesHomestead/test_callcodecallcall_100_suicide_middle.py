...
def test_callcodecallcall_100_suicide_middle(
    ...
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x186a0, address=0xac90bb4611b91d4c6292bd64e8656110822e01ed, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
        balance=0x2540be400,
        nonce=0,
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000002: Account(
                storage={},
                code=bytes.fromhex("732b30b637f37e3f5b8ca4ab846331d0779a3f4671ff604060006040600060007373b954ebc05bb0ff4a0f6a13a054d50ad158409961c350f160025500"),  # noqa: E501
                balance=0,
                nonce=0,
            ),
