...
def test_callcodecall_10_suicide_end(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x249f0, address=0xf741cfee7b7fb1025dccef3db5a3cbc8ffb776f8, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000002: Account(storage={2: 1, 3: 0}),
    }
