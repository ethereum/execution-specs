...
def test_callcallcodecall_010_oogm_before(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0xc3500, address=0x97367129e262c26ff9d41b4424eb9e460270f83f, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
