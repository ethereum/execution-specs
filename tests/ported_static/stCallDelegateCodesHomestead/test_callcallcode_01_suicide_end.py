...
def test_callcallcode_01_suicide_end(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x249f0, address=0x1cca6e93108ec94304ae5eb121d323e6c317fe7a, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
        + Op.STOP,
    ...
    # Source: lll
    # {  [[ 1 ]] (DELEGATECALL 50000 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (SELFDESTRUCT <contract:target:0x1000000000000000000000000000000000000000>) }
    addr_0x1000000000000000000000000000000000000001 = pre.deploy_contract(
        code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0xc350, address=0x703b936fd4d674f0ff5d6957f61097152f8781b8, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))  # noqa: E501
    ...
    post = {
        ...
        addr_0x1000000000000000000000000000000000000001: Account(storage={1: 1, 2: 1}, balance=0, nonce=0),
