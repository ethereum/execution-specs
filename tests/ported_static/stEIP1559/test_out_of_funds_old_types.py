...
Ported from:
state_tests/stEIP1559/outOfFundsOldTypesFiller.yml
"""
...
def test_out_of_funds_old_types(
    ...
    _exc = {
        ...
        (1, 0, 0): TransactionException.INSUFFICIENT_ACCOUNT_FUNDS,
        (1, 0, 1): TransactionException.INSUFFICIENT_ACCOUNT_FUNDS,
        (1, 1, 1): TransactionException.INSUFFICIENT_ACCOUNT_FUNDS,
    }.get((d, g, v))
