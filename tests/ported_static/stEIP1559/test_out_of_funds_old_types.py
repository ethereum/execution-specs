...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(0, 1, 0, None, id="case2"),
        pytest.param(
            0, 1, 1, None, id="case3", marks=pytest.mark.exception_test
        ),
        pytest.param(
            1, 0, 0, [], id="case4", marks=pytest.mark.exception_test
        ),
        pytest.param(
            1, 0, 1, [], id="case5", marks=pytest.mark.exception_test
        ),
        pytest.param(1, 1, 0, [], id="case6"),
        pytest.param(
            1, 1, 1, [], id="case7", marks=pytest.mark.exception_test
        ),
    ],
)
