...
def test_base_fee_diff_places(
    ...
    contract_3 = pre.deploy_contract(
        ...
        + Op.MSTORE(offset=0x0, value=Op.BASEFEE)
        + Op.JUMPI(pc=0x156, condition=Op.EQ(Op.SLOAD(key=0x0), Op.MLOAD(offset=0x0)))  # noqa: E501
        + Op.MSTORE(offset=0x0, value=0xbadbadbad) + Op.JUMP(pc=0x156)
        + Op.JUMPDEST + Op.POP * 4 + Op.MSTORE(offset=0x0, value=Op.BASEFEE)
        + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0))
        ...
        + Op.JUMP(pc=0x156) + Op.JUMPDEST + Op.POP * 4
        + Op.MSTORE(offset=0x0, value=Op.BASEFEE) + Op.JUMP(pc=0x156),
        storage={0: 24743},
        balance=0xde0b6b3a7640000,
        nonce=1,
    ...
    contract_9 = pre.deploy_contract(
        code=Op.MSTORE(offset=0x0, value=Op.BASEFEE)
        + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.INVALID,
        storage={0: 24743},
        balance=0xde0b6b3a7640000,
        nonce=1,
