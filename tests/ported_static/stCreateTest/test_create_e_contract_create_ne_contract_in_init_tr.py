...
def test_create_e_contract_create_ne_contract_in_init_tr(
    ...
    tx = Transaction(
        sender=sender,
        to=None,
        data=bytes.fromhex("6000600060006000600073c94f5374fce5edbc8e2a8697c15331677e6ebf0b61ea60f1506d64600c6000556000526005601bf3600052600e60126000f0"),  # noqa: E501
        gas_limit=600000,
        nonce=0,
        gas_price=10,
    )
    ...
    post = {
        ...
        Address("0x64e2ebd6405af8cb348aec519084d3fff42ebba6"): Account(code=bytes.fromhex("600c600055")),  # noqa: E501
    }
