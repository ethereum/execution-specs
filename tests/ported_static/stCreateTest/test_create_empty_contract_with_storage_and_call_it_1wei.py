...
def test_create_empty_contract_with_storage_and_call_it_1wei(
    ...
    # Source: lll
    # { [[0]](GAS) (MSTORE 0 0x600c6000556000600060006000600073c94f5374fce5edbc8e2a8697c1533167) (MSTORE 32 0x7e6ebf0b61ea60f1000000000000000000000000000000000000000000000000) [[1]] (CREATE 0 0 64) [[2]] (GAS) [[3]] (CALL 60000 (SLOAD 1) 1 0 0 0 0) [[100]] (GAS) }
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=0x3, value=Op.CALL(gas=0xea60, address=Op.SLOAD(key=0x1), value=0x1, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))  # noqa: E501
    ...
    post = {
        ...
        Address("0xf1ecf98489fa9ed60a664fc4998db699cfa39d40"): Account(storage={0: 12}, balance=1),  # noqa: E501
