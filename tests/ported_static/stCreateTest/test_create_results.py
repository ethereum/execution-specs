...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(2, 0, 0, id="case18"),
        pytest.param(3, 0, 0, id="case19"),
        pytest.param(4, 0, 0, id="case20"),
        pytest.param(5, 0, 0, id="case21"),
        pytest.param(6, 0, 0, id="case22"),
        pytest.param(7, 0, 0, id="case23"),
        pytest.param(8, 0, 0, id="case24"),
        pytest.param(9, 0, 0, id="case25"),
    ],
)
    ...
    EXPECT_ENTRIES: list[dict] = [
        {
            ...
            "network": [">=Cancun"],
            "result": {
                callee: Account(storage={0: 24743}),
                contract: Account(storage={32: 295, 33: 551}),
            },
        },
        {
            "indexes": {"data": [3, 7], "gas": 0, "value": 0},
            "network": [">=Cancun"],
            "result": {contract: Account(storage={32: 295, 33: 551})},
        },
        {
            "indexes": {
