...
def test_create_oo_gafter_max_codesize(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.JUMPI(pc=0xc, condition=Op.GT(Op.CALLDATASIZE, 0x0)) + Op.STOP
        + Op.JUMPDEST + Op.SELFDESTRUCT(address=0x0),
        nonce=0,
    ...
    contract_1 = pre.deploy_contract(
        code=Op.PUSH3[0xc0de0] + Op.PUSH1[0x0] + Op.DUP1
        + Op.EXTCODESIZE(address=Op.DUP3) + Op.SWAP3 + Op.EXTCODECOPY
    ...
    contract_2 = pre.deploy_contract(
        code=Op.SSTORE(key=Op.DUP1, value=0x1) + Op.PUSH1[0x0]
        + Op.CALLDATALOAD(offset=Op.DUP1) + Op.CALLDATALOAD(offset=0x20)
        + Op.PUSH3[0xc0de1] + Op.DUP4 + Op.EXTCODESIZE(address=Op.DUP2)
        + Op.SWAP5 + Op.DUP6 + Op.SWAP3 + Op.EXTCODECOPY + Op.PUSH1[0x0]
        + Op.JUMPDEST + Op.JUMPI(pc=0x2d, condition=Op.LT(Op.DUP2, Op.DUP3))
        + Op.POP + Op.PUSH1[0x0] + Op.JUMPI(pc=0x2b, condition=Op.LT)
        + Op.PUSH1[0x20] + Op.MUL + Op.SWAP1 + Op.RETURN + Op.JUMPDEST
        + Op.INVALID + Op.JUMPDEST + Op.PUSH1[0x1] + Op.SWAP1
        + Op.MSTORE(offset=Op.ADD(Op.DUP7, Op.MUL(Op.DUP3, 0x20)), value=Op.CREATE(value=Op.DUP1, offset=0x0, size=Op.DUP5))
        + Op.ADD + Op.JUMP(pc=0x18),
        nonce=1,
    ...
    contract_3 = pre.deploy_contract(
        code=Op.CALLDATALOAD(offset=0x4) + Op.CALLDATALOAD(offset=0x24)
        + Op.CALLDATALOAD(offset=0x44) + Op.SWAP1 + Op.CALLDATALOAD(offset=0x64)
        + Op.SWAP3 + Op.MSTORE(offset=0x0, value=Op.DUP1)
        + Op.MSTORE(offset=0x20, value=0x0) + Op.PUSH1[0x0] + Op.PUSH1[0x40]
        + Op.MUL(Op.DUP4, 0x20) + Op.SWAP1 + Op.PUSH1[0x40] + Op.DUP4
        + Op.PUSH3[0xc0deb]
        + Op.JUMPI(pc=0xbf, condition=Op.EQ(Op.DELEGATECALL, Op.DIV(Op.GAS, 0x2)))
        + Op.MSTORE(offset=0x0, value=Op.DUP2)
        + Op.MSTORE(offset=0x20, value=Op.DUP3) + Op.PUSH1[0x0]
        + Op.ADD(0x40, Op.MUL(Op.DUP3, 0x20)) + Op.MUL(Op.DUP5, 0x20) + Op.SWAP1
        + Op.PUSH1[0x40] + Op.DUP4 + Op.DUP1 + Op.PUSH3[0xc0deb]
        + Op.JUMPI(pc=0xba, condition=Op.EQ(Op.CALL, Op.DIV(Op.GAS, 0x2)))
        + Op.JUMPDEST + Op.PUSH1[0x0] + Op.DUP2 + Op.SWAP4
        + Op.JUMPI(pc=0xb1, condition=Op.EQ) + Op.JUMPDEST + Op.POP * 2
        + Op.PUSH1[0x0] + Op.JUMPDEST
        + Op.JUMPI(pc=0x94, condition=Op.LT(Op.DUP2, Op.DUP2)) + Op.DUP3
        + Op.PUSH1[0x0] + Op.JUMPDEST
        + Op.JUMPI(pc=0x77, condition=Op.LT(Op.DUP2, Op.DUP2)) + Op.STOP
        + Op.JUMPDEST + Op.DUP1 + Op.PUSH1[0x0] + Op.DUP1 + Op.PUSH1[0x1]
        + Op.DUP2 + Op.DUP1 + Op.PUSH1[0x20] + Op.DUP4 + Op.SWAP8
        + Op.MLOAD(offset=Op.ADD(0x40, Op.MUL)) + Op.SUB(Op.GAS, 0x3e8)
        + Op.POP(Op.CALL) + Op.ADD + Op.JUMP(pc=0x6f) + Op.JUMPDEST + Op.DUP1
        + Op.PUSH1[0x0] + Op.DUP1 * 4 + Op.PUSH1[0x20] + Op.PUSH1[0x1] + Op.SWAP8
        + Op.MLOAD(offset=Op.ADD(0x40, Op.MUL)) + Op.SUB(Op.GAS, 0x3e8)
        + Op.POP(Op.CALL) + Op.ADD + Op.JUMP(pc=0x65) + Op.JUMPDEST + Op.ADD
        + Op.SWAP1 + Op.POP + Op.CODESIZE + Op.DUP1 + Op.JUMP(pc=0x60)
        + Op.JUMPDEST + Op.JUMPI(pc=0x57, condition=Op.DUP3) + Op.JUMPDEST
    ...
    expect_entries_: list[dict] = [
        ...
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0xb3210b741a5dfbddc1636521965b3558defa3e60"): Account.NONEXISTENT,  # noqa: E501
    },
        },
        {
        ...
        contract_2: Account(storage={}, nonce=1),
        Address("0x396b47fae89161b1959b5a833acf816be526b860"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xbd205415c24eb289b6a275baae74527b92b49fe2"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0xb3210b741a5dfbddc1636521965b3558defa3e60"): Account.NONEXISTENT,  # noqa: E501
    },
        },
        ...
        Address("0x396b47fae89161b1959b5a833acf816be526b860"): Account.NONEXISTENT,  # noqa: E501
        Address("0xbd205415c24eb289b6a275baae74527b92b49fe2"): Account.NONEXISTENT,  # noqa: E501
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0x936d5e529580a9cc92bc2b2963a9d0a99f437e89"): Account.NONEXISTENT,  # noqa: E501
        Address("0x2e5a5ec103443f6b299cf31a52c69cf222ae4e6b"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xbade62b355fe6b7117f4f7c913321b318ca3a4da"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xd8a8f3569a1d76027f9ece5010489576897014ea"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xfcdccc3b46b9fbe71221061091e8fe82b77e02f2"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x67262aa10552371ec665c2f90c56d9d65c16715e"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xb3210b741a5dfbddc1636521965b3558defa3e60"): Account(storage={0: 24576}),  # noqa: E501
    },
        },
        {
        ...
        contract_2: Account(storage={}, nonce=1),
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0x782f34ee13897680a5000838ce53d07b9558b5e2"): Account.NONEXISTENT,  # noqa: E501
    },
        },
        {
        ...
        contract_2: Account(storage={}, nonce=1),
        Address("0x396b47fae89161b1959b5a833acf816be526b860"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x336debb8ce5a3cf4b40be471ac04f77b51f2d2e1"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0x782f34ee13897680a5000838ce53d07b9558b5e2"): Account.NONEXISTENT,  # noqa: E501
    },
        },
        ...
        Address("0x396b47fae89161b1959b5a833acf816be526b860"): Account.NONEXISTENT,  # noqa: E501
        Address("0x336debb8ce5a3cf4b40be471ac04f77b51f2d2e1"): Account.NONEXISTENT,  # noqa: E501
        Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT,  # noqa: E501
        Address("0x638e1b782452eaf5270509651f665d2c00e599ff"): Account.NONEXISTENT,  # noqa: E501
        Address("0x511c6c5591eacfc8b9bf2658916225418508f548"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x9ca6a1cfda677fc2679fce570dd47120686cb7c0"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xdf7cd0b9839e4d93b98f09bf4c79366b9ffbe638"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xee8b40edee25283a8c934b9c3a2ad8c848dc61b9"): Account(storage={0: 24576}),  # noqa: E501
        Address("0xe0fad4310f169961f052ac02bb70707ebfa3ece2"): Account(storage={0: 24576}),  # noqa: E501
        Address("0x782f34ee13897680a5000838ce53d07b9558b5e2"): Account(storage={0: 24576}),  # noqa: E501
    },
        },
    ]
