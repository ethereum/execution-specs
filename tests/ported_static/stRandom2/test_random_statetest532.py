...
def test_random_statetest532(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x1]
        + Op.SLOAD(key=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)  # noqa: E501
        + Op.PREVRANDAO + Op.PUSH32[0xc350]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x78297ba08ba478507f413b3597109c55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x43e5a248,
        nonce=0,
        gas_price=10,
