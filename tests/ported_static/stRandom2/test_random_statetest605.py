...
def test_random_statetest605(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x650044fa,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
                storage={
            0xffffffffffffffffffffffff00000000000000000000000000000000000000e9: 0x10000000000000000000000000000000000000000,
        },
                nonce=0,
            ),
