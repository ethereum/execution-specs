...
def test_random_statetest534(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.GASLIMIT
        + Op.NUMBER + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.GASLIMIT + Op.PUSH32[0x0] + Op.NUMBER
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xf3075243846d88747b6a9e7ff28c6155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x55db76c1,
        nonce=0,
        gas_price=10,
