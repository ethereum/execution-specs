...
def test_random_statetest500(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] * 2 + Op.DUP2
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x87196584968a97046c67919931148255),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x20d454f,
        nonce=0,
        gas_price=10,
