...
def test_random_statetest527(
    ...
    target = pre.deploy_contract(
        code=Op.CALLVALUE + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0xab00b0e,
        nonce=0,
        gas_price=10,
