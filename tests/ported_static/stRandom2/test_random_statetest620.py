...
def test_random_statetest620(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6c54a420327d73727d9d1a667bf38955),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x61f75e26,
        nonce=0,
        gas_price=10,
