...
def test_random_statetest582(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE
        + Op.PUSH32[0x0]
        ...
        + Op.RETURN(offset=Op.DUP1, size=0x17718) + Op.SSTORE
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=200000,
        value=0x756b69d9,
        nonce=0,
        gas_price=10,
