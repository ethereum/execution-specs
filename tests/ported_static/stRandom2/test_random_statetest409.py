...
def test_random_statetest409(
    ...
    target = pre.deploy_contract(
        code=Op.JUMPDEST + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x41028c83,
        nonce=0,
        gas_price=10,
    ...
    post = {
        ...
        Address("0xffffffffffffffffffffffffffffffffffffffff"): Account(storage={}, code=b"", balance=0x41028c83, nonce=0),  # noqa: E501
    }
