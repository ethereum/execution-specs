...
def test_random_statetest418(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=392462029,
        value=0x65a87a48,
        nonce=0,
        gas_price=10,
