...
def test_random_statetest523(
    ...
    target = pre.deploy_contract(
        code=Op.COINBASE + Op.PUSH32[0x1]
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x5741bf83,
        nonce=0,
        gas_price=10,
