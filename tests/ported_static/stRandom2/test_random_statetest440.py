...
def test_random_statetest440(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.GASLIMIT * 2
        + Op.PUSH32[0x1] * 2
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.COINBASE
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x1513a9b8216816f74f3676e9ea26155),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4a3fd736,
        nonce=0,
        gas_price=10,
