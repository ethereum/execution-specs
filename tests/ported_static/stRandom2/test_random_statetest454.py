...
def test_random_statetest454(
    ...
    target = pre.deploy_contract(
        code=Op.SSTORE(key=Op.PUSH32[0x0], value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)  # noqa: E501
        + Op.SSTORE(key=Op.PUSH32[0x0], value=Op.PUSH32[0x0])
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.EXP
        + Op.DUP5 + Op.CALLER + Op.SWAP2
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x55500ee3,
        nonce=0,
        gas_price=10,
