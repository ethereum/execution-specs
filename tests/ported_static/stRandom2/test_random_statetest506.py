...
def test_random_statetest506(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa218f370862059149e3cff20),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x3879dac6,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
            ...
            0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 0,
        },
                nonce=0,
            ),
