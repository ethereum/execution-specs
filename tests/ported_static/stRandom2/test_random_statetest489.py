...
def test_random_statetest489(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0] * 2 + Op.GASLIMIT
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x2b8e846b91987417705a126e77076455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x6ea1dc52,
        nonce=0,
        gas_price=10,
