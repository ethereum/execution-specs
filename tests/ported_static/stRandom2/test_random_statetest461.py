...
def test_random_statetest461(
    ...
    target = pre.deploy_contract(
        code=Op.MLOAD(offset=Op.PUSH32[0xc350]) + Op.PUSH32[0xc350]
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x20b19906,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
                storage={
            0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 50048,
        },
                nonce=0,
            ),
