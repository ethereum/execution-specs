...
def test_random_statetest395(
    ...
    target = pre.deploy_contract(
        code=Op.PREVRANDAO + Op.PUSH32[0x1] + Op.COINBASE + Op.PUSH32[0x1]
        + Op.PUSH32[0x0] + Op.PUSH32[0xc350]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x823140710bf13990e4500136726d8b55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x5a9c61ef,
        nonce=0,
        gas_price=10,
