...
def test_random_statetest516(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.MULMOD(0x32787358019b3918686194, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x2c787ea,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
                storage={
            0: 0x32787358019b3918686193ffffffffffffffffffcd878ca7fe64c6e7979e6c,
        },
                nonce=0,
            ),
