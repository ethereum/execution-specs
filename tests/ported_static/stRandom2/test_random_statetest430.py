...
def test_random_statetest430(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7d41a29934035b748e96a3135b696455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x6bf5e61f,
        nonce=0,
        gas_price=10,
