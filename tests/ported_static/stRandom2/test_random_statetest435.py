...
def test_random_statetest435(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PREVRANDAO
        ...
        + Op.CODECOPY + Op.MLOAD(offset=0x0) + Op.SSTORE,
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4adf9c16,
        nonce=0,
        gas_price=10,
