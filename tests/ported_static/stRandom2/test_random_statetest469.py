...
def test_random_statetest469(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=500000,
        value=0x690aecf0,
        nonce=0,
        gas_price=10,
