...
def test_random_statetest416(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.NUMBER, value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4f622410,
        nonce=0,
        gas_price=10,
