...
def test_random_statetest556(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x726e757692a2ad96526b9e8b77a33a55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x44f0b58c,
        nonce=0,
        gas_price=10,
