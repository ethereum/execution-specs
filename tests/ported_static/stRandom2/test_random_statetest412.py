...
def test_random_statetest412(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa46ef06a5a858b9742198a37e1153c55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x75cf6ad,
        nonce=0,
        gas_price=10,
