...
def test_random_statetest401(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0xc350] + Op.PREVRANDAO + Op.TIMESTAMP
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x230f1c8e,
        nonce=0,
        gas_price=10,
