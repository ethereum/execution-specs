...
def test_random_statetest502(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.PUSH32[0xc350] + Op.DUP1
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.SSTORE(key=0xb59c66369a85a46da1821861586378600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x14960c58,
        nonce=0,
        gas_price=10,
