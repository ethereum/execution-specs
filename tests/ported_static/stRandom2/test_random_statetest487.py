...
def test_random_statetest487(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x32216d83,
        nonce=0,
        gas_price=10,
    ...
    post = {
        ...
        Address("0xffffffffffffffffffffffffffffffffffff3cae"): Account(storage={}, code=b"", nonce=0),  # noqa: E501
    }
