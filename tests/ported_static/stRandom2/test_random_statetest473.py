...
def test_random_statetest473(
    ...
    contract_0 = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MULMOD, value=Op.MUL) + Op.MLOAD(offset=0x0)
        + Op.SSTORE,
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4467ca41,
        nonce=0,
        gas_price=10,
    ...
    post = {
        contract_0: Account(
                storage={
            0xffffffffffffffffffffffff6bacfb1469f9a4d5674a85b75f951d72d7a58e4a: 50000,
        },
                nonce=0,
            ),
