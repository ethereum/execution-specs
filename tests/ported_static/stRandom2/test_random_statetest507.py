...
def test_random_statetest507(
    ...
    target = pre.deploy_contract(
        code=Op.GAS + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.ORIGIN + Op.PUSH32[0x1]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x99a4527612a199a06d1a348b02563a9b),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
