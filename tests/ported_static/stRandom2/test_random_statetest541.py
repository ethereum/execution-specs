...
def test_random_statetest541(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.LT(Op.SIGNEXTEND(Op.CALLDATALOAD(offset=0x6e089257368d07897d57), Op.CALLDATALOAD(offset=Op.NUMBER)), Op.PUSH32[0x10000000000000000000000000000000000000000]), value=Op.PUSH32[0x0])  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x1f529315,
        nonce=0,
        gas_price=10,
