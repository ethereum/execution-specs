...
def test_random_statetest565(
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x28cd0966,
        nonce=0,
        gas_price=10,
    ...
    post = {
        target: Account(
                storage={
            0x7f00000000000000000000000100000000000000000000000000000000000000: 0x10000000000000000000000000000000000000000,
        },
                nonce=0,
            ),
