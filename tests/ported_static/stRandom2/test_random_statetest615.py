...
def test_random_statetest615(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.DUP4), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x7bcc296a,
        nonce=0,
        gas_price=10,
