...
def test_random_statetest470(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.SIGNEXTEND(Op.PUSH32[0x0], Op.CALLDATALOAD(offset=Op.PUSH32[0x1]))),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x67c37947,
        nonce=0,
        gas_price=10,
