...
def test_random_statetest389(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350]
        + Op.CALLDATACOPY(dest_offset=Op.SLT(Op.PC, Op.SLOAD(key=Op.CODESIZE)), offset=Op.DUP7, size=Op.GASPRICE)  # noqa: E501
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x5bf15d9b,
        nonce=0,
        gas_price=10,
