...
def test_random_statetest600(
    ...
    target = pre.deploy_contract(
        ...
        + Op.PUSH32[0xc350] * 2 + Op.NUMBER + Op.GASLIMIT
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xb6f37208e76a402927039198c969907),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0xad3f19c,
        nonce=0,
        gas_price=10,
