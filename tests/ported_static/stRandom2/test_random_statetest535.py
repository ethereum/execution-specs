...
def test_random_statetest535(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.PUSH32[0x0], value=Op.PUSH32[0x10000000000000000000000000000000000000000]),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x4cd4dc30,
        nonce=0,
        gas_price=10,
