...
def test_random_statetest641(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x29199c9aa4054170f1a15a55056f9655),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0xf08f864,
        nonce=0,
        gas_price=10,
