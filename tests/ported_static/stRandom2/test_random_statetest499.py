...
def test_random_statetest499(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SWAP16 + Op.DUP7 + Op.SWAP11 + Op.SELFDESTRUCT + Op.EXTCODESIZE
        + Op.MOD + Op.CALLER
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x7aab34a5,
        nonce=0,
        gas_price=10,
