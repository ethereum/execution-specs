...
def test_random_statetest407(
    ...
    target = pre.deploy_contract(
        code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6d71656f054471181163037902615b55),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x313547f8,
        nonce=0,
        gas_price=10,
