...
def test_random_statetest451(
    ...
    target = pre.deploy_contract(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xed05989a0659453076573a8704117455),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=target,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x306ca21a,
        nonce=0,
        gas_price=10,
