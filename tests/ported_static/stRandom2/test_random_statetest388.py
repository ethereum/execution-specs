...
def test_random_statetest388(
    ...
    contract_0 = pre.deploy_contract(
        code=Op.PUSH32[0x0] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=0xb5765b8f743b9979a0905b6a189165600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),  # noqa: E501
        nonce=0,
    ...
    tx = Transaction(
        sender=sender,
        to=contract_0,
        data=bytes.fromhex(""),  # noqa: E501
        gas_limit=100000,
        value=0x460b9f39,
        nonce=0,
        gas_price=10,
