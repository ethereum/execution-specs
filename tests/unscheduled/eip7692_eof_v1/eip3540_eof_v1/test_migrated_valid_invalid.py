...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex("ef00010100040200010001ff000200")
            ),
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex("ef00010100040200010001ff00020000")
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex("ef00010100040200010001ff0002000000")
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex("ef00010100040200010001ff000200000000")
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001ff00020000000000"
                )
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010029ff000000000000027f"
                )
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001 010004 0200010001 ff0000 00 00800000 fe aabbcc"
                )
            ),
            EOFException.INVALID_SECTION_BODIES_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001 010004 0200010001 ff0000 00 00000000 fe aabbcc"
                )
            ),
            [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010000ff00000000000000"
                )
            ),
            EOFException.ZERO_SECTION_SIZE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010200010001010004ff00020000000000feaabb"
                )
            ),
            [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001ff000201000402000100010000000000feaabb"
                )
            ),
            [
                EOFException.MISSING_TYPE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001010004ff000202000100010000000000feaabb"
                )
            ),
            [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex("ef0001010004ff00020000000000aabb")
            ),
            [
                EOFException.MISSING_CODE_HEADER,
                EOFException.UNEXPECTED_HEADER_KIND,
        ...
        pytest.param(
            # No data section
            Container(
                raw_bytes=bytes.fromhex("ef000101000402000100010000000000fe")
            ),
            [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001 010004 0200010001 ff0002 00 00000000 fe aabbccdd"
                )
            ),
            [
                EOFException.INVALID_FIRST_SECTION_TYPE,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001ff0002ff00020000000000feaabbaabb"
                )
            ),
            [
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010400010100040200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_TYPE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010500010100040200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_TYPE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001fe00010100040200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_TYPE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040400010200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_CODE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040500010200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_CODE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef0001010004fe00010200010001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_CODE_HEADER,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001050001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_DATA_SECTION,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001060001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_DATA_SECTION,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001040001ff00000000000000fe"
                )
            ),
            [
                EOFException.MISSING_DATA_SECTION,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001ff00000500010000000000fe"
                )
            ),
            [
                EOFException.MISSING_TERMINATOR,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001ff00000600010000000000fe"
                )
            ),
            [
                EOFException.MISSING_TERMINATOR,
        ...
        pytest.param(
            ...
            Container(
                raw_bytes=bytes.fromhex(
                    "ef00010100040200010001ff00000400010000000000fe"
                )
            ),
            [
                EOFException.MISSING_TERMINATOR,
