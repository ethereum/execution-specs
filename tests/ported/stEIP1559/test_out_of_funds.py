...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(16777216, 0, TransactionException.INSUFFICIENT_ACCOUNT_FUNDS, id="case0", marks=pytest.mark.exception_test),
        pytest.param(16777216, 1000000000000000000, TransactionException.INSUFFICIENT_ACCOUNT_FUNDS, id="case1", marks=pytest.mark.exception_test),
        pytest.param(40000, 0, None, id="case2"),
        pytest.param(40000, 1000000000000000000, TransactionException.INSUFFICIENT_ACCOUNT_FUNDS, id="case3", marks=pytest.mark.exception_test),
    ],
)
