...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0x65be40505e6165809f16bfc5cdba14169bc97614
    push2 0x9c90
    staticcall
    stop
...
callee_3 code:
    ...
    push1 0x40
    push1 0x00
    push20 0xb867c4bf480d6dcd06716bcdb0f9bcf3bb5710bf
    push2 0xeaf6
    delegatecall
    push1 0x00
    sstore
...
callee_6 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x96bba71c203b7339624a350fe004f71c3d669aee
    push2 0x9c90
    staticcall
    pop
    jumpdest
...
callee_7 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x2aba60e14f876dac315953942316a9a2f80c3ad5
    push2 0xeaf6
    delegatecall
    push1 0x00
    sstore
