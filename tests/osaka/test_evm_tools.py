...
test_dirs = (
    "tests/fixtures/latest_fork_tests/state_tests/osaka/eip2537_bls_12_381_precompiles",
    "tests/fixtures/latest_fork_tests/state_tests/osaka/eip7702_set_code_tx",
    "tests/fixtures/latest_fork_tests/state_tests/osaka/eip7623_increase_calldata_cost",
)
