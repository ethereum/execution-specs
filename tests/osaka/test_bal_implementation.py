...
class TestBALCore:
    ...
    def test_bal_builder_build_complete(self):
        ...
        assert (
            acc1.storage_reads[0] == slot2
        )  # Direct StorageKey, not SlotRead
...
class TestBALIntegration:
    ...
    def test_balance_type_is_bytes(self):
        ...
        balance_change = BalanceChange(tx_index=U32(0), post_balance=balance)
    ...
    def test_create_operations_pass_tracker(self):
        ...
        assert (
            "increment_nonce" in content and "bal_tracker" in content
...
class TestBALEdgeCases:
    ...
    def test_max_code_changes_limit(self):
        ...
        assert (
            MAX_CODE_CHANGES == 1
        ), "MAX_CODE_CHANGES should be 1 per EIP-7928"
