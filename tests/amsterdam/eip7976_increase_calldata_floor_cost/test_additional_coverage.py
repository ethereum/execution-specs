...
class TestMaximumCalldata:
    ...
    def test_maximum_calldata_size(
        ...
        # floor_cost = 21000 + (G_TX_DATA_FLOOR_TOKEN_COST * tokens)
...
class TestMemoryExpansion:
    ...
    def test_memory_expansion_with_calldata(
        ...
        execution_gas = (
            ...
            + gas_costs.G_VERY_LOW * 2  # PUSH1 * 2
            + gas_costs.G_VERY_LOW  # CALLDATACOPY base
...
class TestNestedContractCalls:
    ...
    def test_nested_call_no_additional_floor_cost(
        ...
        gas_costs = fork.gas_costs()
        expected_floor_cost = 21000 + (
            tokens_tx * gas_costs.G_TX_DATA_FLOOR_TOKEN_COST
        )
        assert floor_cost == expected_floor_cost
...
class TestRefundCapInteraction:
    ...
    def test_refund_calculated_from_execution_not_floor(
        ...
        execution_gas = (
            gas_costs.G_COLD_SLOAD  # First access to storage slot
            + gas_costs.G_STORAGE_RESET  # SSTORE reset cost
            + gas_costs.G_VERY_LOW * 2  # PUSH1 * 2 for Op.SSTORE helper
        )
        ...
        max_refund = gas_costs.R_STORAGE_CLEAR
    ...
    def test_refund_cap_at_one_fifth(
        ...
        for _ in range(num_slots):
            ...
            execution_gas += gas_costs.G_COLD_SLOAD
            execution_gas += gas_costs.G_STORAGE_RESET
            execution_gas += gas_costs.G_VERY_LOW * 2  # PUSH1 * 2
        ...
        refund_counter = gas_costs.R_STORAGE_CLEAR * num_slots
    ...
    def test_floor_cost_not_reduced_by_refunds(
        ...
        refund = min(gas_costs.R_STORAGE_CLEAR, total_gas_before_refund // 5)
