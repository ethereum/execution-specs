...
import ethereum.byzantium.trie as normal_trie
...
try:
    import ethereum_optimized.byzantium.state_db as state_db
except ImportError:
    pass
...
@pytest.mark.skipif(
    "ethereum_optimized.byzantium.state_db" not in sys.modules,
