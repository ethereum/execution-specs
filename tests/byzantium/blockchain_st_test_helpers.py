...
from ethereum.byzantium.spec import BlockChain, state_transition
...
from ethereum.byzantium.utils.hexadecimal import hex_to_address, hex_to_root
...
def run_blockchain_st_test(
    ...
    if not test_data["ignore_pow_validation"]:
        ...
        with patch(
            "ethereum.byzantium.spec.validate_proof_of_work",
            autospec=True,
...
run_byzantium_blockchain_st_tests = partial(
    run_blockchain_st_test, network="Byzantium"
)
