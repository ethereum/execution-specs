...
import ethereum.istanbul.trie as normal_trie
...
try:
    import ethereum_optimized.istanbul.state_db as state_db
except ImportError:
    pass
...
@pytest.mark.skipif(
    "ethereum_optimized.istanbul.state_db" not in sys.modules,
