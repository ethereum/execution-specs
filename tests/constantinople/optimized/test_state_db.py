...
import ethereum.constantinople.trie as normal_trie
...
try:
    import ethereum_optimized.constantinople.state_db as state_db
except ImportError:
    pass
...
@pytest.mark.skipif(
    "ethereum_optimized.constantinople.state_db" not in sys.modules,
