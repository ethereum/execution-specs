...
MODEXP_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=36,
    step=9,  # 5 data points (0, 9, 18, 27, 36)
...
BN128_MUL_CONFIG = MarginalPrecompileConfig(
    ...
    step=18,  # 5 data points (0, 18, 36, 54, 72)
...
BLAKE2F_CONFIG = MarginalPrecompileConfig(
    ...
    step=3,  # 5 data points (0, 3, 6, 9, 12)
...
BLS12_G1MSM_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=40,  # Reduced to fit within 1M gas limit
