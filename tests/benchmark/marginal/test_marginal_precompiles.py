...
MODEXP_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=36,
    step=12,  # 4 data points (0, 12, 24, 36)
...
SHA256_CONFIG = MarginalPrecompileConfig(
    ...
    step=250,  # 5 data points (0, 250, 500, 750, 1000)
...
BN128_ADD_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=800,
    step=200,  # 5 data points (0, 200, 400, 600, 800)
...
BN128_MUL_CONFIG = MarginalPrecompileConfig(
    ...
    step=24,  # 4 data points (0, 24, 48, 72)
...
BN128_PAIRING_CONFIG = MarginalPrecompileConfig(
    ...
    step=2,  # 5 data points (0, 2, 4, 6, 8)
...
BLS12_G1ADD_CONFIG = MarginalPrecompileConfig(
    ...
    step=192,  # 5 data points (0, 192, 384, 576, 768) - close to 770
...
BLS12_G1MSM_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=39,  # Reduced to fit within 1M gas limit
    step=13,  # 4 data points (0, 13, 26, 39)
...
BLS12_G2MSM_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=24,
    step=6,  # 5 data points (0, 6, 12, 18, 24)
...
BLS12_MAP_FP_TO_G1_CONFIG = MarginalPrecompileConfig(
    ...
    step=18,  # 5 data points (0, 18, 36, 54, 72) - close to 75
...
BLS12_MAP_FP2_TO_G2_CONFIG = MarginalPrecompileConfig(
    ...
    max_op_count=27,
    step=6,  # 5 data points (0, 6, 12, 18, 24) - close to 27
