...
ADD_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=1488,  # Calculated for 500K+ gas
)
...
MUL_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=1920,  # Doubled for ~1M gas
)
...
SUB_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=1920,  # Calculated for 500K+ gas
)
...
SMOD_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=1920,  # Scaled for 150M cycles
)
...
ADDMOD_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=3,
    pushes_per_op=1,
    num_calls=882,  # Calculated for 500K+ gas
)
...
EXP_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=12,  # Doubled for ~1M gas
)
...
SIGNEXTEND_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=1920,  # Scaled for 150M cycles target
)
...
BYTE_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=924,  # Scaled for 150M cycles
)
...
KECCAK256_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=1,
    num_calls=188,  # Calculated for 500K+ gas
...
PUSH32_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=0,
    pushes_per_op=1,
    num_calls=1298,  # Calculated for 500K+ gas
)
...
ADDRESS_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=0,
    pushes_per_op=1,
    num_calls=1152,  # Calculated for 500K+ gas
)
...
MSTORE_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=0,
    num_calls=936,  # Calculated for 500K+ gas
...
MSIZE_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=0,
    pushes_per_op=1,
    num_calls=1920,  # Calculated for 500K+ gas (MSIZE costs 2 gas)
...
RETURNDATACOPY_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=3,
    pushes_per_op=0,
    num_calls=544,  # Calculated for 500K+ gas: 170 × (200 setup + 300×9) ≈ 493K
...
MCOPY_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=3,
    pushes_per_op=0,
    num_calls=184,  # Calculated for 500K+ gas
...
SSTORE_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=2,
    pushes_per_op=0,
    num_calls=1164,  # Scaled for 150M cycles target
    setup_code=Op.POP(Op.SLOAD(100)),  # Warm up slot 100 first
)
...
JUMPDEST_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=0,
    pushes_per_op=0,
    num_calls=1920,  # Calculated for 500K+ gas (1 gas per JUMPDEST)
)
...
EXTCODEHASH_CONFIG = MarginalOpcodeConfig(
    ...
    pops_per_op=1,
    pushes_per_op=1,
    num_calls=1804,  # Calculated for 500K+ gas
...
test_dup1 = _create_dup_caller_test(1, DUP1_MAX_OP_COUNT, DUP1_STEP, num_calls=1200)
test_dup8 = _create_dup_caller_test(8, DUP8_MAX_OP_COUNT, DUP8_STEP, num_calls=1200)
test_dup16 = _create_dup_caller_test(16, DUP16_MAX_OP_COUNT, DUP16_STEP, num_calls=1200)
test_swap1 = _create_swap_caller_test(1, SWAP1_MAX_OP_COUNT, SWAP1_STEP, num_calls=930)
test_swap8 = _create_swap_caller_test(8, SWAP8_MAX_OP_COUNT, SWAP8_STEP, num_calls=930)
test_swap16 = _create_swap_caller_test(16, SWAP16_MAX_OP_COUNT, SWAP16_STEP, num_calls=930)
...
test_log1 = _create_log_caller_test(Op.LOG1, 1, LOG1_MAX_OP_COUNT, LOG1_STEP, num_calls=958)
test_log2 = _create_log_caller_test(Op.LOG2, 2, LOG2_MAX_OP_COUNT, LOG2_STEP, num_calls=662)
test_log3 = _create_log_caller_test(Op.LOG3, 3, LOG3_MAX_OP_COUNT, LOG3_STEP, num_calls=658)
test_log4 = _create_log_caller_test(Op.LOG4, 4, LOG4_MAX_OP_COUNT, LOG4_STEP, num_calls=692)
