...
ADD_CONFIG = MarginalOpcodeConfig(
    ...
    step=75,  # 5 data points (0, 75, 150, 225, 300)
...
DIV_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.DIV,
    max_op_count=300,
    step=100,  # 4 data points (0, 100, 200, 300)
...
ADDMOD_CONFIG = MarginalOpcodeConfig(
    ...
    step=66,  # 4 data points (0, 66, 132, 198) - close to 200
...
EXP_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.EXP,
    max_op_count=150,
    step=50,  # 4 data points (0, 50, 100, 150)
...
ISZERO_CONFIG = MarginalOpcodeConfig(
    ...
    step=112,  # 5 data points (0, 112, 224, 336, 448)
    stack_args=[MAX_U256],
    inputs_per_op=1,
    outputs_per_op=1,
    num_calls=450,  # Reduced for faster benchmarking
...
KECCAK256_CONFIG = MarginalOpcodeConfig(
    ...
    max_op_count=120,
    step=30,  # 5 data points (0, 30, 60, 90, 120)
    stack_args=[8192, 0],  # size=8KB, offset=0
    inputs_per_op=2,
    outputs_per_op=1,
    num_calls=20,  # Reduced for faster benchmarking
...
PUSH0_CONFIG = MarginalOpcodeConfig(
    ...
    max_op_count=600,
    step=150,  # 5 data points (0, 150, 300, 450, 600)
    stack_args=[],
    inputs_per_op=0,
    outputs_per_op=1,
    num_calls=150,  # Reduced for faster benchmarking
...
PUSH16_CONFIG = MarginalOpcodeConfig(
    ...
    max_op_count=500,
    step=125,  # 5 data points (0, 125, 250, 375, 500)
    stack_args=[],
    inputs_per_op=0,
    outputs_per_op=1,
    num_calls=250,  # Reduced for faster benchmarking
...
PUSH32_CONFIG = MarginalOpcodeConfig(
    ...
    max_op_count=350,
    step=87,  # 5 data points (0, 87, 174, 261, 348)
    stack_args=[],
    inputs_per_op=0,
    outputs_per_op=1,
    num_calls=300,  # Reduced for faster benchmarking
...
DUP1_CONFIG = CustomTargetConfig(
    name="DUP1", max_op_count=300, step=75, num_calls=450, variant=1  # 5 points
)
DUP8_CONFIG = CustomTargetConfig(
    name="DUP8", max_op_count=300, step=75, num_calls=300, variant=8  # 5 points
)
DUP16_CONFIG = CustomTargetConfig(
    name="DUP16", max_op_count=300, step=75, num_calls=250, variant=16  # 5 points
)
...
SWAP8_CONFIG = CustomTargetConfig(
    name="SWAP8", max_op_count=300, step=75, num_calls=150, variant=8  # 5 points
)
SWAP16_CONFIG = CustomTargetConfig(
    name="SWAP16", max_op_count=300, step=75, num_calls=150, variant=16  # 5 points
)
...
LOG0_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.LOG0,
    max_op_count=100,
    step=25,  # 5 data points (0, 25, 50, 75, 100)
...
LOG1_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.LOG1,
    max_op_count=80,
    step=20,  # 5 data points (0, 20, 40, 60, 80)
...
LOG2_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.LOG2,
    max_op_count=60,
    step=15,  # 5 data points (0, 15, 30, 45, 60)
...
LOG3_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.LOG3,
    max_op_count=50,
    step=12,  # 5 data points (0, 12, 24, 36, 48) - close to 50
...
LOG4_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.LOG4,
    max_op_count=40,
    step=10,  # 5 data points (0, 10, 20, 30, 40)
...
JUMP_CONFIG = CustomTargetConfig(
    name="JUMP", max_op_count=200, step=50, num_calls=450  # 5 points
)
JUMPI_CONFIG = CustomTargetConfig(
    name="JUMPI", max_op_count=200, step=50, num_calls=300  # 5 points
)
...
SSTORE_CONFIG = MarginalOpcodeConfig(
    ...
    opcode=Op.SSTORE,
    max_op_count=50,
    step=12,  # 5 data points (0, 12, 24, 36, 48)
...
CALL_STEP = 25  # 5 data points (0, 25, 50, 75, 100)
...
CREATE_STEP = 5  # 5 data points (0, 5, 10, 15, 20)
