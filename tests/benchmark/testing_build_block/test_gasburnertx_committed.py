"""End-to-end: commit a block of spamoor gasburnertx transactions."""
...
from tests.benchmark.spamoor.helpers import build_gasburnertx_transactions


@pytest.mark.spamoor
@pytest.mark.testing_build_block
def test_gasburnertx_committed(
    ...
    """Deploy the gas-burner contract and commit burn txs against it."""
    raw_txs = build_gasburnertx_transactions(
