"""End-to-end: commit a block of spamoor EOA transfer transactions."""
...
from tests.benchmark.spamoor.helpers import build_eoatx_transactions


@pytest.mark.spamoor
@pytest.mark.testing_build_block
def test_eoatx_committed(
