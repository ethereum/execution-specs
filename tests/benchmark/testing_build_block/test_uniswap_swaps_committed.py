"""End-to-end: commit a block of spamoor uniswap-swaps transactions."""
...
from tests.benchmark.spamoor.helpers import build_uniswap_swaps_transactions


@pytest.mark.spamoor
@pytest.mark.testing_build_block
def test_uniswap_swaps_committed(
    ...
    """Commit a batch of uniswap v2 swap calls against the lab node."""
    raw_txs = build_uniswap_swaps_transactions(
