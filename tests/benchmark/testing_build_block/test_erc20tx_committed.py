"""End-to-end: commit a block of spamoor erc20tx transactions."""
...
from tests.benchmark.spamoor.helpers import build_erc20tx_transactions


@pytest.mark.spamoor
@pytest.mark.testing_build_block
def test_erc20tx_committed(
    ...
    """Commit an ERC-20 deploy + transferMint batch against the lab node."""
    raw_txs = build_erc20tx_transactions(
        ...
        contract_code=spamoor_config["contract_code"] or "0x6001600055",
