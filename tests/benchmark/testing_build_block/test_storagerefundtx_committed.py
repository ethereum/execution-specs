"""End-to-end: commit a block of spamoor storagerefundtx transactions."""
...
def test_storagerefundtx_committed(
    ...
    """Deploy storagerefundtx stub and commit execute(slotsPerCall) calls."""
    raw_txs = build_storagerefundtx_transactions(
