...
from ethereum.spurious_dragon.spec import BlockChain, state_transition
...
from ethereum.spurious_dragon.utils.hexadecimal import (
    hex_to_address,
    hex_to_root,
)
...
def run_blockchain_st_test(
    ...
    if not test_data["ignore_pow_validation"]:
        ...
        with patch(
            "ethereum.spurious_dragon.spec.validate_proof_of_work",
            autospec=True,
